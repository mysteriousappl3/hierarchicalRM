(define (domain liftedtcore_minigrid-domain)
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (or (= ?obj green_box_1) (carrying green_box_1)) (seen_psi_1)) (when (and (locked green_door_1) (not (or (= ?obj green_box_1) (carrying green_box_1)))) (not (hold_3))) (when (or (= ?obj green_box_1) (carrying green_box_1)) (hold_3)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (carrying green_box_1) (not (= ?obj green_box_1))) (seen_psi_1)) (when (and (locked green_door_1) (not (and (carrying green_box_1) (not (= ?obj green_box_1))))) (not (hold_3))) (when (and (carrying green_box_1) (not (= ?obj green_box_1))) (hold_3)) (increase (total-cost) 1)))
 (:action toggle
  ...
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (not (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1)))))) (hold_0)) (when (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1))))) (hold_2)) (when (and (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1))))) (not (carrying green_box_1))) (not (hold_3))) (increase (total-cost) 1)))
)
