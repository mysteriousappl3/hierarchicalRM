(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (= ?room2 room_1) (and (agentinroom room_1) (not (= ?room1 room_1)))) (hold_0)) (when (and (or (= ?room2 room_1) (and (agentinroom room_1) (not (= ?room1 room_1)))) (not (objectinroom purple_box_1 room_3))) (not (hold_1))) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (agentinroom room_1) (not (and (objectinroom purple_box_1 room_3) (not (and (= ?obj purple_box_1) (= ?room room_3)))))) (not (hold_1))) (when (and (objectinroom purple_box_1 room_3) (not (and (= ?obj purple_box_1) (= ?room room_3)))) (hold_1)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (agentinroom room_1) (not (or (and (= ?obj purple_box_1) (= ?room room_3)) (objectinroom purple_box_1 room_3)))) (not (hold_1))) (when (or (and (= ?obj purple_box_1) (= ?room room_3)) (objectinroom purple_box_1 room_3)) (hold_1)) (increase (total-cost) 1)))
 (:action toggle
