(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   purple_door_1 green_door_1 blue_door_1 - door
   green_box_2 purple_box_1 green_box_1 purple_box_2 - box
 ...
 (and (objectcolor ?d greytype) (adjacentrooms room_4 room_3 ?d) (at_ ?d) (not (locked ?d)))) (hold_0)))
