(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_1 red_ball_1 green_ball_2 green_ball_1 - ball
 ...
 (:constraints (sometime (locked purple_door_2)) (sometime-after (locked purple_door_2) (objectinroom grey_ball_1 room_3)))
