(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoobject
  ...
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?obj) (when (and (locked grey_door_1) (= ?obj green_box_1)) (hold_1)) (increase (total-cost) 1)))
 (:action gotoempty
  :parameters ()
 ...
 (not (blocked ?door ?o ?room1))))
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?door) (when (= ?door grey_door_1) (hold_0)) (when (= ?door grey_door_1) (not (hold_1))) (increase (total-cost) 1)))
 (:action gotoroom
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (at_ grey_door_1) (not (and (locked grey_door_1) (at_ green_box_1) (not (= ?obj green_box_1))))) (not (hold_1))) (when (and (locked grey_door_1) (at_ green_box_1) (not (= ?obj green_box_1))) (hold_1)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (at_ grey_door_1) (not (and (locked grey_door_1) (or (= ?obj green_box_1) (at_ green_box_1))))) (not (hold_1))) (when (and (locked grey_door_1) (or (= ?obj green_box_1) (at_ green_box_1))) (hold_1)) (increase (total-cost) 1)))
 (:action toggle
  :parameters ( ?door - door)
  :precondition (and (at_ ?door))
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (and (at_ grey_door_1) (not (and (or (and (not (locked ?door)) (= ?door grey_door_1)) (and (locked grey_door_1) (not (and (locked ?door) (= ?door grey_door_1))))) (at_ green_box_1)))) (not (hold_1))) (when (and (or (and (not (locked ?door)) (= ?door grey_door_1)) (and (locked grey_door_1) (not (and (locked ?door) (= ?door grey_door_1))))) (at_ green_box_1)) (hold_1)) (increase (total-cost) 1)))
)
