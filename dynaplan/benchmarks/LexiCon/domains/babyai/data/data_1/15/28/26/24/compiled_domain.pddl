(define (domain liftedtcore_minigrid-domain)
 ...
 (not (blocked ?door ?o ?room1))) (or (not (= ?door blue_door_1)) (seen_psi_1)))
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?door) (when (= ?door blue_door_1) (hold_0)) (increase (total-cost) 1)))
 (:action gotoroom
