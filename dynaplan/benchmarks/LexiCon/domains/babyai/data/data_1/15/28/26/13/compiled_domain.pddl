(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (and (locked blue_door_1) (not (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4))) (= ?room2 room_3) (and (agentinroom room_3) (not (= ?room1 room_3)))))) (not (hold_1))) (when (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4))) (= ?room2 room_3) (and (agentinroom room_3) (not (= ?room1 room_3)))) (hold_1)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
