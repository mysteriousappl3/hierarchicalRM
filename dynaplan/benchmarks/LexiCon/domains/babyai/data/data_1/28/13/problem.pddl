(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 purple_ball_1 red_ball_2 green_ball_1 red_ball_1 - ball
 ...
 (and (objectcolor ?d bluetype) (adjacentrooms room_2 room_1 ?d) (at_ ?d) (not (locked ?d))))))
 (:constraints (sometime (and (at_ empty) (at_ purple_ball_1))))
