(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_door_1 blue_door_2 green_door_1 red_door_1 - door
   green_box_1 purple_box_1 yellow_box_1 purple_box_2 grey_box_1 red_box_1 - box
 ...
 (:constraints (sometime (agentinroom room_1)) (sometime-after (agentinroom room_1) (or (at_ green_box_1) (not (locked blue_door_1)))))
