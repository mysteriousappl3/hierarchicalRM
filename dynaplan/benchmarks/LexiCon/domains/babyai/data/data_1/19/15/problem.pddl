(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_box_1 purple_box_1 grey_box_1 red_box_1 - box
   red_ball_1 yellow_ball_1 blue_ball_1 blue_ball_2 - ball
 )
 ...
 (:constraints (sometime (not (locked yellow_door_2))) (sometime-before (not (locked yellow_door_2)) (carrying yellow_ball_1)))
