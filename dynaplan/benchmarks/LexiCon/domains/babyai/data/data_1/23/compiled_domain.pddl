(define (domain liftedtcore_minigrid-domain)
 ...
 (:action toggle
  ...
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (not (or (and (not (locked ?door)) (= ?door green_door_2)) (and (locked green_door_2) (not (and (locked ?door) (= ?door green_door_2)))))) (hold_0)) (increase (total-cost) 1)))
)
