(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 green_box_2 yellow_box_1 green_box_1 - box
   red_ball_1 grey_ball_1 grey_ball_2 purple_ball_1 - ball
 )
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (carrying grey_ball_1)))
