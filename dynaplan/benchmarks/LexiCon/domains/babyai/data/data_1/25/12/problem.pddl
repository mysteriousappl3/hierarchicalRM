(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_box_1 blue_box_1 yellow_box_1 green_box_1 green_box_2 yellow_box_2 - box
   yellow_ball_1 red_ball_1 - ball
 )
 ...
 (:constraints (sometime (not (locked red_door_1))) (sometime-before (not (locked red_door_1)) (not (locked grey_door_1))))
