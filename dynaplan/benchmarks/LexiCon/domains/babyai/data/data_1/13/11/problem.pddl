(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_box_2 blue_box_2 grey_box_1 purple_box_1 yellow_box_1 blue_box_1 - box
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (objectinroom yellow_box_1 room_4)))
