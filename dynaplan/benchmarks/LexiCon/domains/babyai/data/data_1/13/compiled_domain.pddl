(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   empty - empty_0
   yellow_door_2 yellow_door_1 - door
   blue_box_1 - box
   room_2 - room
 )
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (locked yellow_door_2) (not (or (not (locked yellow_door_1)) (and (objectinroom blue_box_1 room_2) (not (and (= ?obj blue_box_1) (= ?room room_2))))))) (not (hold_1))) (when (or (not (locked yellow_door_1)) (and (objectinroom blue_box_1 room_2) (not (and (= ?obj blue_box_1) (= ?room room_2))))) (hold_1)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (locked yellow_door_2) (not (or (not (locked yellow_door_1)) (and (= ?obj blue_box_1) (= ?room room_2)) (objectinroom blue_box_1 room_2)))) (not (hold_1))) (when (or (not (locked yellow_door_1)) (and (= ?obj blue_box_1) (= ?room room_2)) (objectinroom blue_box_1 room_2)) (hold_1)) (increase (total-cost) 1)))
 (:action toggle
  :parameters ( ?door - door)
  :precondition (and (at_ ?door))
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (or (and (not (locked ?door)) (= ?door yellow_door_2)) (and (locked yellow_door_2) (not (and (locked ?door) (= ?door yellow_door_2))))) (hold_0)) (when (and (or (and (not (locked ?door)) (= ?door yellow_door_2)) (and (locked yellow_door_2) (not (and (locked ?door) (= ?door yellow_door_2))))) (not (or (not (or (and (not (locked ?door)) (= ?door yellow_door_1)) (and (locked yellow_door_1) (not (and (locked ?door) (= ?door yellow_door_1)))))) (objectinroom blue_box_1 room_2)))) (not (hold_1))) (when (or (not (or (and (not (locked ?door)) (= ?door yellow_door_1)) (and (locked yellow_door_1) (not (and (locked ?door) (= ?door yellow_door_1)))))) (objectinroom blue_box_1 room_2)) (hold_1)) (increase (total-cost) 1)))
)
