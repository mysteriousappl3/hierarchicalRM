(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_1 blue_ball_1 red_ball_2 blue_ball_2 red_ball_1 - ball
   purple_box_1 blue_box_1 purple_box_2 - box
 )
 ...
 (and (objectcolor ?v bluetype) (objectinroom ?v room_2) (agentinroom room_2) (at_ ?v))) (hold_0)))
