(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 blue_ball_1 green_ball_2 green_ball_1 red_ball_1 yellow_ball_2 - ball
 ...
 (:constraints (sometime (and (not (emptyhands)) (objectinroom green_ball_2 room_2))))
