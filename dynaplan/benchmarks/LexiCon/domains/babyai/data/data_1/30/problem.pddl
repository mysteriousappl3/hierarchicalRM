(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_door_1 red_door_1 blue_door_2 green_door_1 - door
   red_box_2 grey_box_1 red_box_1 - box
   green_ball_2 green_ball_1 red_ball_1 blue_ball_1 purple_ball_1 - ball
 )
 ...
 (:constraints (sometime (not (locked blue_door_2))) (sometime-before (not (locked blue_door_2)) (at_ green_door_1)))
