(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   blue_door_1 blue_door_2 blue_door_3 - door
   grey_box_2 grey_box_1 purple_box_1 grey_box_4 green_box_1 grey_box_3 - box
   green_ball_1 purple_ball_1 - ball
 )
 ...
 (and (objectcolor ?v purpletype) (objectinroom ?v room_4) (agentinroom room_4) (at_ ?v))) (hold_0)))
