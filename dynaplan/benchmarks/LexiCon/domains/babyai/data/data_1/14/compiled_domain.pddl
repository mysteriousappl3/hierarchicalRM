(define (domain liftedtcore_minigrid-domain)
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (or (and (objectinroom purple_box_1 room_3) (not (and (= ?obj purple_box_1) (= ?room room_3)))) (not (locked yellow_door_1))) (hold_0)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (or (and (= ?obj purple_box_1) (= ?room room_3)) (objectinroom purple_box_1 room_3) (not (locked yellow_door_1))) (hold_0)) (increase (total-cost) 1)))
 (:action toggle
