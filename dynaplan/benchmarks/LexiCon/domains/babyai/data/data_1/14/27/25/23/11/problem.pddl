(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_door_1 yellow_door_1 blue_door_1 green_door_1 - door
   red_box_1 green_box_1 - box
   blue_ball_1 yellow_ball_1 green_ball_1 red_ball_1 purple_ball_2 purple_ball_1 - ball
 )
 ...
 (:constraints (sometime (or (not (locked blue_door_1)) (carrying purple_ball_1))))
