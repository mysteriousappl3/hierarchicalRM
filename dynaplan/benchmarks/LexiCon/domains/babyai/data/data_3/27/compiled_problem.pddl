(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   green_door_1 blue_door_1 yellow_door_1 - door
   yellow_ball_1 grey_ball_1 green_ball_1 red_ball_1 - ball
   blue_box_3 blue_box_1 red_box_1 - box
 )
 ...
 (and (objectcolor ?d bluetype) (adjacentrooms room_4 room_2 ?d) (at_ ?d) (not (locked ?d)))) (hold_0) (hold_1)))
