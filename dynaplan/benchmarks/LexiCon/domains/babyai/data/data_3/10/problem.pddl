(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_door_1 green_door_1 purple_door_1 red_door_2 - door
   yellow_ball_1 red_ball_1 red_ball_2 purple_ball_1 - ball
   blue_box_1 yellow_box_1 grey_box_1 blue_box_2 - box
 )
 ...
 (and (objectcolor ?d greentype) (adjacentrooms room_3 room_1 ?d) (at_ ?d) (not (locked ?d))))))
 (:constraints (sometime (at_ blue_box_1)) (sometime (not (locked red_door_1))) (sometime-before (not (locked red_door_1)) (objectinroom red_ball_1 room_3)) (sometime (and (agentinroom room_3) (not (emptyhands)))))
