(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_door_1 red_door_2 yellow_door_1 green_door_1 - door
 ...
 (:constraints (sometime (carrying purple_ball_1)) (sometime (not (locked red_door_1))) (sometime-before (not (locked red_door_1)) (or (not (emptyhands)) (at_ red_door_2))) (sometime (at_ green_door_1)))
