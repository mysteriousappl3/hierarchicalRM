(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 grey_box_2 blue_box_2 grey_box_1 blue_box_1 yellow_box_1 - box
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (objectinroom grey_box_1 room_4)) (sometime (and (objectinroom blue_box_1 room_1) (not (emptyhands)))) (sometime (or (carrying grey_box_1) (objectinroom grey_box_2 room_2))))
