(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   empty - empty_0
   blue_box_1 grey_box_2 grey_box_1 - box
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (objectinroom grey_box_1 room_4) (not (and (= ?obj grey_box_1) (= ?room room_4)))) (seen_psi_1)) (when (and (objectinroom blue_box_1 room_1) (not (and (= ?obj blue_box_1) (= ?room room_1)))) (hold_2)) (when (or (= ?obj grey_box_1) (carrying grey_box_1) (and (objectinroom grey_box_2 room_2) (not (and (= ?obj grey_box_2) (= ?room room_2))))) (hold_3)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (or (and (= ?obj grey_box_1) (= ?room room_4)) (objectinroom grey_box_1 room_4)) (seen_psi_1)) (when (or (and (carrying grey_box_1) (not (= ?obj grey_box_1))) (and (= ?obj grey_box_2) (= ?room room_2)) (objectinroom grey_box_2 room_2)) (hold_3)) (increase (total-cost) 1)))
 (:action toggle
