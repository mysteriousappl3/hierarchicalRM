(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 grey_box_1 blue_box_1 yellow_box_1 - box
   grey_ball_1 red_ball_1 blue_ball_1 grey_ball_2 - ball
 )
 ...
 (:constraints (sometime (and (carrying grey_ball_2) (objectinroom purple_box_1 room_4))) (sometime (or (at_ red_ball_1) (not (locked yellow_door_1)))) (sometime (or (at_ grey_box_1) (not (emptyhands)))))
