(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (emptyhands))) (sometime-after (not (emptyhands)) (or (agentinroom room_4) (not (locked yellow_door_1)))) (sometime (agentinroom room_4)) (sometime (or (objectinroom empty room_1) (carrying blue_box_1))))
