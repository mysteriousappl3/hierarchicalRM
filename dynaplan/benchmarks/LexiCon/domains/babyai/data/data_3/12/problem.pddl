(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_ball_2 grey_ball_1 blue_ball_1 grey_ball_2 - ball
   green_box_1 grey_box_1 green_box_2 yellow_box_1 - box
 )
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (at_ purple_door_1)) (sometime (at_ purple_door_2)) (sometime-before (at_ purple_door_2) (or (carrying grey_ball_2) (objectinroom grey_box_1 room_4))) (sometime (or (objectinroom blue_ball_2 room_4) (objectinroom yellow_box_1 room_3))))
