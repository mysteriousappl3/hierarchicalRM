(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 blue_ball_1 yellow_ball_2 - ball
 ...
 (:constraints (always (locked purple_door_1)) (always (not (agentinroom room_1))) (sometime (agentinroom room_3)) (sometime-before (agentinroom room_3) (or (at_ yellow_ball_2) (at_ empty))))
