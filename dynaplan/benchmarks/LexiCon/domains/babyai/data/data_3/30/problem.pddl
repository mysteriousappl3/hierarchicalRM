(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 red_box_2 grey_box_1 blue_box_1 grey_box_2 red_box_1 - box
 ...
 (:constraints (always (not (agentinroom room_4))) (sometime (locked green_door_1)) (sometime-after (locked green_door_1) (carrying blue_box_1)) (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (carrying blue_box_1)))
