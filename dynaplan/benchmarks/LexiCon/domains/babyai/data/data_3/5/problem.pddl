(define (problem minigrid-problem)
 ...
 (:constraints (always (locked yellow_door_1)) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (or (not (emptyhands)) (at_ yellow_door_2))) (sometime (or (at_ green_ball_1) (not (locked green_door_1)))))
