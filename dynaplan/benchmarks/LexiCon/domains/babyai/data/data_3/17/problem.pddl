(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 red_ball_2 red_ball_1 purple_ball_1 - ball
   green_box_1 grey_box_1 blue_box_1 yellow_box_1 - box
 )
 ...
 (:constraints (sometime (at_ blue_door_2)) (sometime-before (at_ blue_door_2) (carrying red_ball_2)) (always (locked blue_door_2)) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (or (objectinroom green_box_1 room_4) (not (emptyhands)))))
