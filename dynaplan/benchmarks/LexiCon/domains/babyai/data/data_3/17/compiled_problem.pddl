(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 red_ball_1 purple_ball_1 - ball
   grey_box_1 blue_box_1 yellow_box_1 - box
 )
 ...
 (and (objectcolor ?d purpletype) (adjacentrooms room_3 room_4 ?d) (at_ ?d) (not (locked ?d)))) (hold_0) (hold_2)))
