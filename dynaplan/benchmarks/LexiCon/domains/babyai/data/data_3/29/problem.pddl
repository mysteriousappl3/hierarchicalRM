(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_3 yellow_box_2 yellow_box_1 red_box_1 - box
 ...
 (:constraints (always (not (agentinroom room_2))) (sometime (carrying yellow_box_2)) (always (locked purple_door_1)))
