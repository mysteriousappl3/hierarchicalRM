(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   blue_door_1 red_door_1 blue_door_2 - door
   yellow_box_3 yellow_box_1 red_box_1 - box
   grey_ball_1 grey_ball_3 blue_ball_1 grey_ball_2 - ball
 )
 ...
 (and (objectcolor ?d bluetype) (adjacentrooms room_1 room_2 ?d) (at_ ?d) (not (locked ?d)))) (hold_0)))
