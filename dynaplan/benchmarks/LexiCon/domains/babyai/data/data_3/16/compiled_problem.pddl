(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   grey_door_1 green_door_1 red_door_2 - door
   yellow_box_2 green_box_1 yellow_box_1 - box
   green_ball_1 red_ball_2 green_ball_2 - ball
 )
 ...
 (and (objectcolor ?d redtype) (adjacentrooms room_3 room_4 ?d) (at_ ?d) (not (locked ?d)))) (hold_0) (hold_2)))
