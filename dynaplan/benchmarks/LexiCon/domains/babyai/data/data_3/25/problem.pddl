(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_ball_2 grey_ball_1 green_ball_1 blue_ball_1 purple_ball_1 - ball
   green_box_1 grey_box_1 blue_box_1 - box
 )
 ...
 (:constraints (sometime (locked blue_door_1)) (sometime-after (locked blue_door_1) (not (emptyhands))) (sometime (not (locked blue_door_1))) (sometime-before (not (locked blue_door_1)) (agentinroom room_1)) (sometime (or (at_ purple_door_1) (carrying green_box_1))))
