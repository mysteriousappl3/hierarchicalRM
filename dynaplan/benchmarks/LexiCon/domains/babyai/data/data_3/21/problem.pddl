(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_ball_2 yellow_ball_1 grey_ball_1 green_ball_1 green_ball_2 red_ball_1 blue_ball_1 - ball
   purple_box_1 - box
 )
 ...
 (:constraints (sometime (not (locked red_door_1))) (always (not (agentinroom room_2))) (sometime (at_ purple_door_2)) (sometime-after (at_ purple_door_2) (or (agentinroom room_3) (not (emptyhands)))))
