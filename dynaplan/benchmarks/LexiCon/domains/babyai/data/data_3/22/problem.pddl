(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 blue_ball_1 purple_ball_1 - ball
   green_box_1 blue_box_2 blue_box_1 yellow_box_1 red_box_1 - box
 )
 ...
 (:constraints (sometime (locked yellow_door_2)) (sometime-after (locked yellow_door_2) (or (not (locked yellow_door_1)) (objectinroom yellow_box_1 room_2))) (sometime (at_ purple_ball_1)) (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (not (emptyhands))))
