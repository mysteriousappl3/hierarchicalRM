(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (and (locked red_door_1) (not (or (carrying red_ball_1) (= ?room2 room_1) (and (agentinroom room_1) (not (= ?room1 room_1)))))) (not (hold_1))) (when (or (carrying red_ball_1) (= ?room2 room_1) (and (agentinroom room_1) (not (= ?room1 room_1)))) (hold_1)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (locked red_door_1) (not (or (= ?obj red_ball_1) (carrying red_ball_1) (agentinroom room_1)))) (not (hold_1))) (when (or (= ?obj red_ball_1) (carrying red_ball_1) (agentinroom room_1)) (hold_1)) (seen_psi_3) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (locked red_door_1) (not (or (and (carrying red_ball_1) (not (= ?obj red_ball_1))) (agentinroom room_1)))) (not (hold_1))) (when (or (and (carrying red_ball_1) (not (= ?obj red_ball_1))) (agentinroom room_1)) (hold_1)) (when (and (carrying red_ball_2) (not (= ?obj red_ball_2))) (seen_psi_3)) (increase (total-cost) 1)))
 (:action toggle
  :parameters ( ?door - door)
  :precondition (and (at_ ?door))
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (or (and (not (locked ?door)) (= ?door red_door_1)) (and (locked red_door_1) (not (and (locked ?door) (= ?door red_door_1))))) (hold_0)) (when (and (or (and (not (locked ?door)) (= ?door red_door_1)) (and (locked red_door_1) (not (and (locked ?door) (= ?door red_door_1))))) (not (or (carrying red_ball_1) (agentinroom room_1)))) (not (hold_1))) (increase (total-cost) 1)))
)
