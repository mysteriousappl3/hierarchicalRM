(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 grey_ball_1 green_ball_1 green_ball_2 - ball
   purple_box_1 grey_box_1 yellow_box_1 grey_box_2 - box
 )
 ...
 (:constraints (sometime (and (not (locked green_door_1)) (at_ yellow_ball_1))) (sometime (or (not (emptyhands)) (objectinroom grey_box_1 room_2))) (sometime (or (not (locked green_door_2)) (at_ grey_box_1))))
