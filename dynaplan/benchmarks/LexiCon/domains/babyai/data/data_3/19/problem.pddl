(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 blue_box_2 blue_box_1 yellow_box_1 purple_box_2 red_box_1 - box
 ...
 (:constraints (always (locked red_door_1)) (sometime (or (at_ red_box_1) (agentinroom room_2))) (sometime (not (emptyhands))) (sometime-before (not (emptyhands)) (or (objectinroom purple_box_1 room_4) (agentinroom room_1))))
