(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (= ?room2 room_3) (and (agentinroom room_3) (not (= ?room1 room_3)))) (hold_0)) (when (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4)))) (hold_2)) (when (and (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4)))) (not (or (= ?room2 room_1) (and (agentinroom room_1) (not (= ?room1 room_1))) (carrying grey_ball_1)))) (not (hold_3))) (when (or (= ?room2 room_1) (and (agentinroom room_1) (not (= ?room1 room_1))) (carrying grey_ball_1)) (hold_3)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (or (= ?obj red_box_1) (carrying red_box_1)) (seen_psi_1)) (when (and (agentinroom room_4) (not (or (agentinroom room_1) (= ?obj grey_ball_1) (carrying grey_ball_1)))) (not (hold_3))) (when (or (agentinroom room_1) (= ?obj grey_ball_1) (carrying grey_ball_1)) (hold_3)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (carrying red_box_1) (not (= ?obj red_box_1))) (seen_psi_1)) (when (and (agentinroom room_4) (not (or (agentinroom room_1) (and (carrying grey_ball_1) (not (= ?obj grey_ball_1)))))) (not (hold_3))) (when (or (agentinroom room_1) (and (carrying grey_ball_1) (not (= ?obj grey_ball_1)))) (hold_3)) (increase (total-cost) 1)))
 (:action toggle
  :parameters ( ?door - door)
  :precondition (and (at_ ?door) (or (and (not (locked ?door)) (= ?door yellow_door_2)) (and (locked yellow_door_2) (not (and (locked ?door) (= ?door yellow_door_2))))))
