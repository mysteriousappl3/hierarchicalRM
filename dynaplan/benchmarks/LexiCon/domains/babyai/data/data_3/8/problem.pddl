(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_door_1 grey_door_1 yellow_door_1 yellow_door_2 - door
   purple_box_1 yellow_box_1 red_box_2 purple_box_2 red_box_1 - box
   purple_ball_1 grey_ball_1 blue_ball_1 - ball
 )
 ...
 (and (objectcolor ?v redtype) (agentinroom room_3) (objectinroom ?v room_3) (emptyhands) (at_ ?v)))))
 (:constraints (always (locked yellow_door_2)) (sometime (agentinroom room_3)) (sometime-before (agentinroom room_3) (carrying red_box_1)) (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (or (agentinroom room_1) (carrying grey_ball_1))))
