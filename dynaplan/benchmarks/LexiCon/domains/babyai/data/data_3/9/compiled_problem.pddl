(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   yellow_door_1 purple_door_1 purple_door_2 - door
   grey_ball_2 blue_ball_1 - ball
 ...
 (and (objectcolor ?v bluetype) (carrying ?v) (agentinroom room_1))) (hold_0) (hold_2) (hold_3)))
