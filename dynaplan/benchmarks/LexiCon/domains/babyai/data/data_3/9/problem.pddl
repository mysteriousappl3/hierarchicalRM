(define (problem minigrid-problem)
 ...
 (:constraints (sometime (agentinroom room_1)) (sometime-before (agentinroom room_1) (not (locked grey_door_1))) (sometime (or (objectinroom grey_ball_1 room_2) (at_ blue_ball_2))) (sometime (and (carrying purple_ball_1) (at_ blue_ball_2))))
