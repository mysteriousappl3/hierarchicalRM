(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_2 purple_ball_1 blue_ball_1 yellow_ball_1 - ball
   yellow_box_1 grey_box_2 green_box_1 grey_box_1 - box
 )
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (at_ blue_door_3)) (sometime (and (agentinroom room_3) (objectinroom yellow_ball_1 room_3))) (sometime (agentinroom room_1)) (sometime (objectinroom purple_ball_1 room_3)))
