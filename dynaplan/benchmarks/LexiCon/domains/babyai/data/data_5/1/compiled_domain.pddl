(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   red_ball_1 - ball
   empty - empty_0
   blue_door_1 red_door_1 grey_door_1 - door
   room_4 - room
 )
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (seen_psi_1) (when (and (at_ red_ball_1) (not (= ?obj red_ball_1))) (seen_psi_3)) (hold_4) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
 ...
 (:action toggle
  ...
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (not (or (and (not (locked ?door)) (= ?door red_door_1)) (and (locked red_door_1) (not (and (locked ?door) (= ?door red_door_1)))))) (hold_5)) (increase (total-cost) 1)))
)
