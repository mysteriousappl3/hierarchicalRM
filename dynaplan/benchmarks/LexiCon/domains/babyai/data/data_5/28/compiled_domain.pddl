(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoobject
  ...
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?obj) (when (= ?obj red_box_2) (hold_4)) (increase (total-cost) 1)))
 (:action gotoempty
  :parameters ()
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (locked green_door_1) (not (or (= ?obj red_box_2) (carrying red_box_2)))) (not (hold_1))) (when (or (= ?obj red_box_2) (carrying red_box_2)) (hold_1)) (when (or (= ?obj red_box_2) (carrying red_box_2)) (seen_psi_3)) (when (and (at_ red_box_2) (not (= ?obj red_box_2))) (hold_4)) (hold_6) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (locked green_door_1) (not (and (carrying red_box_2) (not (= ?obj red_box_2))))) (not (hold_1))) (when (and (carrying red_box_2) (not (= ?obj red_box_2))) (hold_1)) (when (and (carrying red_box_2) (not (= ?obj red_box_2))) (seen_psi_3)) (when (or (= ?obj red_box_2) (at_ red_box_2)) (hold_4)) (when (and (agentinroom room_3) (locked red_door_1)) (not (hold_6))) (when (not (locked red_door_1)) (hold_6)) (increase (total-cost) 1)))
 (:action toggle
  ...
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1))))) (hold_0)) (when (and (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1))))) (not (carrying red_box_2))) (not (hold_1))) (when (not (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1)))))) (hold_2)) (when (and (agentinroom room_3) (not (or (not (or (and (not (locked ?door)) (= ?door red_door_1)) (and (locked red_door_1) (not (and (locked ?door) (= ?door red_door_1)))))) (not (emptyhands))))) (not (hold_6))) (when (or (not (or (and (not (locked ?door)) (= ?door red_door_1)) (and (locked red_door_1) (not (and (locked ?door) (= ?door red_door_1)))))) (not (emptyhands))) (hold_6)) (increase (total-cost) 1)))
)
