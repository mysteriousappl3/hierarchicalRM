(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_box_1 green_box_1 red_box_2 - box
   blue_ball_1 purple_ball_1 purple_ball_2 blue_ball_2 red_ball_1 - ball
 )
 ...
 (:constraints (always (locked purple_door_1)) (sometime (carrying blue_ball_1)) (sometime (and (not (locked grey_door_1)) (not (locked blue_door_1)))) (sometime (at_ purple_door_1)) (sometime-before (at_ purple_door_1) (or (not (locked purple_door_1)) (not (emptyhands)))) (sometime (agentinroom room_1)) (sometime-before (agentinroom room_1) (and (not (emptyhands)) (objectinroom blue_ball_1 room_3))))
