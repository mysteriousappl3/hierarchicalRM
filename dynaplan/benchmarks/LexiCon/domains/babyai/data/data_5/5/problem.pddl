(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (emptyhands))) (always (not (agentinroom room_3))) (always (locked purple_door_1)) (sometime (at_ yellow_door_1)) (sometime-before (at_ yellow_door_1) (not (emptyhands))) (sometime (at_ purple_door_1)) (sometime-before (at_ purple_door_1) (or (agentinroom room_1) (not (emptyhands)))))
