(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_1 grey_box_1 green_box_2 green_box_1 - box
 )
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (at_ purple_door_1)) (sometime (at_ purple_door_2)) (sometime-before (at_ purple_door_2) (or (objectinroom green_box_2 room_2) (carrying green_box_1))) (sometime (locked purple_door_2)) (sometime-after (locked purple_door_2) (not (emptyhands))) (sometime (not (locked purple_door_2))) (sometime-before (not (locked purple_door_2)) (or (objectinroom green_box_2 room_1) (agentinroom room_3))) (sometime (at_ yellow_door_1)) (sometime-before (at_ yellow_door_1) (or (agentinroom room_2) (carrying green_box_2))))
