(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_door_1 green_door_1 purple_door_2 grey_door_1 - door
 ...
 (:constraints (always (not (agentinroom room_1))) (always (locked green_door_1)) (always (locked purple_door_1)) (sometime (not (locked grey_door_1))) (sometime (not (emptyhands))))
