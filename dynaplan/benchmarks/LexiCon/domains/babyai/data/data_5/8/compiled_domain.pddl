(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   empty - empty_0
   room_1 - room
   green_door_1 purple_door_1 grey_door_1 - door
 )
 ...
 (:action toggle
  ...
  :precondition (and (at_ ?door) (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1))))) (or (and (not (locked ?door)) (= ?door purple_door_1)) (and (locked purple_door_1) (not (and (locked ?door) (= ?door purple_door_1))))))
