(define (problem minigrid-problem)
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (agentinroom room_1)) (sometime (objectinroom yellow_box_1 room_3)) (sometime (not (locked blue_door_2))) (sometime-after (not (locked blue_door_2)) (or (agentinroom room_4) (at_ yellow_box_1))) (sometime (locked blue_door_2)) (sometime-after (locked blue_door_2) (or (carrying yellow_ball_1) (objectinroom grey_box_1 room_2))) (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (or (agentinroom room_2) (not (emptyhands)))))
