(define (problem minigrid-problem)
 ...
 (:constraints (sometime (or (not (emptyhands)) (not (locked red_door_2)))) (sometime (not (locked red_door_2))) (always (locked red_door_1)) (sometime (at_ yellow_ball_1)) (sometime (not (locked blue_door_1))) (sometime-after (not (locked blue_door_1)) (or (objectinroom green_ball_1 room_2) (agentinroom room_4))))
