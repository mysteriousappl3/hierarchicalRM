(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   blue_door_1 - door
   purple_box_1 grey_box_4 grey_box_1 grey_box_2 green_box_1 grey_box_3 - box
   green_ball_1 - ball
 )
 ...
 (and (objectcolor ?v purpletype) (objectinroom ?v room_4) (agentinroom room_4) (at_ ?v))) (hold_0) (hold_1) (hold_3) (hold_5)))
