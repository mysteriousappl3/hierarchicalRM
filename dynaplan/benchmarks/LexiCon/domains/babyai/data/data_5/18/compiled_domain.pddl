(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoobject
  ...
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?obj) (when (and (not (locked green_door_1)) (= ?obj purple_box_1)) (hold_0)) (increase (total-cost) 1)))
 (:action gotoempty
  :parameters ()
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (not (emptyhands)) (= ?room2 room_1) (and (agentinroom room_1) (not (= ?room1 room_1)))) (hold_3)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (not (locked green_door_1)) (at_ purple_box_1) (not (= ?obj purple_box_1))) (hold_0)) (hold_1) (when (or (not (locked green_door_2)) (= ?obj grey_ball_1) (carrying grey_ball_1)) (hold_2)) (hold_3) (hold_4) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (not (locked green_door_1)) (or (= ?obj purple_box_1) (at_ purple_box_1))) (hold_0)) (when (or (and (= ?obj grey_ball_1) (= ?room room_2)) (objectinroom grey_ball_1 room_2)) (hold_1)) (when (or (not (locked green_door_2)) (and (carrying grey_ball_1) (not (= ?obj grey_ball_1)))) (hold_2)) (when (agentinroom room_1) (hold_3)) (when (and (carrying yellow_box_1) (not (= ?obj yellow_box_1))) (hold_4)) (increase (total-cost) 1)))
 (:action toggle
  :parameters ( ?door - door)
  :precondition (and (at_ ?door))
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (and (not (or (and (not (locked ?door)) (= ?door green_door_1)) (and (locked green_door_1) (not (and (locked ?door) (= ?door green_door_1)))))) (at_ purple_box_1)) (hold_0)) (when (or (not (or (and (not (locked ?door)) (= ?door green_door_2)) (and (locked green_door_2) (not (and (locked ?door) (= ?door green_door_2)))))) (carrying grey_ball_1)) (hold_2)) (increase (total-cost) 1)))
)
