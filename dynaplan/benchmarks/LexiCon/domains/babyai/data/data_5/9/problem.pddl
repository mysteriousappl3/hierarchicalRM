(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_ball_1 green_ball_2 blue_ball_3 blue_ball_1 blue_ball_2 yellow_ball_1 - ball
 )
 ...
 (:constraints (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (or (not (emptyhands)) (at_ yellow_ball_1))) (sometime (agentinroom room_1)) (sometime-after (agentinroom room_1) (not (emptyhands))) (sometime (and (not (emptyhands)) (objectinroom green_ball_2 room_4))) (always (locked green_door_1)) (sometime (carrying green_ball_1)))
