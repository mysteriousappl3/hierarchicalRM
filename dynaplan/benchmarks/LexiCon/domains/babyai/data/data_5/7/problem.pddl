(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_box_3 purple_box_1 grey_box_1 blue_box_1 blue_box_2 - box
 ...
 (:constraints (sometime (or (objectinroom blue_box_1 room_3) (at_ grey_box_1))) (sometime (and (carrying blue_box_3) (not (locked yellow_door_2)))) (sometime (at_ yellow_door_1)) (sometime (and (agentinroom room_4) (not (emptyhands)))) (sometime (or (at_ grey_box_1) (not (locked red_door_1)))))
