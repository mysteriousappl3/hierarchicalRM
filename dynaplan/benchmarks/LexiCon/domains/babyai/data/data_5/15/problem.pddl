(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 yellow_box_1 grey_box_1 blue_box_1 - box
   red_ball_1 grey_ball_2 blue_ball_1 grey_ball_1 - ball
 )
 ...
 (:constraints (sometime (and (carrying blue_box_1) (objectinroom purple_box_1 room_4))) (sometime (or (objectinroom red_ball_1 room_3) (at_ blue_ball_1))) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (not (emptyhands))) (always (locked grey_door_1)) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (or (objectinroom blue_box_1 room_3) (at_ yellow_door_1))))
