(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (not (locked yellow_door_1))) (always (locked red_door_1)) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (and (carrying purple_box_1) (objectinroom blue_box_1 room_2))))
