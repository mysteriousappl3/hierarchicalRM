(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2)))) (hold_2)) (when (and (or (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2)))) (not (and (carrying purple_box_1) (objectinroom blue_box_1 room_2)))) (not (hold_3))) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (hold_0) (when (and (agentinroom room_2) (not (and (or (= ?obj purple_box_1) (carrying purple_box_1)) (objectinroom blue_box_1 room_2) (not (and (= ?obj blue_box_1) (= ?room room_2)))))) (not (hold_3))) (when (and (or (= ?obj purple_box_1) (carrying purple_box_1)) (objectinroom blue_box_1 room_2) (not (and (= ?obj blue_box_1) (= ?room room_2)))) (hold_3)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (agentinroom room_2) (not (and (carrying purple_box_1) (not (= ?obj purple_box_1)) (or (and (= ?obj blue_box_1) (= ?room room_2)) (objectinroom blue_box_1 room_2))))) (not (hold_3))) (when (and (carrying purple_box_1) (not (= ?obj purple_box_1)) (or (and (= ?obj blue_box_1) (= ?room room_2)) (objectinroom blue_box_1 room_2))) (hold_3)) (increase (total-cost) 1)))
 (:action toggle
