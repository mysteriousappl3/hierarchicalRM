(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_1 purple_ball_1 grey_ball_2 red_ball_1 - ball
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (carrying yellow_box_1)) (sometime (locked green_door_1)) (sometime-after (locked green_door_1) (carrying yellow_box_1)) (sometime (or (at_ yellow_box_1) (objectinroom purple_box_1 room_4))) (sometime (carrying green_box_1)) (sometime (agentinroom room_2)))
