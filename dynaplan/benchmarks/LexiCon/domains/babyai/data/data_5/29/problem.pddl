(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (emptyhands))) (sometime-before (not (emptyhands)) (at_ purple_ball_1)) (sometime (objectinroom grey_box_1 room_4)) (sometime (agentinroom room_4)) (sometime (and (not (locked grey_door_3)) (carrying yellow_ball_1))) (sometime (at_ purple_ball_2)))
