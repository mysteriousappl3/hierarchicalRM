(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (and (not (emptyhands)) (not (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4))) (not (locked yellow_door_1))))) (not (hold_1))) (when (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4))) (not (locked yellow_door_1))) (hold_1)) (when (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4)))) (hold_2)) (when (and (emptyhands) (not (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4))) (objectinroom purple_ball_1 room_4)))) (not (hold_6))) (when (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4))) (objectinroom purple_ball_1 room_4)) (hold_6)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (hold_0) (when (not (or (agentinroom room_4) (not (locked yellow_door_1)))) (not (hold_1))) (when (or (and (objectinroom empty room_1) (not (and (= ?obj empty) (= ?room room_1)))) (= ?obj purple_ball_1) (carrying purple_ball_1)) (hold_3)) (when (or (agentinroom room_4) (and (objectinroom purple_ball_1 room_4) (not (and (= ?obj purple_ball_1) (= ?room room_4))))) (hold_6)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (or (and (= ?obj empty) (= ?room room_1)) (objectinroom empty room_1) (and (carrying purple_ball_1) (not (= ?obj purple_ball_1)))) (hold_3)) (hold_5) (when (not (or (agentinroom room_4) (and (= ?obj purple_ball_1) (= ?room room_4)) (objectinroom purple_ball_1 room_4))) (not (hold_6))) (when (or (agentinroom room_4) (and (= ?obj purple_ball_1) (= ?room room_4)) (objectinroom purple_ball_1 room_4)) (hold_6)) (increase (total-cost) 1)))
 (:action toggle
  :parameters ( ?door - door)
  :precondition (and (at_ ?door))
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (and (not (emptyhands)) (not (or (agentinroom room_4) (not (or (and (not (locked ?door)) (= ?door yellow_door_1)) (and (locked yellow_door_1) (not (and (locked ?door) (= ?door yellow_door_1))))))))) (not (hold_1))) (when (or (agentinroom room_4) (not (or (and (not (locked ?door)) (= ?door yellow_door_1)) (and (locked yellow_door_1) (not (and (locked ?door) (= ?door yellow_door_1))))))) (hold_1)) (when (not (or (and (not (locked ?door)) (= ?door yellow_door_1)) (and (locked yellow_door_1) (not (and (locked ?door) (= ?door yellow_door_1)))))) (hold_4)) (increase (total-cost) 1)))
)
