(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_ball_1 purple_ball_1 grey_ball_1 blue_ball_2 green_ball_1 - ball
 ...
 (:constraints (sometime (locked blue_door_1)) (sometime-after (locked blue_door_1) (not (emptyhands))) (sometime (not (locked blue_door_1))) (sometime-before (not (locked blue_door_1)) (agentinroom room_1)) (sometime (or (at_ purple_door_1) (carrying purple_ball_1))) (sometime (objectinroom blue_ball_1 room_1)) (sometime (not (emptyhands))))
