(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 - box
   yellow_ball_1 red_ball_1 blue_ball_1 grey_ball_1 green_ball_2 blue_ball_2 green_ball_1 - ball
 )
 ...
 (:constraints (sometime (not (locked red_door_1))) (always (not (agentinroom room_2))) (sometime (at_ purple_door_2)) (sometime-after (at_ purple_door_2) (or (agentinroom room_3) (not (emptyhands)))) (sometime (not (locked yellow_door_1))) (sometime (and (not (emptyhands)) (not (locked red_door_1)))))
