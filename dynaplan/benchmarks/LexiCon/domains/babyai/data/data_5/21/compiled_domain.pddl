(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   empty - empty_0
   yellow_door_1 purple_door_2 red_door_1 - door
   room_2 room_3 - room
 )
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (hold_2) (when (not (locked red_door_1)) (hold_4)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (at_ purple_door_2) (not (agentinroom room_3))) (not (hold_2))) (when (agentinroom room_3) (hold_2)) (increase (total-cost) 1)))
 (:action toggle
