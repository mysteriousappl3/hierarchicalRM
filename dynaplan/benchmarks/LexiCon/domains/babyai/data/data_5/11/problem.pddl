(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 blue_box_1 purple_box_2 green_box_2 green_box_1 - box
 ...
 (:constraints (always (locked purple_door_1)) (always (not (agentinroom room_1))) (sometime (agentinroom room_3)) (sometime-before (agentinroom room_3) (or (at_ green_box_2) (at_ empty))) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (or (at_ yellow_ball_1) (carrying blue_box_1))) (sometime (at_ purple_door_1)) (sometime-before (at_ purple_door_1) (or (at_ green_box_2) (agentinroom room_4))))
