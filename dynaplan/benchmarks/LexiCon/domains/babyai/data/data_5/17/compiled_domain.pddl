(define (domain liftedtcore_minigrid-domain)
 ...
 (:action gotoobject
  ...
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?obj) (when (and (not (emptyhands)) (= ?obj yellow_box_1)) (hold_5)) (increase (total-cost) 1)))
 (:action gotoempty
  :parameters ()
 ...
 (not (blocked ?door ?o ?room1))) (or (not (= ?door blue_door_2)) (seen_psi_1)))
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?door) (when (= ?door blue_door_2) (hold_0)) (increase (total-cost) 1)))
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (= ?room2 room_4) (and (agentinroom room_4) (not (= ?room1 room_4)))) (hold_2)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (or (= ?obj purple_ball_1) (carrying purple_ball_1)) (seen_psi_1)) (seen_psi_3) (when (or (= ?obj purple_ball_1) (carrying purple_ball_1) (and (objectinroom empty room_3) (not (and (= ?obj empty) (= ?room room_3))))) (hold_4)) (when (and (at_ yellow_box_1) (not (= ?obj yellow_box_1))) (hold_5)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (carrying purple_ball_1) (not (= ?obj purple_ball_1))) (seen_psi_1)) (when (or (and (= ?obj red_ball_1) (= ?room room_4)) (objectinroom red_ball_1 room_4)) (seen_psi_3)) (when (or (and (carrying purple_ball_1) (not (= ?obj purple_ball_1))) (and (= ?obj empty) (= ?room room_3)) (objectinroom empty room_3)) (hold_4)) (increase (total-cost) 1)))
 (:action toggle
