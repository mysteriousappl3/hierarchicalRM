(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 red_ball_1 purple_ball_1 red_ball_2 - ball
   yellow_box_1 grey_box_1 blue_box_1 green_box_1 - box
 )
 ...
 (:constraints (sometime (at_ blue_door_2)) (sometime-before (at_ blue_door_2) (carrying purple_ball_1)) (always (locked blue_door_2)) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (or (objectinroom red_ball_1 room_4) (not (emptyhands)))) (sometime (or (carrying purple_ball_1) (objectinroom empty room_3))) (sometime (and (not (emptyhands)) (at_ yellow_box_1))))
