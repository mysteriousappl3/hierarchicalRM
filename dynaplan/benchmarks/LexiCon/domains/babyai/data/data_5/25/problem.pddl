(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_ball_1 purple_ball_1 grey_ball_1 red_ball_4 red_ball_2 red_ball_3 - ball
 ...
 (:constraints (sometime (locked red_door_1)) (sometime-after (locked red_door_1) (or (carrying red_ball_2) (agentinroom room_1))) (always (not (agentinroom room_4))) (sometime (at_ grey_door_1)) (sometime-before (at_ grey_door_1) (or (not (emptyhands)) (carrying red_ball_4))) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (objectinroom red_ball_3 room_3)) (sometime (carrying red_ball_3)))
