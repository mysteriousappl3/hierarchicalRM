(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_box_1 blue_box_2 red_box_1 yellow_box_1 purple_box_2 blue_box_1 - box
 ...
 (:constraints (always (locked red_door_1)) (sometime (or (at_ purple_ball_2) (agentinroom room_2))) (sometime (not (emptyhands))) (sometime-before (not (emptyhands)) (or (objectinroom purple_box_1 room_4) (agentinroom room_1))) (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (at_ red_box_1)) (sometime (or (at_ yellow_box_1) (at_ purple_door_1))))
