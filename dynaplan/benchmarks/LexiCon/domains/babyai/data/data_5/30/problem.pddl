(define (problem minigrid-problem)
 ...
 (:constraints (sometime (at_ yellow_box_1)) (sometime (at_ blue_door_1)) (sometime-before (at_ blue_door_1) (carrying grey_ball_3)) (sometime (locked blue_door_1)) (sometime-after (locked blue_door_1) (or (agentinroom room_4) (not (emptyhands)))) (sometime (carrying red_box_1)) (sometime (not (locked blue_door_1))) (sometime-before (not (locked blue_door_1)) (carrying yellow_ball_1)))
