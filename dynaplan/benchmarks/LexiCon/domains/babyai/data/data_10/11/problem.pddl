(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_box_1 purple_box_1 grey_box_3 grey_box_4 grey_box_2 grey_box_1 - box
 ...
 (:constraints (sometime (at_ green_door_1)) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (or (agentinroom room_1) (carrying grey_box_3))) (always (locked blue_door_3)) (sometime (at_ blue_door_3)) (sometime-before (at_ blue_door_3) (or (not (locked blue_door_2)) (carrying purple_box_1))) (sometime (agentinroom room_3)) (sometime (objectinroom grey_box_3 room_4)) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (not (emptyhands))) (sometime (or (not (emptyhands)) (carrying purple_box_1))) (sometime (carrying green_box_1)) (sometime (not (emptyhands))))
