(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_door_1 grey_door_1 blue_door_1 green_door_1 - door
   blue_ball_1 blue_ball_2 red_ball_1 green_ball_1 - ball
   green_box_1 grey_box_1 purple_box_1 yellow_box_1 - box
 )
 ...
 (:constraints (sometime (at_ blue_ball_2)) (sometime (agentinroom room_3)) (sometime (and (at_ red_ball_1) (agentinroom room_4))) (sometime (carrying blue_ball_2)) (sometime (or (at_ purple_box_1) (not (locked grey_door_1)))) (sometime (objectinroom blue_ball_2 room_3)) (sometime (objectinroom green_box_1 room_2)) (sometime (and (not (emptyhands)) (agentinroom room_2))) (sometime (at_ empty)))
