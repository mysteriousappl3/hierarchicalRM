(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-after (not (locked green_door_1)) (and (carrying red_ball_1) (at_ green_box_1))) (sometime (locked red_door_1)) (sometime-after (locked red_door_1) (at_ green_ball_1)) (sometime (not (locked red_door_1))) (sometime-before (not (locked red_door_1)) (and (at_ red_box_2) (carrying grey_box_1))) (always (not (agentinroom room_3))) (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (not (emptyhands))) (sometime (carrying grey_box_1)) (sometime (agentinroom room_1)))
