(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (locked grey_door_1))) (always (locked yellow_door_1)) (sometime (agentinroom room_1)) (sometime-before (agentinroom room_1) (not (emptyhands))) (sometime (agentinroom room_3)) (sometime-after (agentinroom room_3) (not (emptyhands))) (sometime (at_ green_door_2)) (sometime (at_ yellow_door_1)) (sometime-after (at_ yellow_door_1) (carrying blue_box_1)) (sometime (agentinroom room_2)))
