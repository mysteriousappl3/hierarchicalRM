(define (problem minigrid-problem)
 ...
 (:constraints (always (locked red_door_1)) (sometime (agentinroom room_3)) (sometime-before (agentinroom room_3) (or (at_ empty) (not (emptyhands)))) (sometime (agentinroom room_4)) (sometime (not (locked yellow_door_1))) (sometime (agentinroom room_1)) (sometime-after (agentinroom room_1) (not (locked green_door_1))) (sometime (and (not (locked blue_door_1)) (carrying green_box_2))) (sometime (or (objectinroom grey_ball_1 room_1) (at_ yellow_door_1))) (sometime (at_ red_door_1)) (sometime-after (at_ red_door_1) (and (not (locked blue_door_1)) (carrying green_box_1))))
