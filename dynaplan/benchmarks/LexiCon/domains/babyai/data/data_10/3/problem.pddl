(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_ball_1 yellow_ball_2 yellow_ball_1 red_ball_1 green_ball_1 - ball
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (not (locked yellow_door_1))) (always (locked red_door_1)) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (and (carrying red_ball_1) (objectinroom yellow_ball_2 room_2))) (sometime (not (locked purple_door_1))) (sometime (objectinroom blue_box_1 room_1)) (sometime (at_ purple_box_1)) (sometime-before (at_ purple_box_1) (or (carrying green_ball_1) (not (emptyhands)))) (sometime (agentinroom room_1)) (sometime-before (agentinroom room_1) (not (locked grey_door_1))))
