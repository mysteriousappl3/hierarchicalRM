(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_door_1 green_door_1 yellow_door_1 grey_door_1 - door
   purple_ball_1 green_ball_1 yellow_ball_1 blue_ball_1 - ball
   purple_box_1 red_box_1 purple_box_2 blue_box_1 - box
 )
 ...
 (:constraints (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (not (emptyhands))) (sometime (locked grey_door_1)) (sometime-after (locked grey_door_1) (or (at_ green_ball_1) (at_ purple_ball_1))) (sometime (or (carrying purple_ball_1) (not (emptyhands)))) (sometime (not (emptyhands))) (sometime (agentinroom room_3)) (sometime (or (agentinroom room_3) (not (locked yellow_door_1)))) (sometime (and (at_ green_door_1) (not (locked yellow_door_1)))) (sometime (at_ purple_ball_1)) (sometime (and (agentinroom room_3) (carrying purple_box_1))) (sometime (at_ grey_door_1)) (sometime-before (at_ grey_door_1) (objectinroom purple_box_1 room_1)))
