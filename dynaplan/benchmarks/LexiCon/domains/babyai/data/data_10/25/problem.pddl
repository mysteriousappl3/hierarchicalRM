(define (problem minigrid-problem)
 ...
 (:constraints (sometime (or (carrying green_box_1) (not (emptyhands)))) (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (not (emptyhands))) (sometime (at_ green_box_1)) (sometime-before (at_ green_box_1) (at_ yellow_door_1)) (sometime (not (locked yellow_door_2))) (sometime-before (not (locked yellow_door_2)) (carrying blue_box_1)) (always (not (agentinroom room_2))) (sometime (carrying green_box_1)) (sometime (carrying purple_ball_1)) (sometime (and (not (emptyhands)) (carrying purple_ball_1))) (sometime (and (agentinroom room_3) (at_ purple_door_1))) (always (locked green_door_1)))
