(define (problem minigrid-problem)
 ...
 (:constraints (sometime (and (not (emptyhands)) (carrying blue_box_1))) (always (locked grey_door_1)) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (not (emptyhands))) (sometime (at_ blue_box_1)) (sometime-before (at_ blue_box_1) (agentinroom room_2)) (sometime (carrying green_ball_1)) (sometime (and (not (emptyhands)) (carrying grey_box_1))) (sometime (or (agentinroom room_1) (not (locked yellow_door_2)))) (sometime (or (carrying yellow_box_1) (not (locked green_door_1)))) (sometime (not (locked yellow_door_1))) (sometime (agentinroom room_3)) (sometime-after (agentinroom room_3) (carrying red_box_1)))
