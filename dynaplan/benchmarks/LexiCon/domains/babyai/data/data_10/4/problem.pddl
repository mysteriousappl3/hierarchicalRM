(define (problem minigrid-problem)
 ...
 (:constraints (sometime (or (objectinroom grey_box_1 room_3) (at_ purple_box_1))) (sometime (and (carrying blue_ball_1) (not (locked yellow_door_2)))) (sometime (at_ yellow_door_1)) (sometime (and (agentinroom room_4) (not (emptyhands)))) (sometime (or (at_ purple_box_1) (not (locked red_door_1)))) (sometime (and (at_ yellow_ball_1) (not (emptyhands)))) (sometime (objectinroom blue_ball_1 room_2)) (sometime (or (objectinroom blue_ball_1 room_3) (carrying blue_box_1))) (sometime (and (carrying yellow_ball_1) (at_ green_ball_1))) (sometime (not (locked yellow_door_1))))
