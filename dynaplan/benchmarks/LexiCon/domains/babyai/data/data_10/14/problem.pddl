(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_1 green_ball_2 green_ball_3 green_ball_1 grey_ball_2 red_ball_1 red_ball_2 - ball
   purple_box_1 - box
 )
 ...
 (:constraints (sometime (at_ green_ball_2)) (sometime (and (not (emptyhands)) (not (locked blue_door_1)))) (sometime (not (locked yellow_door_1))) (sometime-before (not (locked yellow_door_1)) (carrying grey_ball_2)) (sometime (agentinroom room_1)) (sometime-after (agentinroom room_1) (or (carrying red_ball_1) (objectinroom green_ball_2 room_2))) (always (not (agentinroom room_2))) (always (locked grey_door_1)) (sometime (locked yellow_door_1)) (sometime-after (locked yellow_door_1) (not (locked blue_door_1))) (sometime (and (not (emptyhands)) (carrying grey_ball_1))) (sometime (not (emptyhands))) (sometime (at_ grey_door_1)) (sometime-before (at_ grey_door_1) (or (agentinroom room_4) (objectinroom purple_box_1 room_4))))
