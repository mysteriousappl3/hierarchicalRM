(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_box_1 yellow_box_1 purple_box_1 red_box_1 blue_box_1 yellow_box_2 - box
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (locked grey_door_1)) (sometime-after (locked grey_door_1) (or (not (locked green_door_1)) (at_ yellow_door_1))) (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (or (agentinroom room_3) (carrying yellow_box_1))) (sometime (and (agentinroom room_3) (carrying green_box_1))) (sometime (at_ red_box_1)) (sometime-before (at_ red_box_1) (at_ empty)) (sometime (or (carrying red_box_1) (carrying green_box_1))) (sometime (and (not (emptyhands)) (objectinroom purple_box_1 room_4))) (sometime (at_ grey_door_1)) (sometime-after (at_ grey_door_1) (or (objectinroom red_ball_1 room_1) (locked grey_door_1))) (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (agentinroom room_1)) (sometime (or (at_ yellow_box_1) (not (emptyhands)))))
