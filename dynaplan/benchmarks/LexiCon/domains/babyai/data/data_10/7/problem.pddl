(define (problem minigrid-problem)
 ...
 (:objects
   ...
   purple_ball_2 blue_ball_1 blue_ball_2 red_ball_1 purple_ball_1 - ball
   green_box_1 red_box_2 red_box_1 - box
 )
 ...
 (:constraints (always (locked purple_door_1)) (sometime (carrying blue_ball_1)) (sometime (and (not (locked grey_door_1)) (not (locked blue_door_1)))) (sometime (agentinroom room_3)) (always (not (agentinroom room_1))) (sometime (and (carrying purple_ball_2) (objectinroom red_box_2 room_2))) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (and (carrying purple_ball_2) (not (locked blue_door_1)))))
