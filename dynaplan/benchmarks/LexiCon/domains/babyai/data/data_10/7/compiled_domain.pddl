(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   ...
   purple_ball_2 blue_ball_1 - ball
   grey_door_1 blue_door_1 purple_door_1 - door
   red_box_2 - box
 )
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (= ?room2 room_3) (and (agentinroom room_3) (not (= ?room1 room_3)))) (hold_2)) (when (or (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2)))) (hold_4)) (when (and (or (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2)))) (not (and (carrying purple_ball_2) (not (locked blue_door_1))))) (not (hold_5))) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (or (= ?obj blue_ball_1) (carrying blue_ball_1)) (hold_0)) (when (and (or (= ?obj purple_ball_2) (carrying purple_ball_2)) (objectinroom red_box_2 room_2) (not (and (= ?obj red_box_2) (= ?room room_2)))) (hold_3)) (when (and (agentinroom room_2) (not (and (or (= ?obj purple_ball_2) (carrying purple_ball_2)) (not (locked blue_door_1))))) (not (hold_5))) (when (and (or (= ?obj purple_ball_2) (carrying purple_ball_2)) (not (locked blue_door_1))) (hold_5)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (carrying blue_ball_1) (not (= ?obj blue_ball_1))) (hold_0)) (when (and (carrying purple_ball_2) (not (= ?obj purple_ball_2)) (or (and (= ?obj red_box_2) (= ?room room_2)) (objectinroom red_box_2 room_2))) (hold_3)) (when (and (agentinroom room_2) (not (and (carrying purple_ball_2) (not (= ?obj purple_ball_2)) (not (locked blue_door_1))))) (not (hold_5))) (when (and (carrying purple_ball_2) (not (= ?obj purple_ball_2)) (not (locked blue_door_1))) (hold_5)) (increase (total-cost) 1)))
 (:action toggle
  ...
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (and (not (or (and (not (locked ?door)) (= ?door grey_door_1)) (and (locked grey_door_1) (not (and (locked ?door) (= ?door grey_door_1)))))) (not (or (and (not (locked ?door)) (= ?door blue_door_1)) (and (locked blue_door_1) (not (and (locked ?door) (= ?door blue_door_1))))))) (hold_1)) (when (and (agentinroom room_2) (not (and (carrying purple_ball_2) (not (or (and (not (locked ?door)) (= ?door blue_door_1)) (and (locked blue_door_1) (not (and (locked ?door) (= ?door blue_door_1))))))))) (not (hold_5))) (when (and (carrying purple_ball_2) (not (or (and (not (locked ?door)) (= ?door blue_door_1)) (and (locked blue_door_1) (not (and (locked ?door) (= ?door blue_door_1))))))) (hold_5)) (increase (total-cost) 1)))
)
