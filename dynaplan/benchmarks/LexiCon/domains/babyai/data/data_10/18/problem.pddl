(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_3 grey_ball_1 green_ball_1 yellow_ball_1 grey_ball_2 - ball
   green_box_1 yellow_box_1 red_box_1 - box
 )
 ...
 (:constraints (sometime (at_ green_box_1)) (always (locked blue_door_1)) (sometime (at_ blue_door_1)) (sometime-after (at_ blue_door_1) (carrying red_box_1)) (sometime (carrying grey_ball_1)) (sometime (carrying green_box_1)) (sometime (and (not (emptyhands)) (agentinroom room_3))) (sometime (agentinroom room_2)) (sometime-before (agentinroom room_2) (not (emptyhands))) (sometime (and (carrying grey_ball_1) (objectinroom green_box_1 room_2))) (sometime (agentinroom room_1)) (sometime-after (agentinroom room_1) (agentinroom room_3)) (sometime (not (locked purple_door_1))))
