(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_ball_1 yellow_ball_2 yellow_ball_1 red_ball_1 green_ball_1 green_ball_2 - ball
 ...
 (:constraints (sometime (at_ grey_door_1)) (sometime-after (at_ grey_door_1) (and (locked grey_door_1) (at_ green_box_1))) (always (not (agentinroom room_2))) (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (and (agentinroom room_4) (not (locked red_door_1)))) (sometime (or (carrying red_ball_1) (objectinroom blue_ball_1 room_2))) (sometime (and (not (emptyhands)) (carrying yellow_ball_2))) (sometime (not (locked yellow_door_1))) (sometime-before (not (locked yellow_door_1)) (and (at_ red_door_1) (objectinroom blue_ball_1 room_4))) (sometime (locked grey_door_1)) (sometime-after (locked grey_door_1) (not (emptyhands))) (sometime (at_ empty)) (sometime (at_ yellow_ball_2)))
