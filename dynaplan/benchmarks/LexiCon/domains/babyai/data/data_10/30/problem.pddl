(define (problem minigrid-problem)
 ...
 (:objects
   ...
   blue_ball_2 blue_ball_1 red_ball_1 yellow_ball_1 - ball
   purple_box_1 red_box_1 grey_box_1 blue_box_1 - box
 )
 ...
 (:constraints (sometime (not (locked yellow_door_2))) (sometime-before (not (locked yellow_door_2)) (carrying red_box_1)) (sometime (not (locked green_door_1))) (sometime (carrying red_box_1)) (sometime (or (carrying red_box_1) (objectinroom red_box_1 room_4))) (sometime (or (objectinroom grey_box_1 room_4) (not (emptyhands)))) (sometime (at_ yellow_door_2)) (sometime-before (at_ yellow_door_2) (not (emptyhands))) (sometime (or (not (emptyhands)) (agentinroom room_1))) (sometime (agentinroom room_1)) (sometime (at_ green_door_1)) (sometime (not (emptyhands))))
