(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_1 purple_ball_1 blue_ball_2 green_ball_1 blue_ball_1 - ball
   green_box_1 blue_box_1 grey_box_1 - box
 )
 ...
 (:constraints (sometime (locked blue_door_1)) (sometime-after (locked blue_door_1) (not (emptyhands))) (sometime (not (locked blue_door_1))) (sometime-before (not (locked blue_door_1)) (agentinroom room_1)) (sometime (or (at_ purple_door_1) (carrying green_box_1))) (sometime (objectinroom grey_ball_1 room_1)) (sometime (objectinroom green_box_1 room_4)) (sometime (at_ blue_door_1)) (sometime-before (at_ blue_door_1) (or (at_ blue_ball_1) (objectinroom grey_ball_1 room_2))) (sometime (or (objectinroom grey_box_1 room_3) (objectinroom green_ball_1 room_1))) (sometime (not (emptyhands))) (sometime (or (objectinroom green_ball_1 room_2) (at_ empty))) (sometime (or (carrying purple_ball_1) (at_ green_door_1))))
