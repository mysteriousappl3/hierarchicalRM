(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_1 purple_ball_1 purple_ball_2 red_ball_1 red_ball_2 - ball
   green_box_1 purple_box_1 blue_box_1 - box
 )
 ...
 (:constraints (sometime (locked red_door_1)) (sometime-after (locked red_door_1) (not (locked grey_door_1))) (sometime (not (locked red_door_1))) (sometime-before (not (locked red_door_1)) (objectinroom purple_ball_1 room_2)) (sometime (at_ red_door_1)) (sometime-before (at_ red_door_1) (at_ blue_door_1)) (sometime (not (locked yellow_door_1))) (sometime (not (emptyhands))) (sometime (or (at_ grey_ball_1) (carrying purple_ball_1))) (sometime (and (not (emptyhands)) (carrying green_box_1))) (sometime (or (not (locked grey_door_1)) (at_ purple_box_1))) (sometime (or (carrying purple_ball_1) (not (emptyhands)))) (sometime (or (carrying red_ball_2) (at_ green_box_1))))
