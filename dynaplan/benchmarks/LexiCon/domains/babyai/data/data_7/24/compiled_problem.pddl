(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   blue_door_1 - door
   yellow_box_2 red_box_1 - box
   grey_ball_3 blue_ball_1 - ball
 )
 ...
 (and (objectcolor ?d bluetype) (adjacentrooms room_1 room_2 ?d) (at_ ?d) (not (locked ?d)))) (hold_0) (hold_1) (hold_2) (hold_3) (hold_4)))
