(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_box_2 yellow_box_1 red_box_1 yellow_box_3 - box
   grey_ball_2 grey_ball_1 grey_ball_3 blue_ball_1 - ball
 )
 ...
 (:constraints (always (not (agentinroom room_2))) (sometime (carrying grey_ball_2)) (always (locked purple_door_1)) (sometime (and (at_ red_door_1) (carrying yellow_box_1))) (sometime (and (objectinroom grey_ball_1 room_4) (at_ yellow_box_3))) (sometime (or (at_ blue_door_2) (carrying yellow_box_3))) (sometime (or (agentinroom room_1) (not (emptyhands)))))
