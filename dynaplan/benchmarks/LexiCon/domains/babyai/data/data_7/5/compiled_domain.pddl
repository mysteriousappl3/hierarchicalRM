(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   empty - empty_0
   room_2 room_1 - room
   yellow_ball_1 yellow_ball_2 - ball
   grey_box_1 - box
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2)))) (hold_2)) (when (and (or (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2)))) (not (and (carrying yellow_ball_2) (objectinroom grey_box_1 room_2)))) (not (hold_3))) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (hold_0) (when (and (agentinroom room_2) (not (and (or (= ?obj yellow_ball_2) (carrying yellow_ball_2)) (objectinroom grey_box_1 room_2) (not (and (= ?obj grey_box_1) (= ?room room_2)))))) (not (hold_3))) (when (and (or (= ?obj yellow_ball_2) (carrying yellow_ball_2)) (objectinroom grey_box_1 room_2) (not (and (= ?obj grey_box_1) (= ?room room_2)))) (hold_3)) (when (and (objectinroom yellow_ball_1 room_1) (not (and (= ?obj yellow_ball_1) (= ?room room_1)))) (hold_5)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (agentinroom room_2) (not (and (carrying yellow_ball_2) (not (= ?obj yellow_ball_2)) (or (and (= ?obj grey_box_1) (= ?room room_2)) (objectinroom grey_box_1 room_2))))) (not (hold_3))) (when (and (carrying yellow_ball_2) (not (= ?obj yellow_ball_2)) (or (and (= ?obj grey_box_1) (= ?room room_2)) (objectinroom grey_box_1 room_2))) (hold_3)) (when (or (and (= ?obj yellow_ball_1) (= ?room room_1)) (objectinroom yellow_ball_1 room_1)) (hold_5)) (increase (total-cost) 1)))
 (:action toggle
  ...
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (not (or (and (not (locked ?door)) (= ?door yellow_door_1)) (and (locked yellow_door_1) (not (and (locked ?door) (= ?door yellow_door_1)))))) (hold_1)) (when (not (or (and (not (locked ?door)) (= ?door purple_door_1)) (and (locked purple_door_1) (not (and (locked ?door) (= ?door purple_door_1)))))) (hold_4)) (increase (total-cost) 1)))
)
