(define (problem minigrid-problem)
 ...
 (:objects
   ...
   red_box_2 grey_box_1 red_box_1 yellow_box_1 - box
   blue_ball_1 blue_ball_2 green_ball_1 yellow_ball_1 - ball
 )
 ...
 (:constraints (sometime (not (emptyhands))) (always (not (agentinroom room_3))) (always (locked purple_door_1)) (sometime (at_ yellow_door_1)) (sometime-before (at_ yellow_door_1) (not (emptyhands))) (sometime (at_ purple_door_1)) (sometime-before (at_ purple_door_1) (or (agentinroom room_1) (not (emptyhands)))) (sometime (not (locked yellow_door_1))) (sometime-before (not (locked yellow_door_1)) (carrying yellow_ball_1)))
