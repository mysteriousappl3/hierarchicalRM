(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_box_1 yellow_box_1 red_box_1 purple_box_1 blue_box_1 - box
   purple_ball_1 grey_ball_1 green_ball_1 - ball
 )
 ...
 (:constraints (always (locked purple_door_1)) (sometime (not (locked green_door_1))) (sometime (agentinroom room_1)) (sometime-before (agentinroom room_1) (or (agentinroom room_4) (at_ green_door_1))) (sometime (at_ purple_door_1)) (sometime-before (at_ purple_door_1) (or (carrying green_ball_1) (objectinroom grey_ball_1 room_4))) (sometime (at_ blue_door_1)) (sometime-before (at_ blue_door_1) (objectinroom yellow_box_1 room_4)) (sometime (or (agentinroom room_2) (not (emptyhands)))) (sometime (objectinroom blue_box_1 room_3)))
