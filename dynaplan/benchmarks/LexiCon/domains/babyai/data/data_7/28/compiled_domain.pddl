(define (domain liftedtcore_minigrid-domain)
 ...
 (:predicates (agentinroom ?room - room) (objectinroom ?obj - object_ ?room - room) (objectcolor ?objectordoor - objectordoor ?color - color) (at_ ?objectordoor - objectordoor) (carrying ?obj - object_) (locked ?door - door) (adjacentrooms ?room1 - room ?room2 - room ?door - door) (blocked ?door - door ?obj - object_ ?room - room) (visited ?room - room) (emptyhands) (hold_0) (hold_1) (seen_psi_2) (hold_3) (seen_psi_4) (hold_5) (seen_psi_6) (hold_7) (hold_8))
 (:functions (total-cost))
 (:action gotoobject
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (objectinroom ?obj ?room) (agentinroom ?room))
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?obj) (when (agentinroom room_4) (seen_psi_2)) (increase (total-cost) 1)))
 (:action gotoempty
  :parameters ()
 ...
 (not (blocked ?door ?o ?room1))) (or (not (= ?door purple_door_1)) (seen_psi_4)) (or (not (= ?door blue_door_1)) (seen_psi_6)))
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?door) (when (or (agentinroom room_4) (= ?door green_door_1)) (seen_psi_2)) (when (= ?door purple_door_1) (hold_3)) (when (= ?door blue_door_1) (hold_5)) (increase (total-cost) 1)))
 (:action gotoroom
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (or (= ?obj green_ball_1) (carrying green_ball_1) (and (objectinroom grey_ball_1 room_4) (not (and (= ?obj grey_ball_1) (= ?room room_4))))) (seen_psi_4)) (when (and (objectinroom yellow_box_1 room_4) (not (and (= ?obj yellow_box_1) (= ?room room_4)))) (seen_psi_6)) (hold_7) (when (and (objectinroom blue_box_1 room_3) (not (and (= ?obj blue_box_1) (= ?room room_3)))) (hold_8)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (or (and (carrying green_ball_1) (not (= ?obj green_ball_1))) (and (= ?obj grey_ball_1) (= ?room room_4)) (objectinroom grey_ball_1 room_4)) (seen_psi_4)) (when (or (and (= ?obj yellow_box_1) (= ?room room_4)) (objectinroom yellow_box_1 room_4)) (seen_psi_6)) (when (agentinroom room_2) (hold_7)) (when (or (and (= ?obj blue_box_1) (= ?room room_3)) (objectinroom blue_box_1 room_3)) (hold_8)) (increase (total-cost) 1)))
 (:action toggle
