(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_box_2 grey_box_1 yellow_box_2 grey_box_3 yellow_box_1 red_box_1 purple_box_1 - box
   green_ball_1 - ball
 )
 ...
 (:constraints (sometime (or (not (emptyhands)) (objectinroom grey_box_3 room_1))) (always (locked green_door_1)) (sometime (agentinroom room_1)) (sometime-after (agentinroom room_1) (or (at_ purple_box_1) (objectinroom grey_box_2 room_4))) (sometime (not (locked red_door_1))) (sometime (agentinroom room_3)) (sometime-before (agentinroom room_3) (or (not (emptyhands)) (objectinroom red_box_1 room_2))) (sometime (at_ green_door_1)) (sometime-before (at_ green_door_1) (carrying yellow_box_2)) (sometime (or (objectinroom empty room_1) (at_ yellow_box_2))))
