(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_box_1 grey_box_2 red_box_2 purple_box_1 red_box_1 blue_box_1 - box
   grey_ball_1 green_ball_1 - ball
 )
 ...
 (:constraints (always (not (agentinroom room_4))) (sometime (locked green_door_1)) (sometime-after (locked green_door_1) (carrying red_box_1)) (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (carrying red_box_1)) (sometime (at_ red_box_1)) (sometime (agentinroom room_3)) (sometime-after (agentinroom room_3) (or (not (locked red_door_1)) (not (emptyhands)))) (sometime (carrying grey_box_1)) (sometime (and (not (emptyhands)) (at_ red_box_2))))
