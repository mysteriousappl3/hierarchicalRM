(define (problem minigrid-problem)
 ...
 (:constraints (sometime (locked grey_door_1)) (sometime-after (locked grey_door_1) (and (at_ grey_box_2) (not (emptyhands)))) (sometime (and (carrying yellow_box_1) (objectinroom blue_ball_2 room_2))) (always (not (agentinroom room_1))) (sometime (not (locked purple_door_1))) (sometime-before (not (locked purple_door_1)) (agentinroom room_4)) (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (carrying purple_ball_1)) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (and (not (locked green_door_1)) (carrying purple_ball_1))) (sometime (and (carrying grey_ball_1) (not (emptyhands)))))
