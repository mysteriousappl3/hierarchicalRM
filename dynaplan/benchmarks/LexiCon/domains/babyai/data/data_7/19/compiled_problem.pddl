(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   purple_door_1 - door
   green_ball_2 red_ball_1 yellow_ball_1 grey_ball_1 blue_ball_1 green_ball_1 - ball
   purple_box_1 - box
 )
 ...
 (and (objectcolor ?v redtype) (objectinroom ?v room_4) (agentinroom room_4) (at_ ?v))) (hold_0) (hold_1) (hold_2) (hold_3) (hold_4) (hold_5)))
