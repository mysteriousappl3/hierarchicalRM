(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (locked grey_door_1)) (sometime-after (locked grey_door_1) (or (not (locked green_door_1)) (at_ yellow_door_1))) (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (or (agentinroom room_3) (carrying red_ball_2))) (sometime (and (agentinroom room_3) (carrying red_ball_1))) (sometime (at_ grey_door_1)) (sometime-before (at_ grey_door_1) (carrying yellow_box_1)) (sometime (at_ blue_box_1)) (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (or (agentinroom room_1) (not (locked red_door_1)))))
