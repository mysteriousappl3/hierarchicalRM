(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_ball_1 grey_ball_2 grey_ball_1 grey_ball_3 green_ball_1 - ball
   yellow_box_1 red_box_1 green_box_1 - box
 )
 ...
 (:constraints (sometime (carrying green_box_1)) (always (locked blue_door_1)) (sometime (at_ blue_door_1)) (sometime-after (at_ blue_door_1) (carrying yellow_box_1)) (sometime (carrying grey_ball_2)) (sometime (carrying grey_ball_1)) (sometime (at_ grey_ball_1)) (sometime-before (at_ grey_ball_1) (carrying yellow_box_1)) (sometime (or (at_ red_door_1) (carrying grey_ball_1))))
