(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_box_2 purple_box_1 yellow_box_2 green_box_1 blue_box_1 yellow_box_1 - box
 ...
 (:constraints (sometime (not (locked yellow_door_1))) (sometime (or (objectinroom yellow_box_1 room_3) (at_ green_ball_1))) (sometime (or (not (emptyhands)) (at_ yellow_door_1))) (sometime (objectinroom yellow_box_2 room_3)) (sometime (agentinroom room_3)) (sometime (agentinroom room_4)))
