(define (problem minigrid-problem)
 ...
 (:constraints (sometime (locked grey_door_1)) (sometime-after (locked grey_door_1) (at_ red_box_1)) (sometime (not (emptyhands))) (sometime (agentinroom room_3)) (sometime-before (agentinroom room_3) (or (carrying green_ball_1) (not (emptyhands)))) (sometime (at_ green_ball_1)) (sometime (not (locked grey_door_1))) (sometime-before (not (locked grey_door_1)) (agentinroom room_3)) (sometime (or (not (locked yellow_door_1)) (not (emptyhands)))) (sometime (carrying yellow_box_1)))
