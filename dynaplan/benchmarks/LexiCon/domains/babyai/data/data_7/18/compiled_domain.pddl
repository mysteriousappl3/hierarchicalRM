(define (domain liftedtcore_minigrid-domain)
 ...
 (:predicates (agentinroom ?room - room) (objectinroom ?obj - object_ ?room - room) (objectcolor ?objectordoor - objectordoor ?color - color) (at_ ?objectordoor - objectordoor) (carrying ?obj - object_) (locked ?door - door) (adjacentrooms ?room1 - room ?room2 - room ?door - door) (blocked ?door - door ?obj - object_ ?room - room) (visited ?room - room) (emptyhands) (hold_0) (hold_1) (hold_2) (hold_3) (seen_psi_4) (hold_5) (hold_6) (seen_psi_7) (hold_8) (hold_9))
 (:functions (total-cost))
 (:action gotoobject
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (objectinroom ?obj ?room) (agentinroom ?room))
  :effect (and(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (at_ ?obj) (when (and (locked grey_door_1) (not (= ?obj red_box_1))) (not (hold_1))) (when (= ?obj red_box_1) (hold_1)) (when (= ?obj green_ball_1) (hold_5)) (increase (total-cost) 1)))
 (:action gotoempty
  :parameters ()
 ...
 (:action pick
  ...
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (locked grey_door_1) (not (and (at_ red_box_1) (not (= ?obj red_box_1))))) (not (hold_1))) (when (and (at_ red_box_1) (not (= ?obj red_box_1))) (hold_1)) (hold_2) (seen_psi_4) (when (and (at_ green_ball_1) (not (= ?obj green_ball_1))) (hold_5)) (hold_8) (when (or (= ?obj yellow_box_1) (carrying yellow_box_1)) (hold_9)) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (and (locked grey_door_1) (not (or (= ?obj red_box_1) (at_ red_box_1)))) (not (hold_1))) (when (or (= ?obj red_box_1) (at_ red_box_1)) (hold_1)) (when (and (carrying green_ball_1) (not (= ?obj green_ball_1))) (seen_psi_4)) (when (or (= ?obj green_ball_1) (at_ green_ball_1)) (hold_5)) (when (not (locked yellow_door_1)) (hold_8)) (when (and (carrying yellow_box_1) (not (= ?obj yellow_box_1))) (hold_9)) (increase (total-cost) 1)))
 (:action toggle
  ...
  :effect (and (when (not (locked ?door)) (locked ?door)) (when (locked ?door) (not (locked ?door))) (when (or (and (not (locked ?door)) (= ?door grey_door_1)) (and (locked grey_door_1) (not (and (locked ?door) (= ?door grey_door_1))))) (hold_0)) (when (and (or (and (not (locked ?door)) (= ?door grey_door_1)) (and (locked grey_door_1) (not (and (locked ?door) (= ?door grey_door_1))))) (not (at_ red_box_1))) (not (hold_1))) (when (not (or (and (not (locked ?door)) (= ?door grey_door_1)) (and (locked grey_door_1) (not (and (locked ?door) (= ?door grey_door_1)))))) (hold_6)) (when (or (not (or (and (not (locked ?door)) (= ?door yellow_door_1)) (and (locked yellow_door_1) (not (and (locked ?door) (= ?door yellow_door_1)))))) (not (emptyhands))) (hold_8)) (increase (total-cost) 1)))
)
