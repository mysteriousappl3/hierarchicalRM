(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_box_2 grey_box_1 red_box_1 green_box_1 blue_box_1 yellow_box_1 - box
 ...
 (:constraints (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (and (not (emptyhands)) (agentinroom room_1))) (sometime (not (locked green_door_1))) (sometime-after (not (locked green_door_1)) (and (carrying red_box_1) (not (locked red_door_1)))) (sometime (at_ green_door_1)) (sometime-before (at_ green_door_1) (or (carrying yellow_box_1) (carrying green_box_2))) (sometime (agentinroom room_2)) (sometime-before (agentinroom room_2) (and (carrying grey_box_1) (not (emptyhands)))) (sometime (at_ grey_door_1)) (sometime-before (at_ grey_door_1) (objectinroom red_box_1 room_3)) (sometime (not (emptyhands))) (sometime (locked green_door_1)) (sometime-after (locked green_door_1) (not (emptyhands))))
