(define (problem minigrid-problem)
 ...
 (:constraints (sometime (not (emptyhands))) (sometime-before (not (emptyhands)) (or (objectinroom grey_ball_1 room_4) (agentinroom room_1))) (sometime (not (locked green_door_1))) (always (locked blue_door_1)) (sometime (or (not (locked red_door_1)) (carrying green_box_1))) (sometime (agentinroom room_4)) (sometime-after (agentinroom room_4) (and (locked blue_door_1) (not (locked green_door_1)))) (sometime (agentinroom room_2)) (sometime-before (agentinroom room_2) (not (emptyhands))) (sometime (at_ red_door_1)))
