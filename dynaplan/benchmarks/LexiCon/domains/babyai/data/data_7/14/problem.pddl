(define (problem minigrid-problem)
 ...
 (:constraints (sometime (and (carrying blue_box_1) (objectinroom red_ball_1 room_4))) (sometime (or (at_ blue_ball_1) (not (locked yellow_door_1)))) (sometime (or (not (emptyhands)) (at_ purple_box_1))) (sometime (locked grey_door_1)) (sometime-after (locked grey_door_1) (objectinroom yellow_box_1 room_3)) (sometime (carrying grey_ball_1)) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (or (objectinroom blue_box_1 room_3) (at_ yellow_door_1))) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (not (locked yellow_door_2))))
