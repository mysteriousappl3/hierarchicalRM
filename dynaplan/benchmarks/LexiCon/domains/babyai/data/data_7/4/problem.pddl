(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_box_2 grey_box_1 green_box_1 yellow_box_1 - box
 ...
 (:constraints (sometime (not (emptyhands))) (sometime (at_ blue_door_3)) (sometime (and (agentinroom room_3) (objectinroom purple_ball_1 room_3))) (sometime (or (at_ yellow_box_1) (objectinroom grey_box_1 room_4))) (sometime (agentinroom room_1)) (sometime (and (at_ grey_box_1) (not (locked green_door_1)))))
