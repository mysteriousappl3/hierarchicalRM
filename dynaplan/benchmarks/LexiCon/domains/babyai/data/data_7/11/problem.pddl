(define (problem minigrid-problem)
 ...
 (:objects
   ...
   yellow_door_1 purple_door_1 green_door_1 yellow_door_2 - door
   green_box_2 purple_box_2 purple_box_1 blue_box_1 green_box_1 - box
   yellow_ball_1 yellow_ball_2 blue_ball_1 - ball
 )
 ...
 (:constraints (always (locked purple_door_1)) (always (not (agentinroom room_1))) (sometime (agentinroom room_3)) (sometime-before (agentinroom room_3) (or (at_ blue_box_1) (at_ empty))) (sometime (agentinroom room_2)) (sometime-after (agentinroom room_2) (or (at_ yellow_ball_1) (carrying blue_ball_1))) (sometime (at_ purple_door_1)) (sometime-before (at_ purple_door_1) (or (at_ blue_box_1) (agentinroom room_4))) (sometime (not (emptyhands))) (sometime (or (objectinroom blue_box_1 room_3) (at_ yellow_ball_1))))
