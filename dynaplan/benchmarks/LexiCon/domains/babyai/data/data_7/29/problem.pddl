(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_box_1 grey_box_2 grey_box_3 purple_box_1 blue_box_1 green_box_1 - box
 ...
 (:constraints (sometime (or (carrying grey_box_3) (objectinroom green_box_1 room_3))) (sometime (or (carrying blue_ball_1) (at_ purple_box_1))) (sometime (not (emptyhands))) (sometime (not (emptyhands))) (sometime (or (not (emptyhands)) (carrying green_box_1))) (sometime (and (carrying blue_ball_1) (at_ grey_box_1))) (sometime (carrying grey_box_3)))
