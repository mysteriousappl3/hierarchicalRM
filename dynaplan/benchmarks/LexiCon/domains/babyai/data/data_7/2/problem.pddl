(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_ball_3 grey_ball_1 red_ball_1 grey_ball_2 purple_ball_1 - ball
 ...
 (:constraints (sometime (and (at_ blue_box_1) (agentinroom room_1))) (sometime (not (locked purple_door_1))) (sometime-before (not (locked purple_door_1)) (or (carrying red_ball_1) (at_ red_ball_1))) (sometime (agentinroom room_4)) (sometime-before (agentinroom room_4) (and (carrying blue_box_1) (not (locked green_door_1)))) (sometime (not (locked grey_door_1))) (sometime (agentinroom room_3)) (sometime (not (emptyhands))) (sometime (at_ grey_ball_3)) (sometime-before (at_ grey_ball_3) (at_ empty)))
