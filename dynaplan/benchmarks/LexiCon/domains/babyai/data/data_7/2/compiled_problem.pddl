(define (problem liftedtcore_minigrid-problem)
 ...
 (:objects
   ...
   red_door_1 - door
   grey_ball_1 grey_ball_2 purple_ball_1 - ball
 ...
 (and (objectcolor ?v greytype) (objectinroom ?v room_4) (agentinroom room_4) (at_ ?v))) (hold_0) (hold_1) (hold_3) (hold_5) (hold_6) (hold_7) (hold_8)))
