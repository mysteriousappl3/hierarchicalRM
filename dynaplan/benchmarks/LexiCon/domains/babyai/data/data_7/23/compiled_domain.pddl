(define (domain liftedtcore_minigrid-domain)
 ...
 (:constants
   ...
   blue_box_2 yellow_box_1 purple_box_1 - box
   green_door_1 - door
 )
 (:predicates (agentinroom ?room - room) (objectinroom ?obj - object_ ?room - room) (objectcolor ?objectordoor - objectordoor ?color - color) (at_ ?objectordoor - objectordoor) (carrying ?obj - object_) (locked ?door - door) (adjacentrooms ?room1 - room ?room2 - room ?door - door) (blocked ?door - door ?obj - object_ ?room - room) (visited ?room - room) (emptyhands) (hold_0) (seen_psi_1) (hold_2) (hold_3) (hold_4) (hold_5) (hold_6) (hold_7) (hold_8))
 ...
 (:action gotoroom
  ...
  :effect (and (not (agentinroom ?room1)) (agentinroom ?room2) (visited ?room2)(forall (?o - object_) (when (at_ ?o) (not (at_ ?o))))(forall (?d - door) (when (at_ ?d) (not (at_ ?d)))) (when (or (= ?room2 room_2) (and (agentinroom room_2) (not (= ?room1 room_2))) (carrying grey_ball_1)) (hold_7)) (increase (total-cost) 1)))
 (:action pick
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (objectinroom ?obj ?room) (at_ ?obj) (emptyhands))
  :effect (and (not (at_ ?obj)) (not (emptyhands)) (carrying ?obj) (not (objectinroom ?obj ?room))(forall (?d - door) (when (blocked ?d ?obj ?room) (not (blocked ?d ?obj ?room)))) (when (and (objectinroom yellow_box_1 room_4) (not (and (= ?obj yellow_box_1) (= ?room room_4)))) (seen_psi_1)) (when (and (objectinroom purple_box_1 room_1) (not (and (= ?obj purple_box_1) (= ?room room_1)))) (hold_2)) (when (or (= ?obj yellow_box_1) (carrying yellow_box_1) (and (objectinroom purple_ball_1 room_2) (not (and (= ?obj purple_ball_1) (= ?room room_2))))) (hold_3)) (hold_5) (when (or (= ?obj blue_box_2) (carrying blue_box_2)) (hold_6)) (when (or (agentinroom room_2) (= ?obj grey_ball_1) (carrying grey_ball_1)) (hold_7)) (hold_8) (increase (total-cost) 1)))
 (:action drop
  :parameters ( ?obj - object_ ?room - room)
  :precondition (and (agentinroom ?room) (carrying ?obj) (not (emptyhands)) (at_ empty))
  :effect (and (not (carrying ?obj)) (at_ ?obj) (not (at_ empty)) (emptyhands) (objectinroom ?obj ?room) (when (or (and (= ?obj yellow_box_1) (= ?room room_4)) (objectinroom yellow_box_1 room_4)) (seen_psi_1)) (when (or (and (carrying yellow_box_1) (not (= ?obj yellow_box_1))) (and (= ?obj purple_ball_1) (= ?room room_2)) (objectinroom purple_ball_1 room_2)) (hold_3)) (when (locked green_door_1) (not (hold_5))) (when (and (carrying blue_box_2) (not (= ?obj blue_box_2))) (hold_6)) (when (or (agentinroom room_2) (and (carrying grey_ball_1) (not (= ?obj grey_ball_1)))) (hold_7)) (increase (total-cost) 1)))
 (:action toggle
