(define (problem minigrid-problem)
 ...
 (:objects
   ...
   grey_box_1 grey_box_2 yellow_box_1 purple_box_1 blue_box_1 blue_box_2 - box
 ...
 (:constraints (sometime (not (locked green_door_1))) (sometime-before (not (locked green_door_1)) (objectinroom yellow_box_1 room_4)) (sometime (and (objectinroom purple_box_1 room_1) (not (emptyhands)))) (sometime (or (carrying yellow_box_1) (objectinroom purple_ball_1 room_2))) (sometime (locked green_door_1)) (sometime-after (locked green_door_1) (not (emptyhands))) (sometime (carrying blue_box_2)) (sometime (or (agentinroom room_2) (carrying grey_ball_1))) (sometime (not (emptyhands))))
