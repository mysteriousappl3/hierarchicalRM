(define (problem minigrid-problem)
 ...
 (:objects
   ...
   green_ball_2 yellow_ball_1 grey_ball_1 green_ball_1 - ball
   grey_box_1 grey_box_2 purple_box_1 yellow_box_1 - box
 )
 ...
 (:constraints (sometime (and (not (locked green_door_1)) (at_ green_ball_2))) (sometime (or (not (emptyhands)) (objectinroom grey_box_2 room_2))) (sometime (or (not (locked green_door_2)) (at_ grey_box_2))) (sometime (and (agentinroom room_4) (not (locked red_door_1)))) (sometime (or (objectinroom yellow_ball_1 room_3) (at_ green_ball_1))) (sometime (or (carrying grey_box_2) (agentinroom room_4))) (sometime (at_ green_ball_2)))
