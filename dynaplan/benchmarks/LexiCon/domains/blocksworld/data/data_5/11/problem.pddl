(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (holding black_block_2)) (sometime-before (holding black_block_2) (or (not (clear green_block_2)) (holding orange_block_1))) (sometime (or (on black_block_2 green_block_2) (not (ontable red_block_1)))) (always (not (ontable green_block_1))) (sometime (or (not (ontable orange_block_1)) (on green_block_1 red_block_1))) (sometime (and (on black_block_2 black_block_1) (ontable green_block_2))))
