(define (problem blocksworld-problem)
 ...
 (:constraints (always (not (ontable purple_block_1))) (sometime (holding purple_block_1)) (sometime-after (holding purple_block_1) (not (ontable black_block_1))) (sometime (on blue_block_1 green_block_1)) (always (not (ontable blue_block_2))) (sometime (clear blue_block_1)) (sometime-before (clear blue_block_1) (on grey_block_1 blue_block_2)))
