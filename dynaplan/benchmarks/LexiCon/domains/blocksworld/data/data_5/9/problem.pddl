(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (ontable orange_block_3)) (always (not (ontable red_block_1))) (sometime (holding red_block_1)) (sometime-before (holding red_block_1) (holding orange_block_3)) (sometime (or (not (ontable green_block_1)) (clear grey_block_1))) (sometime (or (ontable blue_block_1) (on grey_block_1 orange_block_1))))
