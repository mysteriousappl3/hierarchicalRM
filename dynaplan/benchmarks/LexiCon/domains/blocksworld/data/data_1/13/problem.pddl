(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (not (on grey_block_1 brown_block_3))) (sometime-after (not (on grey_block_1 brown_block_3)) (or (on red_block_2 brown_block_1) (clear grey_block_1))))
