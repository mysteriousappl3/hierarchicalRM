(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (not (on yellow_block_1 white_block_1))) (sometime-after (not (on yellow_block_1 white_block_1)) (or (clear white_block_2) (on white_block_2 green_block_1))))
