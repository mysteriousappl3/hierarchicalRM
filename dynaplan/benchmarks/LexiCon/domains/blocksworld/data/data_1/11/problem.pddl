(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (not (ontable orange_block_1))) (sometime-before (not (ontable orange_block_1)) (or (on yellow_block_1 white_block_1) (not (ontable black_block_1)))))
