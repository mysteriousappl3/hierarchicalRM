(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (not (on black_block_3 brown_block_1))) (sometime-before (not (on black_block_3 brown_block_1)) (holding brown_block_2)) (sometime (not (on green_block_1 green_block_1))) (sometime-after (not (on green_block_1 green_block_1)) (or (holding black_block_1) (on green_block_1 black_block_1))) (sometime (or (clear green_block_1) (on brown_block_1 black_block_1))) (sometime (not (on black_block_3 black_block_1))) (sometime-after (not (on black_block_3 black_block_1)) (or (not (ontable brown_block_2)) (not (clear brown_block_1)))) (sometime (clear brown_block_1)) (sometime-before (clear brown_block_1) (on black_block_2 green_block_1)) (sometime (not (clear black_block_3))) (sometime-before (not (clear black_block_3)) (clear green_block_1)) (sometime (not (on grey_block_1 brown_block_1))) (sometime-after (not (on grey_block_1 brown_block_1)) (ontable green_block_1)) (sometime (not (on brown_block_2 grey_block_1))) (sometime-after (not (on brown_block_2 grey_block_1)) (ontable green_block_1)) (sometime (not (on black_block_3 brown_block_2))) (sometime-after (not (on black_block_3 brown_block_2)) (or (ontable green_block_1) (not (clear black_block_2)))) (sometime (on brown_block_2 green_block_1)))
