(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (not (ontable white_block_1))) (sometime-after (not (ontable white_block_1)) (or (on blue_block_3 white_block_2) (ontable blue_block_3))) (sometime (not (clear white_block_1))) (sometime-before (not (clear white_block_1)) (holding white_block_2)) (sometime (on blue_block_3 white_block_2)) (sometime (or (on white_block_1 blue_block_3) (clear blue_block_2))) (sometime (or (not (ontable brown_block_1)) (on blue_block_3 brown_block_1))) (sometime (not (on brown_block_1 blue_block_2))) (sometime-after (not (on brown_block_1 blue_block_2)) (not (clear brown_block_1))) (sometime (or (not (clear brown_block_1)) (on brown_block_1 white_block_1))) (sometime (not (on blue_block_3 white_block_1))) (sometime-after (not (on blue_block_3 white_block_1)) (or (on blue_block_2 black_block_1) (not (ontable blue_block_2)))) (sometime (or (on white_block_2 black_block_1) (not (ontable blue_block_2)))) (sometime (not (on blue_block_2 white_block_2))) (sometime-after (not (on blue_block_2 white_block_2)) (holding blue_block_2)))
