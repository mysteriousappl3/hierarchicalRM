(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (and (on purple_block_1 brown_block_1) (on grey_block_2 grey_block_1))) (always (not (ontable yellow_block_2))) (sometime (holding yellow_block_1)) (sometime-before (holding yellow_block_1) (or (not (ontable purple_block_2)) (holding purple_block_2))) (sometime (not (clear brown_block_1))) (sometime-after (not (clear brown_block_1)) (or (clear brown_block_1) (holding grey_block_2))) (sometime (not (ontable brown_block_1))) (sometime-after (not (ontable brown_block_1)) (not (clear purple_block_1))) (sometime (clear brown_block_1)) (sometime-before (clear brown_block_1) (not (ontable purple_block_2))) (sometime (or (on purple_block_1 brown_block_1) (holding grey_block_1))) (sometime (and (on grey_block_2 grey_block_1) (on yellow_block_1 grey_block_2))) (always (not (ontable grey_block_2))) (sometime (and (holding grey_block_1) (on brown_block_1 purple_block_2))))
