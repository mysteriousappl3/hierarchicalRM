(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (and (on purple_block_1 brown_block_1) (on grey_block_2 grey_block_1))) (always (not (ontable yellow_block_2))) (sometime (holding yellow_block_1)) (sometime-before (holding yellow_block_1) (or (not (ontable purple_block_2)) (holding purple_block_2))))
