(define (domain liftedtcore_blocksworld-domain)
 ...
 (:types block)
 (:constants
   green_block_2 green_block_1 orange_block_1 red_block_1 black_block_2 - block
 )
