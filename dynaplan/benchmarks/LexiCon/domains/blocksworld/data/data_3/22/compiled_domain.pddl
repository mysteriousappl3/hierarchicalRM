(define (domain liftedtcore_blocksworld-domain)
 ...
 (:types block)
 (:constants
   brown_block_1 grey_block_1 orange_block_1 black_block_1 black_block_2 - block
 )
 ...
 (:action pickup
  ...
  :precondition (and (clear ?obj) (ontable ?obj) (handempty) (or (and (clear black_block_1) (not (= ?obj black_block_1))) (seen_psi_2)) (not (and (ontable black_block_1) (not (= ?obj black_block_1)))))
 ...
 (:action putdown
  :parameters ( ?obj - block)
  :precondition (and (holding ?obj) (or (= ?obj black_block_1) (clear black_block_1) (seen_psi_2)) (not (or (= ?obj black_block_1) (ontable black_block_1))))
 ...
 (:action stack
  ...
  :effect (and (handempty) (clear ?obj) (on ?obj ?underobj) (not (clear ?underobj)) (not (holding ?obj)) (when (and (holding orange_block_1) (not (= ?obj orange_block_1)) (not (or (= ?obj black_block_2) (and (clear black_block_2) (not (= ?underobj black_block_2)))))) (hold_0)) (when (not (or (= ?obj black_block_1) (and (clear black_block_1) (not (= ?underobj black_block_1))))) (hold_1)) (increase (total-cost) 1)))
 (:action unstack
  :parameters ( ?obj - block ?underobj - block)
  ...
  :effect (and (holding ?obj) (clear ?underobj) (not (on ?obj ?underobj)) (not (clear ?obj)) (not (handempty)) (when (and (or (= ?obj orange_block_1) (holding orange_block_1)) (not (or (= ?underobj black_block_2) (and (clear black_block_2) (not (= ?obj black_block_2)))))) (hold_0)) (when (not (or (= ?underobj black_block_1) (and (clear black_block_1) (not (= ?obj black_block_1))))) (hold_1)) (increase (total-cost) 1)))
)
