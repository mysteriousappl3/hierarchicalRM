(define (problem blocksworld-problem)
 ...
 (:constraints (sometime (not (clear black_block_2))) (sometime (not (on black_block_1 brown_block_1))) (sometime-after (not (on black_block_1 brown_block_1)) (or (not (ontable red_block_1)) (not (clear brown_block_1)))) (sometime (holding blue_block_1)))
