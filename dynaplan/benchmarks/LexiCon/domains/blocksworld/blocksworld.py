...
from domains.blocksworld.up_domain import (
    get_blocksworld_problem,
    get_blocksworld_problem,
)

from domains.blocksworld.utils.constraints import (
    signed_predicates_per_constraint_type,
    domain_axioms,
)

from domains.blocksworld.mapper import BlocksworldMapper


class Blocksworld(LexiCon):
    ...
    def __init__(self, cfg):
        ...
        self.mapper_class = BlocksworldMapper
    ...
    def reset(self, seed: Optional[int], data: Optional[Sample] = None):
        self.seed = seed
        self.unconstrained_problem = get_blocksworld_problem(seed=seed)
    ...
    def set_domain_name(self):
        self.domain = "blocksworld"

def main(cfg: DictConfig):
    run_lexicon(cfg, Blocksworld)
