(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location1) (checked location1)) (seen_psi_3)) (when (or (holds agent1 towel_1) (= ?l location2) (checked location2)) (hold_4)) (when (or (= ?l location1) (checked location1) (atlocation agent1 location2)) (hold_6)) (when (or (= ?l location5) (checked location5)) (hold_8)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (and (holds agent1 mug_3) (not (or (= ?r cart_2) (checked cart_2)))) (not (hold_1))) (when (or (= ?r cart_2) (checked cart_2)) (hold_1)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :precondition (and (atlocation ?a ?lstart) (or (not (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))))) (seen_psi_3)))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_2)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_5)) (when (or (checked location1) (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_6)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_7)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (and (holds agent1 mug_3) (not (or (= ?r cart_2) (checked cart_2)))) (not (hold_1))) (when (or (= ?r cart_2) (checked cart_2)) (hold_1)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_3)) (holds agent1 mug_3)) (hold_0)) (when (and (or (and (= ?a agent1) (= ?o mug_3)) (holds agent1 mug_3)) (not (checked cart_2))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?o towel_1)) (holds agent1 towel_1) (checked location2)) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 mug_3) (not (and (= ?a agent1) (= ?o mug_3)))) (hold_0)) (when (and (holds agent1 mug_3) (not (and (= ?a agent1) (= ?o mug_3))) (not (checked cart_2))) (not (hold_1))) (when (or (and (holds agent1 towel_1) (not (and (= ?a agent1) (= ?o towel_1)))) (checked location2)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
