(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (heatable ?o_0) (objecttype_0 ?o_0 mugtype) (receptacletype_0 ?r_0 cabinettype) (ishot ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (holds agent1 mug_3)) (sometime-after (holds agent1 mug_3) (checked cart_2)) (sometime (atlocation agent1 location3)) (sometime-before (atlocation agent1 location3) (checked location1)) (sometime (or (holds agent1 towel_1) (checked location2))) (sometime (atlocation agent1 location2)) (sometime (or (checked location1) (atlocation agent1 location2))) (sometime (atlocation agent1 location1)) (sometime (checked location5)))
