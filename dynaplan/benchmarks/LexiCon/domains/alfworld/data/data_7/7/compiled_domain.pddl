(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   box_5 ladle_4 - obj
   sinkbasin_3 bathtubbasin_4 fridge_7 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location4) (checked location4) (atlocation agent1 location2)) (hold_1)) (when (or (= ?l location3) (checked location3) (objectatlocation box_5 location4)) (hold_3)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7)) (hold_0)) (when (or (= ?r sinkbasin_3) (checked sinkbasin_3) (= ?r bathtubbasin_4) (checked bathtubbasin_4)) (hold_6)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (checked location4) (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_5)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7)) (hold_0)) (when (or (= ?r sinkbasin_3) (checked sinkbasin_3) (= ?r bathtubbasin_4) (checked bathtubbasin_4)) (hold_6)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o ladle_4)) (holds agent1 ladle_4)) (hold_2)) (when (or (checked location3) (and (objectatlocation box_5 location4) (not (and (= ?o box_5) (= ?l location4))))) (hold_3)) (when (and (objectatlocation box_5 location1) (not (and (= ?o box_5) (= ?l location1)))) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 ladle_4) (not (and (= ?a agent1) (= ?o ladle_4)))) (hold_2)) (when (or (checked location3) (and (= ?o box_5) (= ?l location4)) (objectatlocation box_5 location4)) (hold_3)) (when (or (and (= ?o box_5) (= ?l location1)) (objectatlocation box_5 location1)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
