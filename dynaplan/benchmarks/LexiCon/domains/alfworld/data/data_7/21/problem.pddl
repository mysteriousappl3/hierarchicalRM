(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (coolable ?o_0) (objecttype_0 ?o_0 potatotype) (receptacletype_0 ?r_0 sinkbasintype) (iscool ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (or (holds agent1 kettle_4) (atlocation agent1 location4))) (sometime (atlocation agent1 location3)) (sometime-after (atlocation agent1 location3) (or (checked kettle_4) (atlocation agent1 location2))) (sometime (holds agent1 potato_3)) (sometime-before (holds agent1 potato_3) (or (holds agent1 pot_1) (checked toaster_4))) (sometime (atlocation agent1 location2)) (sometime (holds agent1 apple_2)) (sometime (holds agent1 pot_1)) (sometime (or (checked pot_1) (holds agent1 apple_2))))
