(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   drawer_4 - receptacle
   pen_3 cup_5 saltshaker_4 plate_2 mug_1 - obj
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location3) (checked location3)) (hold_5)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r drawer_4) (checked drawer_4)) (hold_1)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o plate_2) (checked plate_2) (atlocation agent1 location1)) (hold_3)) (when (or (atlocation agent1 location2) (= ?o mug_1) (checked mug_1)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (checked plate_2) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_3)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2)))) (checked mug_1)) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r drawer_4) (checked drawer_4)) (hold_1)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o pen_3)) (holds agent1 pen_3)) (hold_0)) (when (or (and (= ?a agent1) (= ?o plate_2)) (holds agent1 plate_2) (and (objectatlocation saltshaker_4 location1) (not (and (= ?o saltshaker_4) (= ?l location1))))) (hold_2)) (when (and (objectatlocation cup_5 location4) (not (and (= ?o cup_5) (= ?l location4)))) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 pen_3) (not (and (= ?a agent1) (= ?o pen_3)))) (hold_0)) (when (or (and (holds agent1 plate_2) (not (and (= ?a agent1) (= ?o plate_2)))) (and (= ?o saltshaker_4) (= ?l location1)) (objectatlocation saltshaker_4 location1)) (hold_2)) (when (or (and (= ?o cup_5) (= ?l location4)) (objectatlocation cup_5 location4)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
