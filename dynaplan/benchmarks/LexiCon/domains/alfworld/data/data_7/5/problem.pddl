(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 boxtype) (receptacletype_0 ?r_0 dressertype))))))
 (:constraints (sometime (or (atlocation agent1 location4) (objectatlocation tissuebox_4 location3))) (sometime (or (objectatlocation laptop_2 location3) (atlocation agent1 location5))) (sometime (atlocation agent1 location2)) (sometime (or (objectatlocation laptop_2 location3) (checked dresser_4))) (sometime (checked diningtable_1)) (sometime (holds agent1 tissuebox_4)) (sometime (or (objectatlocation tissuebox_4 location3) (checked box_5))))
