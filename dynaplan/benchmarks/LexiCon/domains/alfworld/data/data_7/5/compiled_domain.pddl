(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   box_5 tissuebox_4 laptop_2 - obj
   location2 location4 location3 location5 - location
   dresser_4 diningtable_1 - receptacle
   agent1 - agent
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (objectatlocation laptop_2 location3) (= ?r dresser_4) (checked dresser_4)) (hold_3)) (when (or (= ?r diningtable_1) (checked diningtable_1)) (hold_4)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (objectatlocation tissuebox_4 location3) (= ?o box_5) (checked box_5)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (objectatlocation tissuebox_4 location3)) (hold_0)) (when (or (objectatlocation laptop_2 location3) (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_2)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (objectatlocation laptop_2 location3) (= ?r dresser_4) (checked dresser_4)) (hold_3)) (when (or (= ?r diningtable_1) (checked diningtable_1)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (atlocation agent1 location4) (and (objectatlocation tissuebox_4 location3) (not (and (= ?o tissuebox_4) (= ?l location3))))) (hold_0)) (when (or (and (objectatlocation laptop_2 location3) (not (and (= ?o laptop_2) (= ?l location3)))) (atlocation agent1 location5)) (hold_1)) (when (or (and (objectatlocation laptop_2 location3) (not (and (= ?o laptop_2) (= ?l location3)))) (checked dresser_4)) (hold_3)) (when (or (and (= ?a agent1) (= ?o tissuebox_4)) (holds agent1 tissuebox_4)) (hold_5)) (when (or (and (objectatlocation tissuebox_4 location3) (not (and (= ?o tissuebox_4) (= ?l location3)))) (checked box_5)) (hold_6)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (atlocation agent1 location4) (and (= ?o tissuebox_4) (= ?l location3)) (objectatlocation tissuebox_4 location3)) (hold_0)) (when (or (and (= ?o laptop_2) (= ?l location3)) (objectatlocation laptop_2 location3) (atlocation agent1 location5)) (hold_1)) (when (or (and (= ?o laptop_2) (= ?l location3)) (objectatlocation laptop_2 location3) (checked dresser_4)) (hold_3)) (when (and (holds agent1 tissuebox_4) (not (and (= ?a agent1) (= ?o tissuebox_4)))) (hold_5)) (when (or (and (= ?o tissuebox_4) (= ?l location3)) (objectatlocation tissuebox_4 location3) (checked box_5)) (hold_6)) (increase (total-cost) 1)))
 (:action cleanobject
