(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   statue_1 toiletpaper_3 soapbottle_2 tomato_4 - obj
   fridge_7 handtowelholder_3 laundryhamper_4 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (atlocation agent1 location5) (= ?l location4) (checked location4)) (hold_1)) (when (or (= ?l location3) (checked location3) (holds agent1 toiletpaper_3)) (hold_5)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4)) (hold_0)) (when (or (= ?r fridge_7) (checked fridge_7) (objectatlocation soapbottle_2 location2)) (hold_2)) (when (or (= ?r handtowelholder_3) (checked handtowelholder_3) (holds agent1 statue_1)) (hold_4)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o tomato_4) (checked tomato_4) (= ?o soapbottle_2) (checked soapbottle_2)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (checked location4)) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4)) (hold_0)) (when (or (= ?r fridge_7) (checked fridge_7) (objectatlocation soapbottle_2 location2)) (hold_2)) (when (or (= ?r handtowelholder_3) (checked handtowelholder_3) (holds agent1 statue_1)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (checked fridge_7) (and (objectatlocation soapbottle_2 location2) (not (and (= ?o soapbottle_2) (= ?l location2))))) (hold_2)) (when (or (and (= ?a agent1) (= ?o soapbottle_2)) (holds agent1 soapbottle_2)) (hold_3)) (when (or (checked handtowelholder_3) (and (= ?a agent1) (= ?o statue_1)) (holds agent1 statue_1)) (hold_4)) (when (or (checked location3) (and (= ?a agent1) (= ?o toiletpaper_3)) (holds agent1 toiletpaper_3)) (hold_5)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (checked fridge_7) (and (= ?o soapbottle_2) (= ?l location2)) (objectatlocation soapbottle_2 location2)) (hold_2)) (when (and (holds agent1 soapbottle_2) (not (and (= ?a agent1) (= ?o soapbottle_2)))) (hold_3)) (when (or (checked handtowelholder_3) (and (holds agent1 statue_1) (not (and (= ?a agent1) (= ?o statue_1))))) (hold_4)) (when (or (checked location3) (and (holds agent1 toiletpaper_3) (not (and (= ?a agent1) (= ?o toiletpaper_3))))) (hold_5)) (increase (total-cost) 1)))
 (:action cleanobject
