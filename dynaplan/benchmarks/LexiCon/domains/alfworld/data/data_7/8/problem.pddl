(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (coolable ?o_0) (objecttype_0 ?o_0 eggtype) (receptacletype_0 ?r_0 microwavetype) (iscool ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (atlocation agent1 location5)) (sometime-after (atlocation agent1 location5) (or (checked sofa_4) (atlocation agent1 location2))) (sometime (objectatlocation wateringcan_3 location5)) (sometime (holds agent1 egg_4)) (sometime-after (holds agent1 egg_4) (or (atlocation agent1 location2) (holds agent1 pan_1))) (sometime (or (objectatlocation bowl_2 location4) (holds agent1 pan_1))) (sometime (or (objectatlocation box_5 location3) (checked microwave_6))) (sometime (or (holds agent1 bowl_2) (objectatlocation egg_4 location5))) (sometime (holds agent1 wateringcan_3)))
