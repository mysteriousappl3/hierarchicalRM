(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   location1 location4 location3 - location
   spoon_2 bowl_5 toiletpaperroll_4 - obj
   toilet_1 towelholder_5 - receptacle
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location1) (checked location1) (objectatlocation toiletpaperroll_4 location3)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r towelholder_5) (checked towelholder_5)) (hold_4)) (when (or (= ?r towelholder_5) (checked towelholder_5) (= ?r toilet_1) (checked toilet_1)) (hold_5)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o spoon_2) (checked spoon_2)) (hold_1)) (when (or (= ?o bowl_5) (checked bowl_5)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (holds agent1 spoon_2)) (hold_2)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r towelholder_5) (checked towelholder_5)) (hold_4)) (when (or (= ?r towelholder_5) (checked towelholder_5) (= ?r toilet_1) (checked toilet_1)) (hold_5)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (checked location1) (and (objectatlocation toiletpaperroll_4 location3) (not (and (= ?o toiletpaperroll_4) (= ?l location3))))) (hold_0)) (when (or (atlocation agent1 location4) (and (= ?a agent1) (= ?o spoon_2)) (holds agent1 spoon_2)) (hold_2)) (when (or (and (= ?a agent1) (= ?o bowl_5)) (holds agent1 bowl_5)) (hold_3)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (checked location1) (and (= ?o toiletpaperroll_4) (= ?l location3)) (objectatlocation toiletpaperroll_4 location3)) (hold_0)) (when (or (atlocation agent1 location4) (and (holds agent1 spoon_2) (not (and (= ?a agent1) (= ?o spoon_2))))) (hold_2)) (when (and (holds agent1 bowl_5) (not (and (= ?a agent1) (= ?o bowl_5)))) (hold_3)) (increase (total-cost) 1)))
 (:action cleanobject
