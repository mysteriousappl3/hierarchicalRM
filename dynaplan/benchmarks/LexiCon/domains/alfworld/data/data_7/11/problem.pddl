(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 cellphonetype) (receptacletype_0 ?r_0 sidetabletype))))))
 (:constraints (sometime (or (checked location1) (objectatlocation toiletpaperroll_4 location3))) (sometime (checked spoon_2)) (sometime (or (atlocation agent1 location4) (holds agent1 spoon_2))) (sometime (holds agent1 bowl_5)) (sometime (checked towelholder_5)) (sometime (or (checked towelholder_5) (checked toilet_1))) (sometime (checked bowl_5)))
