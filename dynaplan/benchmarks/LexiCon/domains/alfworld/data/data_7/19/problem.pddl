(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 cuptype) (receptacletype_0 ?r_0 cabinettype))))))
 (:constraints (sometime (or (holds agent1 peppershaker_2) (holds agent1 pan_3))) (sometime (holds agent1 soapbottle_1)) (sometime (atlocation agent1 location4)) (sometime (atlocation agent1 location3)) (sometime (or (atlocation agent1 location5) (holds agent1 pan_3))) (sometime (or (atlocation agent1 location4) (checked cup_5))) (sometime (or (checked microwave_6) (holds agent1 basketball_4))))
