(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   peppershaker_2 soapbottle_1 basketball_4 cup_5 pan_3 - obj
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r microwave_6) (checked microwave_6) (holds agent1 basketball_4)) (hold_6)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (atlocation agent1 location4) (= ?o cup_5) (checked cup_5)) (hold_5)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_2)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_3)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (holds agent1 pan_3)) (hold_4)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (checked cup_5)) (hold_5)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r microwave_6) (checked microwave_6) (holds agent1 basketball_4)) (hold_6)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o peppershaker_2)) (holds agent1 peppershaker_2) (and (= ?a agent1) (= ?o pan_3)) (holds agent1 pan_3)) (hold_0)) (when (or (and (= ?a agent1) (= ?o soapbottle_1)) (holds agent1 soapbottle_1)) (hold_1)) (when (or (atlocation agent1 location5) (and (= ?a agent1) (= ?o pan_3)) (holds agent1 pan_3)) (hold_4)) (when (or (checked microwave_6) (and (= ?a agent1) (= ?o basketball_4)) (holds agent1 basketball_4)) (hold_6)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 peppershaker_2) (not (and (= ?a agent1) (= ?o peppershaker_2)))) (and (holds agent1 pan_3) (not (and (= ?a agent1) (= ?o pan_3))))) (hold_0)) (when (and (holds agent1 soapbottle_1) (not (and (= ?a agent1) (= ?o soapbottle_1)))) (hold_1)) (when (or (atlocation agent1 location5) (and (holds agent1 pan_3) (not (and (= ?a agent1) (= ?o pan_3))))) (hold_4)) (when (or (checked microwave_6) (and (holds agent1 basketball_4) (not (and (= ?a agent1) (= ?o basketball_4))))) (hold_6)) (increase (total-cost) 1)))
 (:action cleanobject
