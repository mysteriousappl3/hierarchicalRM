(define (problem alfred-problem)
 ...
 (:objects
   ...
   dishsponge_1 handtowel_2 tomato_3 knife_4 mug_5 - obj
 )
 ...
 (:constraints (sometime (atlocation agent1 location3)) (sometime (or (objectatlocation dishsponge_1 location3) (checked fridge_7))) (sometime (objectatlocation dishsponge_1 location4)) (sometime (or (holds agent1 handtowel_2) (objectatlocation dishsponge_1 location5))) (sometime (atlocation agent1 location2)) (sometime (holds agent1 knife_4)) (sometime (checked knife_4)))
