(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   dishsponge_1 handtowel_2 knife_4 - obj
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (objectatlocation dishsponge_1 location3) (= ?r fridge_7) (checked fridge_7)) (hold_1)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o knife_4) (checked knife_4)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (objectatlocation dishsponge_1 location3) (= ?r fridge_7) (checked fridge_7)) (hold_1)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation dishsponge_1 location3) (not (and (= ?o dishsponge_1) (= ?l location3)))) (checked fridge_7)) (hold_1)) (when (and (objectatlocation dishsponge_1 location4) (not (and (= ?o dishsponge_1) (= ?l location4)))) (hold_2)) (when (or (and (= ?a agent1) (= ?o handtowel_2)) (holds agent1 handtowel_2) (and (objectatlocation dishsponge_1 location5) (not (and (= ?o dishsponge_1) (= ?l location5))))) (hold_3)) (when (or (and (= ?a agent1) (= ?o knife_4)) (holds agent1 knife_4)) (hold_5)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o dishsponge_1) (= ?l location3)) (objectatlocation dishsponge_1 location3) (checked fridge_7)) (hold_1)) (when (or (and (= ?o dishsponge_1) (= ?l location4)) (objectatlocation dishsponge_1 location4)) (hold_2)) (when (or (and (holds agent1 handtowel_2) (not (and (= ?a agent1) (= ?o handtowel_2)))) (and (= ?o dishsponge_1) (= ?l location5)) (objectatlocation dishsponge_1 location5)) (hold_3)) (when (and (holds agent1 knife_4) (not (and (= ?a agent1) (= ?o knife_4)))) (hold_5)) (increase (total-cost) 1)))
 (:action cleanobject
