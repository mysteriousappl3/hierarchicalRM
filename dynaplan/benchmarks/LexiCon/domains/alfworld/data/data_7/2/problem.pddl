(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r_0) (objecttype_0 ?o1 booktype) (receptacletype_0 ?r_0 cabinettype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 mugtype) (receptacletype_0 ?r_0 cabinettype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (objectatlocation book_3 location3) (checked location1))) (sometime (holds agent1 book_3)) (sometime-before (holds agent1 book_3) (checked handtowel_2)) (sometime (holds agent1 mug_5)) (sometime-after (holds agent1 mug_5) (or (objectatlocation wateringcan_4 location4) (holds agent1 handtowel_2))) (sometime (or (objectatlocation wateringcan_4 location3) (holds agent1 wateringcan_4))) (sometime (or (objectatlocation handtowel_2 location2) (holds agent1 spoon_1))) (sometime (or (objectatlocation spoon_1 location4) (objectatlocation book_3 location5))) (sometime (or (checked handtowel_2) (checked mug_5))))
