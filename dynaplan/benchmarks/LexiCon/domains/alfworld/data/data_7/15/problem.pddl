(define (problem alfred-problem)
 ...
 (:constraints (sometime (holds agent1 lettuce_4)) (sometime-after (holds agent1 lettuce_4) (or (objectatlocation remotecontrol_2 location2) (atlocation agent1 location3))) (sometime (atlocation agent1 location4)) (sometime-before (atlocation agent1 location4) (or (checked location4) (checked microwave_6))) (sometime (or (atlocation agent1 location5) (checked remotecontrol_3))) (sometime (or (holds agent1 pot_1) (holds agent1 remotecontrol_2))) (sometime (or (checked bathtubbasin_2) (atlocation agent1 location2))) (sometime (holds agent1 remotecontrol_3)) (sometime (holds agent1 remotecontrol_2)))
