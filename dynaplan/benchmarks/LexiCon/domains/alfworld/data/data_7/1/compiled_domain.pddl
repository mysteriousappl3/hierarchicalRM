(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   remotecontrol_4 cloth_1 plate_5 - obj
   location3 location4 location5 - location
   microwave_3 - receptacle
   agent1 - agent
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (objectatlocation remotecontrol_4 location5) (= ?r microwave_3) (checked microwave_3)) (hold_3)) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_4)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (objectatlocation remotecontrol_4 location5) (= ?o remotecontrol_4) (checked remotecontrol_4)) (hold_2)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (holds agent1 cloth_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_5)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (objectatlocation remotecontrol_4 location3)) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (objectatlocation remotecontrol_4 location5) (= ?r microwave_3) (checked microwave_3)) (hold_3)) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5) (and (= ?a agent1) (= ?o cloth_1)) (holds agent1 cloth_1)) (hold_0)) (when (or (atlocation agent1 location4) (and (= ?a agent1) (= ?o cloth_1)) (holds agent1 cloth_1)) (hold_1)) (when (or (and (objectatlocation remotecontrol_4 location5) (not (and (= ?o remotecontrol_4) (= ?l location5)))) (checked remotecontrol_4)) (hold_2)) (when (or (and (objectatlocation remotecontrol_4 location5) (not (and (= ?o remotecontrol_4) (= ?l location5)))) (checked microwave_3)) (hold_3)) (when (or (atlocation agent1 location5) (and (objectatlocation remotecontrol_4 location3) (not (and (= ?o remotecontrol_4) (= ?l location3))))) (hold_6)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5)))) (and (holds agent1 cloth_1) (not (and (= ?a agent1) (= ?o cloth_1))))) (hold_0)) (when (or (atlocation agent1 location4) (and (holds agent1 cloth_1) (not (and (= ?a agent1) (= ?o cloth_1))))) (hold_1)) (when (or (and (= ?o remotecontrol_4) (= ?l location5)) (objectatlocation remotecontrol_4 location5) (checked remotecontrol_4)) (hold_2)) (when (or (and (= ?o remotecontrol_4) (= ?l location5)) (objectatlocation remotecontrol_4 location5) (checked microwave_3)) (hold_3)) (when (or (atlocation agent1 location5) (and (= ?o remotecontrol_4) (= ?l location3)) (objectatlocation remotecontrol_4 location3)) (hold_6)) (increase (total-cost) 1)))
 (:action cleanobject
