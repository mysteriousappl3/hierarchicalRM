(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o mug_5) (checked mug_5)) (seen_psi_3)) (when (or (= ?o winebottle_3) (checked winebottle_3) (= ?o newspaper_4) (checked newspaper_4)) (hold_4)) (when (or (atlocation agent1 location3) (= ?o winebottle_3) (checked winebottle_3)) (hold_5)) (when (or (holds agent1 winebottle_3) (= ?o bread_2) (checked bread_2)) (hold_7)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart) (or (not (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))))) (seen_psi_1)))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (checked winebottle_3)) (hold_5)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5))) (seen_psi_3)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5)) (hold_2)) (when (or (and (= ?a agent1) (= ?o kettle_1)) (holds agent1 kettle_1)) (hold_6)) (when (or (and (= ?a agent1) (= ?o winebottle_3)) (holds agent1 winebottle_3) (checked bread_2)) (hold_7)) (when (or (checked location5) (and (objectatlocation bread_2 location1) (not (and (= ?o bread_2) (= ?l location1))))) (hold_8)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5))))) (seen_psi_3)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (hold_2)) (when (and (holds agent1 kettle_1) (not (and (= ?a agent1) (= ?o kettle_1)))) (hold_6)) (when (or (and (holds agent1 winebottle_3) (not (and (= ?a agent1) (= ?o winebottle_3)))) (checked bread_2)) (hold_7)) (when (or (checked location5) (and (= ?o bread_2) (= ?l location1)) (objectatlocation bread_2 location1)) (hold_8)) (increase (total-cost) 1)))
 (:action cleanobject
