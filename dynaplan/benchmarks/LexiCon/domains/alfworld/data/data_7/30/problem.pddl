(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (coolable ?o_0) (objecttype_0 ?o_0 mugtype) (receptacletype_0 ?r_0 sidetabletype) (iscool ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (or (objectatlocation tomato_4 location5) (atlocation agent1 location5))) (sometime (atlocation agent1 location2)) (sometime-before (atlocation agent1 location2) (atlocation agent1 location5)) (sometime (checked mug_5)) (sometime (or (atlocation agent1 location3) (holds agent1 peppershaker_3))) (sometime (checked location5)) (sometime (holds agent1 mug_5)) (sometime-after (holds agent1 mug_5) (atlocation agent1 location1)) (sometime (or (checked location3) (checked toiletpaper_2))))
