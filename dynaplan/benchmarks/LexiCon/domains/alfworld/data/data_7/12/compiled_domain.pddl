(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   bread_4 glassbottle_1 pan_5 basketball_2 - obj
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location5) (checked location5)) (hold_7)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r stoveburner_3) (checked stoveburner_3)) (hold_2)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o glassbottle_1) (checked glassbottle_1) (objectatlocation glassbottle_1 location1)) (hold_4)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (and (holds agent1 bread_4) (not (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_3)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r stoveburner_3) (checked stoveburner_3)) (hold_2)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o bread_4)) (holds agent1 bread_4)) (hold_0)) (when (and (or (and (= ?a agent1) (= ?o bread_4)) (holds agent1 bread_4)) (not (atlocation agent1 location5))) (not (hold_1))) (when (or (checked glassbottle_1) (and (objectatlocation glassbottle_1 location1) (not (and (= ?o glassbottle_1) (= ?l location1))))) (hold_4)) (when (or (and (= ?a agent1) (= ?o basketball_2)) (holds agent1 basketball_2)) (hold_5)) (when (or (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5)) (hold_6)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 bread_4) (not (and (= ?a agent1) (= ?o bread_4)))) (hold_0)) (when (and (holds agent1 bread_4) (not (and (= ?a agent1) (= ?o bread_4))) (not (atlocation agent1 location5))) (not (hold_1))) (when (or (checked glassbottle_1) (and (= ?o glassbottle_1) (= ?l location1)) (objectatlocation glassbottle_1 location1)) (hold_4)) (when (and (holds agent1 basketball_2) (not (and (= ?a agent1) (= ?o basketball_2)))) (hold_5)) (when (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5)))) (hold_6)) (increase (total-cost) 1)))
 (:action cleanobject
