(define (problem alfred-problem)
 ...
 (:constraints (sometime (holds agent1 bread_4)) (sometime-after (holds agent1 bread_4) (atlocation agent1 location5)) (sometime (checked stoveburner_3)) (sometime (atlocation agent1 location1)) (sometime (or (checked glassbottle_1) (objectatlocation glassbottle_1 location1))) (sometime (holds agent1 basketball_2)) (sometime (holds agent1 pan_5)) (sometime (checked location5)))
