(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 dishspongetype) (receptacletype_0 ?r_0 diningtabletype))))))
 (:constraints (sometime (atlocation agent1 location4)) (sometime (holds agent1 dishsponge_4)) (sometime-before (holds agent1 dishsponge_4) (objectatlocation box_3 location2)) (sometime (holds agent1 toiletpaper_1)) (sometime (atlocation agent1 location3)) (sometime-after (atlocation agent1 location3) (atlocation agent1 location4)) (sometime (objectatlocation dishsponge_4 location2)) (sometime-before (objectatlocation dishsponge_4 location2) (checked location3)) (sometime (or (checked fridge_7) (holds agent1 box_3))) (sometime (or (checked fridge_7) (objectatlocation dishsponge_4 location1))))
