(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7) (holds agent1 box_3)) (hold_8)) (when (or (= ?r fridge_7) (checked fridge_7) (objectatlocation dishsponge_4 location1)) (hold_9)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_4)) (when (and (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (not (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))))) (not (hold_5))) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_5)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7) (holds agent1 box_3)) (hold_8)) (when (or (= ?r fridge_7) (checked fridge_7) (objectatlocation dishsponge_4 location1)) (hold_9)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o dishsponge_4)) (holds agent1 dishsponge_4))) (seen_psi_2)) (or (not (and (objectatlocation dishsponge_4 location2) (not (and (= ?o dishsponge_4) (= ?l location2))))) (seen_psi_7)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o dishsponge_4)) (holds agent1 dishsponge_4)) (hold_1)) (when (and (objectatlocation box_3 location2) (not (and (= ?o box_3) (= ?l location2)))) (seen_psi_2)) (when (or (and (= ?a agent1) (= ?o toiletpaper_1)) (holds agent1 toiletpaper_1)) (hold_3)) (when (and (objectatlocation dishsponge_4 location2) (not (and (= ?o dishsponge_4) (= ?l location2)))) (hold_6)) (when (or (checked fridge_7) (and (= ?a agent1) (= ?o box_3)) (holds agent1 box_3)) (hold_8)) (when (or (checked fridge_7) (and (objectatlocation dishsponge_4 location1) (not (and (= ?o dishsponge_4) (= ?l location1))))) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 dishsponge_4) (not (and (= ?a agent1) (= ?o dishsponge_4))))) (seen_psi_2)) (or (not (or (and (= ?o dishsponge_4) (= ?l location2)) (objectatlocation dishsponge_4 location2))) (seen_psi_7)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 dishsponge_4) (not (and (= ?a agent1) (= ?o dishsponge_4)))) (hold_1)) (when (or (and (= ?o box_3) (= ?l location2)) (objectatlocation box_3 location2)) (seen_psi_2)) (when (and (holds agent1 toiletpaper_1) (not (and (= ?a agent1) (= ?o toiletpaper_1)))) (hold_3)) (when (or (and (= ?o dishsponge_4) (= ?l location2)) (objectatlocation dishsponge_4 location2)) (hold_6)) (when (or (checked fridge_7) (and (holds agent1 box_3) (not (and (= ?a agent1) (= ?o box_3))))) (hold_8)) (when (or (checked fridge_7) (and (= ?o dishsponge_4) (= ?l location1)) (objectatlocation dishsponge_4 location1)) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
