(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   wateringcan_4 newspaper_3 ladle_1 baseballbat_2 plate_5 - obj
   toiletpaperhanger_2 - receptacle
   location1 location5 location2 - location
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (holds agent1 baseballbat_2) (= ?r toiletpaperhanger_2) (checked toiletpaperhanger_2)) (hold_1)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o ladle_1) (checked ladle_1)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (holds agent1 newspaper_3)) (seen_psi_4)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_7)) (when (and (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (not (holds agent1 newspaper_3))) (not (hold_8))) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (holds agent1 baseballbat_2) (= ?r toiletpaperhanger_2) (checked toiletpaperhanger_2)) (hold_1)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5))) (seen_psi_4)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o newspaper_3)) (holds agent1 newspaper_3)) (hold_0)) (when (or (and (= ?a agent1) (= ?o baseballbat_2)) (holds agent1 baseballbat_2) (checked toiletpaperhanger_2)) (hold_1)) (when (or (and (= ?a agent1) (= ?o wateringcan_4)) (holds agent1 wateringcan_4)) (hold_2)) (when (or (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5)) (hold_3)) (when (or (atlocation agent1 location5) (and (= ?a agent1) (= ?o newspaper_3)) (holds agent1 newspaper_3)) (seen_psi_4)) (when (and (objectatlocation plate_5 location1) (not (and (= ?o plate_5) (= ?l location1)))) (hold_5)) (when (and (atlocation agent1 location2) (not (or (and (= ?a agent1) (= ?o newspaper_3)) (holds agent1 newspaper_3)))) (not (hold_8))) (when (or (and (= ?a agent1) (= ?o newspaper_3)) (holds agent1 newspaper_3)) (hold_8)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5))))) (seen_psi_4)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 newspaper_3) (not (and (= ?a agent1) (= ?o newspaper_3)))) (hold_0)) (when (or (and (holds agent1 baseballbat_2) (not (and (= ?a agent1) (= ?o baseballbat_2)))) (checked toiletpaperhanger_2)) (hold_1)) (when (and (holds agent1 wateringcan_4) (not (and (= ?a agent1) (= ?o wateringcan_4)))) (hold_2)) (when (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5)))) (hold_3)) (when (or (atlocation agent1 location5) (and (holds agent1 newspaper_3) (not (and (= ?a agent1) (= ?o newspaper_3))))) (seen_psi_4)) (when (or (and (= ?o plate_5) (= ?l location1)) (objectatlocation plate_5 location1)) (hold_5)) (when (and (atlocation agent1 location2) (not (and (holds agent1 newspaper_3) (not (and (= ?a agent1) (= ?o newspaper_3)))))) (not (hold_8))) (when (and (holds agent1 newspaper_3) (not (and (= ?a agent1) (= ?o newspaper_3)))) (hold_8)) (increase (total-cost) 1)))
 (:action cleanobject
