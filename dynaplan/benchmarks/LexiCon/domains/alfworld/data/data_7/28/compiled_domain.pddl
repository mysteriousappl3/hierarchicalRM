(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   location2 location3 location5 location4 - location
   mug_5 pan_4 glassbottle_3 book_2 - obj
   agent1 - agent
   armchair_2 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location5) (checked location5) (checked book_2)) (hold_6)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (holds agent1 book_2) (= ?r armchair_2) (checked armchair_2)) (hold_2)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (objectatlocation glassbottle_3 location5) (= ?o mug_5) (checked mug_5)) (hold_3)) (when (or (checked location5) (= ?o book_2) (checked book_2)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_1)) (when (or (objectatlocation pan_4 location5) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (holds agent1 book_2) (= ?r armchair_2) (checked armchair_2)) (hold_2)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o book_2)) (holds agent1 book_2) (checked armchair_2)) (hold_2)) (when (or (and (objectatlocation glassbottle_3 location5) (not (and (= ?o glassbottle_3) (= ?l location5)))) (checked mug_5)) (hold_3)) (when (or (and (objectatlocation pan_4 location5) (not (and (= ?o pan_4) (= ?l location5)))) (atlocation agent1 location3)) (hold_4)) (when (or (and (= ?a agent1) (= ?o book_2)) (holds agent1 book_2)) (hold_5)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 book_2) (not (and (= ?a agent1) (= ?o book_2)))) (checked armchair_2)) (hold_2)) (when (or (and (= ?o glassbottle_3) (= ?l location5)) (objectatlocation glassbottle_3 location5) (checked mug_5)) (hold_3)) (when (or (and (= ?o pan_4) (= ?l location5)) (objectatlocation pan_4 location5) (atlocation agent1 location3)) (hold_4)) (when (and (holds agent1 book_2) (not (and (= ?a agent1) (= ?o book_2)))) (hold_5)) (increase (total-cost) 1)))
 (:action cleanobject
