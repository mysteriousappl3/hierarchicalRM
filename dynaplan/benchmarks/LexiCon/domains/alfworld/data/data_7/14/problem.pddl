(define (problem alfred-problem)
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 appletype) (receptacletype_0 ?r_0 microwavetype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (holds agent1 tomato_2)) (sometime (objectatlocation apple_4 location4)) (sometime (or (atlocation agent1 location5) (holds agent1 mug_5))) (sometime (holds agent1 apple_4)) (sometime (or (holds agent1 tomato_2) (objectatlocation apple_4 location3))) (sometime (or (objectatlocation cellphone_3 location4) (checked sofa_3))) (sometime (or (atlocation agent1 location3) (checked fridge_2))))
