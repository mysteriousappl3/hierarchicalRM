(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   countertop_1 laundryhamper_4 - receptacle
   agent1 - agent
   creditcard_4 handtowel_2 spraybottle_3 spoon_1 - obj
   location2 location5 location3 - location
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4) (holds agent1 spoon_1)) (hold_1)) (when (or (holds agent1 creditcard_4) (= ?r countertop_1) (checked countertop_1)) (hold_2)) (when (or (= ?r countertop_1) (checked countertop_1)) (hold_3)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_4)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_5)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (holds agent1 spraybottle_3)) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4) (holds agent1 spoon_1)) (hold_1)) (when (or (holds agent1 creditcard_4) (= ?r countertop_1) (checked countertop_1)) (hold_2)) (when (or (= ?r countertop_1) (checked countertop_1)) (hold_3)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o handtowel_2)) (holds agent1 handtowel_2) (and (objectatlocation spraybottle_3 location5) (not (and (= ?o spraybottle_3) (= ?l location5))))) (hold_0)) (when (or (checked laundryhamper_4) (and (= ?a agent1) (= ?o spoon_1)) (holds agent1 spoon_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?o creditcard_4)) (holds agent1 creditcard_4) (checked countertop_1)) (hold_2)) (when (or (atlocation agent1 location3) (and (= ?a agent1) (= ?o spraybottle_3)) (holds agent1 spraybottle_3)) (hold_6)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 handtowel_2) (not (and (= ?a agent1) (= ?o handtowel_2)))) (and (= ?o spraybottle_3) (= ?l location5)) (objectatlocation spraybottle_3 location5)) (hold_0)) (when (or (checked laundryhamper_4) (and (holds agent1 spoon_1) (not (and (= ?a agent1) (= ?o spoon_1))))) (hold_1)) (when (or (and (holds agent1 creditcard_4) (not (and (= ?a agent1) (= ?o creditcard_4)))) (checked countertop_1)) (hold_2)) (when (or (atlocation agent1 location3) (and (holds agent1 spraybottle_3) (not (and (= ?a agent1) (= ?o spraybottle_3))))) (hold_6)) (increase (total-cost) 1)))
 (:action cleanobject
