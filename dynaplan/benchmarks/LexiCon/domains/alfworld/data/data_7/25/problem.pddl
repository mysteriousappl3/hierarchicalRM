(define (problem alfred-problem)
 ...
 (:objects
   ...
   spoon_1 handtowel_2 spraybottle_3 creditcard_4 pot_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 handtoweltype) (receptacletype_0 ?r_0 countertoptype))))))
 (:constraints (sometime (or (holds agent1 handtowel_2) (objectatlocation spraybottle_3 location5))) (sometime (or (checked laundryhamper_4) (holds agent1 spoon_1))) (sometime (or (holds agent1 creditcard_4) (checked countertop_1))) (sometime (checked countertop_1)) (sometime (atlocation agent1 location3)) (sometime (atlocation agent1 location2)) (sometime (or (atlocation agent1 location3) (holds agent1 spraybottle_3))))
