(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (checked agent1) (= ?l location5) (checked location5)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (= ?a agent1) (checked agent1) (checked location5)) (hold_0)) (increase (total-cost) 1)))
