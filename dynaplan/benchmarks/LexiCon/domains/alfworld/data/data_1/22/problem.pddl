(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (coolable ?o_0) (objecttype_0 ?o_0 platetype) (receptacletype_0 ?r_0 fridgetype) (iscool ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (or (checked agent1) (checked location5))))
