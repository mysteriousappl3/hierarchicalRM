(define (domain liftedtcore_alfred-domain)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation mug_3 location2) (not (and (= ?o mug_3) (= ?l location2)))) (and (objectatlocation apple_1 location5) (not (and (= ?o apple_1) (= ?l location5))))) (hold_0)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o mug_3) (= ?l location2)) (objectatlocation mug_3 location2) (and (= ?o apple_1) (= ?l location5)) (objectatlocation apple_1 location5)) (hold_0)) (increase (total-cost) 1)))
 (:action cleanobject
