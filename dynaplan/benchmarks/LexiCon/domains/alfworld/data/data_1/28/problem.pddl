(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 mugtype) (receptacletype_0 ?r_0 desktype))))))
 (:constraints (sometime (or (objectatlocation mug_3 location2) (objectatlocation apple_1 location5))))
