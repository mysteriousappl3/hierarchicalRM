(define (domain liftedtcore_alfred-domain)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5)) (hold_0)) (when (or (and (objectatlocation cellphone_4 location1) (not (and (= ?o cellphone_4) (= ?l location1)))) (and (objectatlocation cellphone_4 location4) (not (and (= ?o cellphone_4) (= ?l location4))))) (seen_psi_1)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (hold_0)) (when (or (and (= ?o cellphone_4) (= ?l location1)) (objectatlocation cellphone_4 location1) (and (= ?o cellphone_4) (= ?l location4)) (objectatlocation cellphone_4 location4)) (seen_psi_1)) (increase (total-cost) 1)))
 (:action cleanobject
