(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location7) (checked location7) (checked microwave_9)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (checked location7) (= ?r microwave_9) (checked microwave_9)) (hold_0)) (increase (total-cost) 1)))
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (checked location7) (= ?r microwave_9) (checked microwave_9)) (hold_0)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
