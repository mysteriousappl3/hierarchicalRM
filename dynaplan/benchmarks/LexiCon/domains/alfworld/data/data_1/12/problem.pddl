(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 tomatotype) (receptacletype_0 ?r_0 garbagecantype))))))
 (:constraints (sometime (and (checked fridge_7) (atlocation agent1 location1))))
