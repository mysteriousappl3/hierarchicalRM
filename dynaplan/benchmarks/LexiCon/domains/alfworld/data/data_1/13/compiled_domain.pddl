(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o box_1) (checked box_1) (objectatlocation glassbottle_2 location2)) (seen_psi_1)) (increase (total-cost) 1)))
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_0)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (checked box_1) (and (objectatlocation glassbottle_2 location2) (not (and (= ?o glassbottle_2) (= ?l location2))))) (seen_psi_1)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (checked box_1) (and (= ?o glassbottle_2) (= ?l location2)) (objectatlocation glassbottle_2 location2)) (seen_psi_1)) (increase (total-cost) 1)))
 (:action cleanobject
