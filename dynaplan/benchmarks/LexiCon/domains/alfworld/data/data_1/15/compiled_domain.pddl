(define (domain liftedtcore_alfred-domain)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (and (holds agent1 plate_5) (not (or (holds agent1 cup_1) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))))) (not (hold_1))) (when (or (holds agent1 cup_1) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5)) (hold_0)) (when (and (or (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5)) (not (or (and (= ?a agent1) (= ?o cup_1)) (holds agent1 cup_1) (atlocation agent1 location3)))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?o cup_1)) (holds agent1 cup_1) (atlocation agent1 location3)) (hold_1)) (increase (total-cost) 1)))
 (:action putobject
