(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (coolable ?o_0) (objecttype_0 ?o_0 bowltype) (receptacletype_0 ?r_0 dressertype) (iscool ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (holds agent1 bowl_3)) (sometime-after (holds agent1 bowl_3) (holds agent1 pan_5)))
