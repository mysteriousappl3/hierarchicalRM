(define (domain liftedtcore_alfred-domain)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o bowl_3)) (holds agent1 bowl_3)) (hold_0)) (when (and (or (and (= ?a agent1) (= ?o bowl_3)) (holds agent1 bowl_3)) (not (or (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5)))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5)) (hold_1)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 bowl_3) (not (and (= ?a agent1) (= ?o bowl_3)))) (hold_0)) (when (and (holds agent1 bowl_3) (not (and (= ?a agent1) (= ?o bowl_3))) (not (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5)))))) (not (hold_1))) (when (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5)))) (hold_1)) (increase (total-cost) 1)))
 (:action cleanobject
