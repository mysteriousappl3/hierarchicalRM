(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 cellphonetype) (receptacletype_0 ?r_0 countertoptype))))))
 (:constraints (sometime (atlocation agent1 location1)) (sometime-before (atlocation agent1 location1) (checked location5)))
