(define (domain liftedtcore_alfred-domain)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (and (objectatlocation handtowel_3 location2) (not (and (= ?o handtowel_3) (= ?l location2)))) (hold_0)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o handtowel_3) (= ?l location2)) (objectatlocation handtowel_3 location2)) (hold_0)) (increase (total-cost) 1)))
 (:action cleanobject
