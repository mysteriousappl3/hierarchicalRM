(define (problem alfred-problem)
 ...
 (:objects
   ...
   spoon_1 book_2 handtowel_3 cup_4 pan_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 spoontype) (receptacletype_0 ?r_0 drawertype))))))
 (:constraints (sometime (objectatlocation handtowel_3 location2)))
