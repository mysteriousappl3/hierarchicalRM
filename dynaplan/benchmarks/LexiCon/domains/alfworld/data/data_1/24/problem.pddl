(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r_0) (objecttype_0 ?o1 watchtype) (receptacletype_0 ?r_0 countertoptype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 statuetype) (receptacletype_0 ?r_0 countertoptype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (holds agent1 statue_1)) (sometime-before (holds agent1 statue_1) (atlocation agent1 location2)))
