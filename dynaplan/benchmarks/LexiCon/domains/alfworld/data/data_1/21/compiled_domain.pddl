(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o cellphone_2) (checked cellphone_2) (holds agent1 cellphone_2)) (hold_0)) (increase (total-cost) 1)))
 (:action gotolocation
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (checked cellphone_2) (and (= ?a agent1) (= ?o cellphone_2)) (holds agent1 cellphone_2)) (hold_0)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (checked cellphone_2) (and (holds agent1 cellphone_2) (not (and (= ?a agent1) (= ?o cellphone_2))))) (hold_0)) (increase (total-cost) 1)))
 (:action cleanobject
