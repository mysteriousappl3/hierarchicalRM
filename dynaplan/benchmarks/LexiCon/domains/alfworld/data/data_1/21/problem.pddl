(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r_0) (objecttype_0 ?o1 papertoweltype) (receptacletype_0 ?r_0 sidetabletype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 boxtype) (receptacletype_0 ?r_0 sidetabletype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (checked cellphone_2) (holds agent1 cellphone_2))))
