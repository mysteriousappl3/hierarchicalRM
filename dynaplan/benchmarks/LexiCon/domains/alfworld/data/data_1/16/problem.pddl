(define (problem alfred-problem)
 ...
 (:objects
   ...
   cloth_1 cd_2 bread_3 keychain_4 bowl_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 clothtype) (receptacletype_0 ?r_0 ottomantype))))))
 (:constraints (sometime (or (holds agent1 keychain_4) (atlocation agent1 location2))))
