(define (domain liftedtcore_alfred-domain)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (and (atlocation agent1 location5) (not (or (and (= ?a agent1) (= ?o pot_2)) (holds agent1 pot_2) (and (= ?a agent1) (= ?o egg_4)) (holds agent1 egg_4)))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?o pot_2)) (holds agent1 pot_2) (and (= ?a agent1) (= ?o egg_4)) (holds agent1 egg_4)) (hold_1)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (atlocation agent1 location5) (not (or (and (holds agent1 pot_2) (not (and (= ?a agent1) (= ?o pot_2)))) (and (holds agent1 egg_4) (not (and (= ?a agent1) (= ?o egg_4))))))) (not (hold_1))) (when (or (and (holds agent1 pot_2) (not (and (= ?a agent1) (= ?o pot_2)))) (and (holds agent1 egg_4) (not (and (= ?a agent1) (= ?o egg_4))))) (hold_1)) (increase (total-cost) 1)))
 (:action cleanobject
