(define (domain liftedtcore_alfred-domain)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))) (and (= ?a agent1) (= ?lend location8)) (and (atlocation agent1 location8) (not (and (= ?a agent1) (= ?lstart location8))))) (hold_0)) (increase (total-cost) 1)))
 (:action openobject
