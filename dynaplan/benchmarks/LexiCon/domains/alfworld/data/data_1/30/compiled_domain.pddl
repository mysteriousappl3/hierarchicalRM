(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   location4 location3 - location
   mug_4 - obj
   sinkbasintype microwavetype fridgetype - receptacletype
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_0)) (when (and (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (not (or (holds agent1 mug_4) (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))))) (not (hold_1))) (when (or (holds agent1 mug_4) (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (and (atlocation agent1 location3) (not (or (and (= ?a agent1) (= ?o mug_4)) (holds agent1 mug_4) (atlocation agent1 location4)))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?o mug_4)) (holds agent1 mug_4) (atlocation agent1 location4)) (hold_1)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (atlocation agent1 location3) (not (or (and (holds agent1 mug_4) (not (and (= ?a agent1) (= ?o mug_4)))) (atlocation agent1 location4)))) (not (hold_1))) (when (or (and (holds agent1 mug_4) (not (and (= ?a agent1) (= ?o mug_4)))) (atlocation agent1 location4)) (hold_1)) (increase (total-cost) 1)))
 (:action cleanobject
