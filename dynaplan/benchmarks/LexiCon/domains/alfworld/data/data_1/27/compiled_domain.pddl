(define (domain liftedtcore_alfred-domain)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5) (and (objectatlocation bowl_4 location5) (not (and (= ?o bowl_4) (= ?l location5))))) (hold_0)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (and (= ?o bowl_4) (= ?l location5)) (objectatlocation bowl_4 location5)) (hold_0)) (increase (total-cost) 1)))
 (:action cleanobject
