(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r_0) (objecttype_0 ?o1 statuetype) (receptacletype_0 ?r_0 sidetabletype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 vasetype) (receptacletype_0 ?r_0 sidetabletype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (holds agent1 mug_5) (objectatlocation bowl_4 location5))))
