(define (domain liftedtcore_alfred-domain)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_0)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_3)) (holds agent1 mug_3) (and (objectatlocation mug_5 location2) (not (and (= ?o mug_5) (= ?l location2))))) (hold_1)) (when (or (and (objectatlocation mug_5 location2) (not (and (= ?o mug_5) (= ?l location2)))) (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 mug_3) (not (and (= ?a agent1) (= ?o mug_3)))) (and (= ?o mug_5) (= ?l location2)) (objectatlocation mug_5 location2)) (hold_1)) (when (or (and (= ?o mug_5) (= ?l location2)) (objectatlocation mug_5 location2) (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5))))) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
