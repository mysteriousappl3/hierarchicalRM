(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   diningtable_2 - receptacle
   agent1 - agent
   location1 location2 - location
   book_3 lettuce_4 - obj
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r diningtable_2) (checked diningtable_2)) (hold_0)) (increase (total-cost) 1)))
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r diningtable_2) (checked diningtable_2)) (hold_0)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o book_3)) (holds agent1 book_3) (and (objectatlocation lettuce_4 location1) (not (and (= ?o lettuce_4) (= ?l location1))))) (hold_1)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 book_3) (not (and (= ?a agent1) (= ?o book_3)))) (and (= ?o lettuce_4) (= ?l location1)) (objectatlocation lettuce_4 location1)) (hold_1)) (increase (total-cost) 1)))
 (:action cleanobject
