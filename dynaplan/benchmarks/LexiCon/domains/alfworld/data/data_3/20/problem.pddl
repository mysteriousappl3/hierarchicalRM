(define (problem alfred-problem)
 ...
 (:objects
   ...
   ladle_1 tomato_2 book_3 lettuce_4 bowl_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 bowltype) (receptacletype_0 ?r_0 diningtabletype))))))
 (:constraints (sometime (checked diningtable_2)) (sometime (or (holds agent1 book_3) (objectatlocation lettuce_4 location1))) (sometime (atlocation agent1 location2)))
