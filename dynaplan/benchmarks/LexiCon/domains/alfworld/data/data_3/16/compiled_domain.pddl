(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   location3 location4 location1 location5 - location
   keychain_3 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (atlocation agent1 location5) (= ?l location4) (checked location4)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (checked location4)) (hold_0)) (when (or (objectatlocation keychain_3 location1) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_1)) (when (or (holds agent1 keychain_3) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_2)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation keychain_3 location1) (not (and (= ?o keychain_3) (= ?l location1)))) (atlocation agent1 location1)) (hold_1)) (when (or (and (= ?a agent1) (= ?o keychain_3)) (holds agent1 keychain_3) (atlocation agent1 location3)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o keychain_3) (= ?l location1)) (objectatlocation keychain_3 location1) (atlocation agent1 location1)) (hold_1)) (when (or (and (holds agent1 keychain_3) (not (and (= ?a agent1) (= ?o keychain_3)))) (atlocation agent1 location3)) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
