(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 lettucetype) (receptacletype_0 ?r_0 diningtabletype))))))
 (:constraints (sometime (or (atlocation agent1 location5) (checked location4))) (sometime (or (objectatlocation keychain_3 location1) (atlocation agent1 location1))) (sometime (or (holds agent1 keychain_3) (atlocation agent1 location3))))
