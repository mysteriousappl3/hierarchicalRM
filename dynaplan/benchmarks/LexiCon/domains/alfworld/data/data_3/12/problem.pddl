(define (problem alfred-problem)
 ...
 (:constraints (sometime (atlocation agent1 location2)) (sometime-after (atlocation agent1 location2) (or (atlocation agent1 location3) (checked location2))) (sometime (atlocation agent1 location5)) (sometime-before (atlocation agent1 location5) (or (holds agent1 newspaper_4) (atlocation agent1 location3))) (sometime (or (atlocation agent1 location1) (objectatlocation plate_5 location1))))
