(define (domain liftedtcore_alfred-domain)
 ...
 (:action gotolocation
  ...
  :precondition (and (atlocation ?a ?lstart) (or (not (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))))) (seen_psi_3)))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_0)) (when (and (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (not (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (checked location2)))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (checked location2)) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_2)) (when (or (holds agent1 newspaper_4) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (seen_psi_3)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))) (objectatlocation plate_5 location1)) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o newspaper_4)) (holds agent1 newspaper_4) (atlocation agent1 location3)) (seen_psi_3)) (when (or (atlocation agent1 location1) (and (objectatlocation plate_5 location1) (not (and (= ?o plate_5) (= ?l location1))))) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 newspaper_4) (not (and (= ?a agent1) (= ?o newspaper_4)))) (atlocation agent1 location3)) (seen_psi_3)) (when (or (atlocation agent1 location1) (and (= ?o plate_5) (= ?l location1)) (objectatlocation plate_5 location1)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
