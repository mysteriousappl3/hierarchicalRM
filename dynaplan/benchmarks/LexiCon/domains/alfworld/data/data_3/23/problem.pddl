(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 bowltype) (receptacletype_0 ?r_0 shelftype))))))
 (:constraints (sometime (holds agent1 bowl_5)) (sometime-before (holds agent1 bowl_5) (atlocation agent1 location5)) (sometime (atlocation agent1 location2)) (sometime (holds agent1 egg_3)))
