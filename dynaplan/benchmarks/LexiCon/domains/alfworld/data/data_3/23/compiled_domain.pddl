(define (domain liftedtcore_alfred-domain)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (seen_psi_1)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_2)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o bowl_5)) (holds agent1 bowl_5))) (seen_psi_1)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o bowl_5)) (holds agent1 bowl_5)) (hold_0)) (when (or (and (= ?a agent1) (= ?o egg_3)) (holds agent1 egg_3)) (hold_3)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 bowl_5) (not (and (= ?a agent1) (= ?o bowl_5))))) (seen_psi_1)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 bowl_5) (not (and (= ?a agent1) (= ?o bowl_5)))) (hold_0)) (when (and (holds agent1 egg_3) (not (and (= ?a agent1) (= ?o egg_3)))) (hold_3)) (increase (total-cost) 1)))
 (:action cleanobject
