(define (domain liftedtcore_alfred-domain)
 ...
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (atlocation agent1 location1) (= ?a agent1) (checked agent1)) (hold_2)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (and (holds agent1 cup_5) (not (or (objectatlocation potato_3 location1) (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))))) (not (hold_1))) (when (or (objectatlocation potato_3 location1) (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))) (checked agent1)) (hold_2)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_3)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o cup_5)) (holds agent1 cup_5)) (hold_0)) (when (and (or (and (= ?a agent1) (= ?o cup_5)) (holds agent1 cup_5)) (not (or (and (objectatlocation potato_3 location1) (not (and (= ?o potato_3) (= ?l location1)))) (atlocation agent1 location5)))) (not (hold_1))) (when (or (and (objectatlocation potato_3 location1) (not (and (= ?o potato_3) (= ?l location1)))) (atlocation agent1 location5)) (hold_1)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 cup_5) (not (and (= ?a agent1) (= ?o cup_5)))) (hold_0)) (when (and (holds agent1 cup_5) (not (and (= ?a agent1) (= ?o cup_5))) (not (or (and (= ?o potato_3) (= ?l location1)) (objectatlocation potato_3 location1) (atlocation agent1 location5)))) (not (hold_1))) (when (or (and (= ?o potato_3) (= ?l location1)) (objectatlocation potato_3 location1) (atlocation agent1 location5)) (hold_1)) (increase (total-cost) 1)))
 (:action cleanobject
