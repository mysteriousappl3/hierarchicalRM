(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r towelholder_4) (checked towelholder_4)) (hold_3)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (objectatlocation lettuce_1 location4)) (hold_0)) (when (and (holds agent1 bread_4) (not (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))))) (not (hold_2))) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_2)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r towelholder_4) (checked towelholder_4)) (hold_3)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (atlocation agent1 location5) (and (objectatlocation lettuce_1 location4) (not (and (= ?o lettuce_1) (= ?l location4))))) (hold_0)) (when (or (and (= ?a agent1) (= ?o bread_4)) (holds agent1 bread_4)) (hold_1)) (when (and (or (and (= ?a agent1) (= ?o bread_4)) (holds agent1 bread_4)) (not (atlocation agent1 location4))) (not (hold_2))) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (atlocation agent1 location5) (and (= ?o lettuce_1) (= ?l location4)) (objectatlocation lettuce_1 location4)) (hold_0)) (when (and (holds agent1 bread_4) (not (and (= ?a agent1) (= ?o bread_4)))) (hold_1)) (when (and (holds agent1 bread_4) (not (and (= ?a agent1) (= ?o bread_4))) (not (atlocation agent1 location4))) (not (hold_2))) (increase (total-cost) 1)))
 (:action cleanobject
