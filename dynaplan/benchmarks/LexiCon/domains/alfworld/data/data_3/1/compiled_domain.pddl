(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r sinkbasin_3) (checked sinkbasin_3)) (hold_0)) (increase (total-cost) 1)))
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r sinkbasin_3) (checked sinkbasin_3)) (hold_0)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (= ?a agent1) (holdsany agent1)) (hold_1)) (when (or (and (objectatlocation bread_2 location2) (not (and (= ?o bread_2) (= ?l location2)))) (= ?a agent1) (holdsany agent1)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_1)) (when (or (and (= ?o bread_2) (= ?l location2)) (objectatlocation bread_2 location2) (and (holdsany agent1) (not (= ?a agent1)))) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
