(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_5) (checked fridge_5)) (hold_0)) (increase (total-cost) 1)))
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_5) (checked fridge_5)) (hold_0)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (not (or (and (= ?a agent1) (= ?o pot_2)) (holds agent1 pot_2))))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (= ?a agent1) (holdsany agent1)) (hold_1)) (when (and (or (= ?a agent1) (holdsany agent1)) (not (or (and (= ?a agent1) (= ?o book_1)) (holds agent1 book_1) (and (objectatlocation pot_3 location1) (not (and (= ?o pot_3) (= ?l location1))))))) (not (hold_2))) (when (or (and (= ?a agent1) (= ?o book_1)) (holds agent1 book_1) (and (objectatlocation pot_3 location1) (not (and (= ?o pot_3) (= ?l location1))))) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (not (and (holds agent1 pot_2) (not (and (= ?a agent1) (= ?o pot_2))))))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_1)) (when (and (holdsany agent1) (not (= ?a agent1)) (not (or (and (holds agent1 book_1) (not (and (= ?a agent1) (= ?o book_1)))) (and (= ?o pot_3) (= ?l location1)) (objectatlocation pot_3 location1)))) (not (hold_2))) (when (or (and (holds agent1 book_1) (not (and (= ?a agent1) (= ?o book_1)))) (and (= ?o pot_3) (= ?l location1)) (objectatlocation pot_3 location1)) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
