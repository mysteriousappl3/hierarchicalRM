(define (problem alfred-problem)
 ...
 (:constraints (always (not (holds agent1 pot_2))) (sometime (checked fridge_5)) (sometime (holdsany agent1)) (sometime-after (holdsany agent1) (or (holds agent1 book_1) (objectatlocation pot_3 location1))))
