(define (domain liftedtcore_alfred-domain)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (and (holdsany agent1) (not (or (inreceptacleobject cup_3 plate_1) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))))) (not (hold_1))) (when (or (inreceptacleobject cup_3 plate_1) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (not (and (objectatlocation cup_2 location2) (not (and (= ?o cup_2) (= ?l location2))))) (not (or (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2))))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (= ?a agent1) (holdsany agent1)) (hold_0)) (when (and (or (= ?a agent1) (holdsany agent1)) (not (or (inreceptacleobject cup_3 plate_1) (atlocation agent1 location3)))) (not (hold_1))) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (not (or (and (= ?o cup_2) (= ?l location2)) (objectatlocation cup_2 location2))) (not (and (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2))))))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_0)) (when (and (holdsany agent1) (not (= ?a agent1)) (not (or (inreceptacleobject cup_3 plate_1) (atlocation agent1 location3)))) (not (hold_1))) (increase (total-cost) 1)))
 (:action cleanobject
