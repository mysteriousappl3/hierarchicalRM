(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7)) (hold_2)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o newspaper_2) (checked newspaper_2)) (hold_1)) (increase (total-cost) 1)))
 (:action gotolocation
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7)) (hold_2)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5)) (hold_0)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5)))) (hold_0)) (increase (total-cost) 1)))
 (:action cleanobject
