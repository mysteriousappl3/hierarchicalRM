(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4) (holds agent1 spraybottle_1)) (hold_1)) (when (or (holds agent1 winebottle_4) (= ?r countertop_1) (checked countertop_1)) (hold_2)) (increase (total-cost) 1)))
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4) (holds agent1 spraybottle_1)) (hold_1)) (when (or (holds agent1 winebottle_4) (= ?r countertop_1) (checked countertop_1)) (hold_2)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o tissuebox_2)) (holds agent1 tissuebox_2) (and (objectatlocation pen_3 location5) (not (and (= ?o pen_3) (= ?l location5))))) (hold_0)) (when (or (checked laundryhamper_4) (and (= ?a agent1) (= ?o spraybottle_1)) (holds agent1 spraybottle_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?o winebottle_4)) (holds agent1 winebottle_4) (checked countertop_1)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 tissuebox_2) (not (and (= ?a agent1) (= ?o tissuebox_2)))) (and (= ?o pen_3) (= ?l location5)) (objectatlocation pen_3 location5)) (hold_0)) (when (or (checked laundryhamper_4) (and (holds agent1 spraybottle_1) (not (and (= ?a agent1) (= ?o spraybottle_1))))) (hold_1)) (when (or (and (holds agent1 winebottle_4) (not (and (= ?a agent1) (= ?o winebottle_4)))) (checked countertop_1)) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
