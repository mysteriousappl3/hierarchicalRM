(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (and (or (= ?l location3) (checked location3)) (holds agent1 apple_1)) (hold_1)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o cup_3) (checked cup_3)) (hold_0)) (increase (total-cost) 1)))
 (:action gotolocation
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (and (checked location3) (or (and (= ?a agent1) (= ?o apple_1)) (holds agent1 apple_1))) (hold_1)) (when (or (inreceptacleobject pan_2 apple_1) (and (objectatlocation apple_1 location2) (not (and (= ?o apple_1) (= ?l location2))))) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (checked location3) (holds agent1 apple_1) (not (and (= ?a agent1) (= ?o apple_1)))) (hold_1)) (when (or (inreceptacleobject pan_2 apple_1) (and (= ?o apple_1) (= ?l location2)) (objectatlocation apple_1 location2)) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
