(define (problem alfred-problem)
 ...
 (:constraints (sometime (checked cup_3)) (sometime (and (checked location3) (holds agent1 apple_1))) (sometime (or (inreceptacleobject pan_2 apple_1) (objectatlocation apple_1 location2))))
