(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   mug_5 toiletpaperroll_4 butterknife_3 - obj
 ...
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (holds agent1 butterknife_3) (= ?a agent1) (checked agent1)) (hold_2)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o mug_5) (checked mug_5) (atlocation agent1 location2)) (hold_0)) (when (or (= ?o toiletpaperroll_4) (checked toiletpaperroll_4) (atlocation agent1 location1)) (hold_1)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (checked mug_5) (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_0)) (when (or (checked toiletpaperroll_4) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o butterknife_3)) (holds agent1 butterknife_3) (checked agent1)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 butterknife_3) (not (and (= ?a agent1) (= ?o butterknife_3)))) (checked agent1)) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
