(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 watchtype) (receptacletype_0 ?r_0 drawertype))))))
 (:constraints (sometime (checked drawer_2)) (sometime (or (atlocation agent1 location2) (checked location4))) (sometime (checked bathtubbasin_3)))
