(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   drawer_2 bathtubbasin_3 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (atlocation agent1 location2) (= ?l location4) (checked location4)) (hold_1)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r drawer_2) (checked drawer_2)) (hold_0)) (when (or (= ?r bathtubbasin_3) (checked bathtubbasin_3)) (hold_2)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2)))) (checked location4)) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r drawer_2) (checked drawer_2)) (hold_0)) (when (or (= ?r bathtubbasin_3) (checked bathtubbasin_3)) (hold_2)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
