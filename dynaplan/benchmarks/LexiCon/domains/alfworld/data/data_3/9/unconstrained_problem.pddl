(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r) (objecttype_0 ?o1 wateringcantype) (receptacletype_0 ?r cabinettype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 boxtype) (receptacletype_0 ?r cabinettype) (inreceptacle ?o2 ?r))))))))
