(define (problem alfred-problem)
 ...
 (:objects
   ...
   soapbar_1 wateringcan_2 box_3 - obj
 )
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 boxtype) (receptacletype_0 ?r_0 cabinettype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (atlocation agent1 location3)) (sometime (holds agent1 soapbar_1)) (sometime (checked wateringcan_2)))
