(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location1) (checked location1) (checked plate_5)) (hold_3)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (holds agent1 egg_1) (= ?a agent1) (checked agent1)) (hold_2)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (checked location1) (= ?o plate_5) (checked plate_5)) (hold_3)) (increase (total-cost) 1)))
 (:action gotolocation
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5)) (hold_0)) (when (or (and (= ?a agent1) (= ?o egg_1)) (holds agent1 egg_1)) (seen_psi_1)) (when (or (and (= ?a agent1) (= ?o egg_1)) (holds agent1 egg_1) (checked agent1)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
