(define (problem alfred-problem)
 ...
 (:objects
   ...
   egg_1 cup_2 cellphone_3 potato_4 plate_5 - obj
 )
 ...
 (:constraints (sometime (holds agent1 plate_5)) (sometime-before (holds agent1 plate_5) (holds agent1 egg_1)) (sometime (or (holds agent1 egg_1) (checked agent1))) (sometime (or (checked location1) (checked plate_5))))
