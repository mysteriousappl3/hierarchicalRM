(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 mugtype) (receptacletype_0 ?r_0 sinkbasintype))))))
 (:constraints (sometime (or (holdsany agent1) (holds agent1 mug_2))) (sometime (or (holdsany agent1) (checked knife_1))) (sometime (holds agent1 knife_1)))
