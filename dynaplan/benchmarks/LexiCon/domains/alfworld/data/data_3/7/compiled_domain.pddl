(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (holdsany agent1) (= ?o knife_1) (checked knife_1)) (hold_1)) (increase (total-cost) 1)))
 (:action gotolocation
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (= ?a agent1) (holdsany agent1) (and (= ?a agent1) (= ?o mug_2)) (holds agent1 mug_2)) (hold_0)) (when (or (= ?a agent1) (holdsany agent1) (checked knife_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?o knife_1)) (holds agent1 knife_1)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holdsany agent1) (not (= ?a agent1))) (and (holds agent1 mug_2) (not (and (= ?a agent1) (= ?o mug_2))))) (hold_0)) (when (or (and (holdsany agent1) (not (= ?a agent1))) (checked knife_1)) (hold_1)) (when (and (holds agent1 knife_1) (not (and (= ?a agent1) (= ?o knife_1)))) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
