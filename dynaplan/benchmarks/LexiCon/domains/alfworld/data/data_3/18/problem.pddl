(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r_0) (objecttype_0 ?o1 potatotype) (receptacletype_0 ?r_0 fridgetype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 bowltype) (receptacletype_0 ?r_0 fridgetype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (atlocation agent1 location2)) (sometime-after (atlocation agent1 location2) (or (atlocation agent1 location4) (objectatlocation soapbar_2 location3))) (sometime (atlocation agent1 location4)) (sometime-after (atlocation agent1 location4) (or (checked microwave_6) (holds agent1 soapbar_2))) (sometime (or (objectatlocation soapbar_2 location1) (atlocation agent1 location1))))
