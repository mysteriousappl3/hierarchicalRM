(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   location3 location4 location1 location2 - location
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (and (atlocation agent1 location4) (not (or (= ?r microwave_6) (checked microwave_6) (holds agent1 soapbar_2)))) (not (hold_3))) (when (or (= ?r microwave_6) (checked microwave_6) (holds agent1 soapbar_2)) (hold_3)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_0)) (when (and (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (not (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (objectatlocation soapbar_2 location3)))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (objectatlocation soapbar_2 location3)) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_2)) (when (and (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (not (or (checked microwave_6) (holds agent1 soapbar_2)))) (not (hold_3))) (when (or (objectatlocation soapbar_2 location1) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (and (atlocation agent1 location4) (not (or (= ?r microwave_6) (checked microwave_6) (holds agent1 soapbar_2)))) (not (hold_3))) (when (or (= ?r microwave_6) (checked microwave_6) (holds agent1 soapbar_2)) (hold_3)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (and (atlocation agent1 location2) (not (or (atlocation agent1 location4) (and (objectatlocation soapbar_2 location3) (not (and (= ?o soapbar_2) (= ?l location3))))))) (not (hold_1))) (when (or (atlocation agent1 location4) (and (objectatlocation soapbar_2 location3) (not (and (= ?o soapbar_2) (= ?l location3))))) (hold_1)) (when (and (atlocation agent1 location4) (not (or (checked microwave_6) (and (= ?a agent1) (= ?o soapbar_2)) (holds agent1 soapbar_2)))) (not (hold_3))) (when (or (checked microwave_6) (and (= ?a agent1) (= ?o soapbar_2)) (holds agent1 soapbar_2)) (hold_3)) (when (or (and (objectatlocation soapbar_2 location1) (not (and (= ?o soapbar_2) (= ?l location1)))) (atlocation agent1 location1)) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (atlocation agent1 location2) (not (or (atlocation agent1 location4) (and (= ?o soapbar_2) (= ?l location3)) (objectatlocation soapbar_2 location3)))) (not (hold_1))) (when (or (atlocation agent1 location4) (and (= ?o soapbar_2) (= ?l location3)) (objectatlocation soapbar_2 location3)) (hold_1)) (when (and (atlocation agent1 location4) (not (or (checked microwave_6) (and (holds agent1 soapbar_2) (not (and (= ?a agent1) (= ?o soapbar_2))))))) (not (hold_3))) (when (or (checked microwave_6) (and (holds agent1 soapbar_2) (not (and (= ?a agent1) (= ?o soapbar_2))))) (hold_3)) (when (or (and (= ?o soapbar_2) (= ?l location1)) (objectatlocation soapbar_2 location1) (atlocation agent1 location1)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
