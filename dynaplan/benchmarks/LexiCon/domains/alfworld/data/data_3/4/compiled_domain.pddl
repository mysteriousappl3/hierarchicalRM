(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location2) (checked location2)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_5) (checked fridge_5) (holds agent1 toiletpaperroll_2)) (hold_2)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (holds agent1 pan_3) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_5) (checked fridge_5) (holds agent1 toiletpaperroll_2)) (hold_2)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o pan_3)) (holds agent1 pan_3) (atlocation agent1 location3)) (hold_1)) (when (or (checked fridge_5) (and (= ?a agent1) (= ?o toiletpaperroll_2)) (holds agent1 toiletpaperroll_2)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 pan_3) (not (and (= ?a agent1) (= ?o pan_3)))) (atlocation agent1 location3)) (hold_1)) (when (or (checked fridge_5) (and (holds agent1 toiletpaperroll_2) (not (and (= ?a agent1) (= ?o toiletpaperroll_2))))) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
