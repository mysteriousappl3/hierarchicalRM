(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   keychain_3 spraybottle_4 tennisracket_2 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location5) (checked location5) (atlocation agent1 location4)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (checked location5) (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_0)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o keychain_3)) (holds agent1 keychain_3) (and (objectatlocation tennisracket_2 location5) (not (and (= ?o tennisracket_2) (= ?l location5))))) (hold_1)) (when (and (objectatlocation spraybottle_4 location3) (not (and (= ?o spraybottle_4) (= ?l location3)))) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 keychain_3) (not (and (= ?a agent1) (= ?o keychain_3)))) (and (= ?o tennisracket_2) (= ?l location5)) (objectatlocation tennisracket_2 location5)) (hold_1)) (when (or (and (= ?o spraybottle_4) (= ?l location3)) (objectatlocation spraybottle_4 location3)) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
