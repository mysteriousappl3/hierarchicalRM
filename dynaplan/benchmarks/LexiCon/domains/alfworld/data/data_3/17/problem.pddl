(define (problem alfred-problem)
 ...
 (:objects
   ...
   cloth_1 tennisracket_2 keychain_3 spraybottle_4 pot_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 spraybottletype) (receptacletype_0 ?r_0 drawertype))))))
 (:constraints (sometime (or (checked location5) (atlocation agent1 location4))) (sometime (or (holds agent1 keychain_3) (objectatlocation tennisracket_2 location5))) (sometime (objectatlocation spraybottle_4 location3)))
