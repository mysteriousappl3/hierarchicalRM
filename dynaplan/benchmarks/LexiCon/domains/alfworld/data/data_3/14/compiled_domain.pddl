(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (objectatlocation peppershaker_1 location5) (= ?o tomato_2) (checked tomato_2)) (hold_0)) (increase (total-cost) 1)))
 (:action gotolocation
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o box_5)) (holds agent1 box_5))) (seen_psi_3)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation peppershaker_1 location5) (not (and (= ?o peppershaker_1) (= ?l location5)))) (checked tomato_2)) (hold_0)) (when (or (and (objectatlocation tomato_2 location1) (not (and (= ?o tomato_2) (= ?l location1)))) (checked location2)) (hold_1)) (when (or (and (= ?a agent1) (= ?o box_5)) (holds agent1 box_5)) (hold_2)) (when (or (and (= ?a agent1) (= ?o peppershaker_1)) (holds agent1 peppershaker_1)) (seen_psi_3)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 box_5) (not (and (= ?a agent1) (= ?o box_5))))) (seen_psi_3)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o peppershaker_1) (= ?l location5)) (objectatlocation peppershaker_1 location5) (checked tomato_2)) (hold_0)) (when (or (and (= ?o tomato_2) (= ?l location1)) (objectatlocation tomato_2 location1) (checked location2)) (hold_1)) (when (and (holds agent1 box_5) (not (and (= ?a agent1) (= ?o box_5)))) (hold_2)) (when (and (holds agent1 peppershaker_1) (not (and (= ?a agent1) (= ?o peppershaker_1)))) (seen_psi_3)) (increase (total-cost) 1)))
 (:action cleanobject
