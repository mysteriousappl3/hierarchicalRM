(define (problem alfred-problem)
 ...
 (:objects
   ...
   peppershaker_1 tomato_2 fork_3 cellphone_4 box_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 boxtype) (receptacletype_0 ?r_0 cabinettype))))))
 (:constraints (sometime (or (objectatlocation peppershaker_1 location5) (checked tomato_2))) (sometime (or (objectatlocation tomato_2 location1) (checked location2))) (sometime (holds agent1 box_5)) (sometime-before (holds agent1 box_5) (holds agent1 peppershaker_1)))
