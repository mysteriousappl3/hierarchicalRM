(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (checked candle_1) (= ?r fridge_7) (checked fridge_7)) (hold_4)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o vase_2) (checked vase_2) (objectatlocation candle_1 location4)) (seen_psi_1)) (when (or (objectatlocation vase_2 location5) (= ?o candle_1) (checked candle_1)) (seen_psi_3)) (when (or (= ?o candle_1) (checked candle_1) (checked fridge_7)) (hold_4)) (increase (total-cost) 1)))
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_2)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (checked candle_1) (= ?r fridge_7) (checked fridge_7)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5)) (hold_0)) (when (or (checked vase_2) (and (objectatlocation candle_1 location4) (not (and (= ?o candle_1) (= ?l location4))))) (seen_psi_1)) (when (or (and (objectatlocation vase_2 location5) (not (and (= ?o vase_2) (= ?l location5)))) (checked candle_1)) (seen_psi_3)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (hold_0)) (when (or (checked vase_2) (and (= ?o candle_1) (= ?l location4)) (objectatlocation candle_1 location4)) (seen_psi_1)) (when (or (and (= ?o vase_2) (= ?l location5)) (objectatlocation vase_2 location5) (checked candle_1)) (seen_psi_3)) (increase (total-cost) 1)))
 (:action cleanobject
