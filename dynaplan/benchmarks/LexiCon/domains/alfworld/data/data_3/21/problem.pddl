(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 statuetype) (receptacletype_0 ?r_0 safetype))))))
 (:constraints (sometime (or (checked location4) (holds agent1 pan_5))) (sometime (holds agent1 statue_1)) (sometime (or (holds agent1 toiletpaper_4) (holds agent1 box_2))))
