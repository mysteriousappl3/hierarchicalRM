(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   location4 - location
   agent1 - agent
   pan_5 statue_1 toiletpaper_4 box_2 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location4) (checked location4) (holds agent1 pan_5)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (checked location4) (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5)) (hold_0)) (when (or (and (= ?a agent1) (= ?o statue_1)) (holds agent1 statue_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?o toiletpaper_4)) (holds agent1 toiletpaper_4) (and (= ?a agent1) (= ?o box_2)) (holds agent1 box_2)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (checked location4) (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5))))) (hold_0)) (when (and (holds agent1 statue_1) (not (and (= ?a agent1) (= ?o statue_1)))) (hold_1)) (when (or (and (holds agent1 toiletpaper_4) (not (and (= ?a agent1) (= ?o toiletpaper_4)))) (and (holds agent1 box_2) (not (and (= ?a agent1) (= ?o box_2))))) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
