(define (problem alfred-problem)
 ...
 (:objects
   ...
   bathtubbasin_1 drawer_2 coffeetable_3 microwave_4 fridge_5 - receptacle
   bread_1 tennisracket_2 box_3 - obj
 )
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 tennisrackettype) (receptacletype_0 ?r_0 coffeetabletype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (objectatlocation box_3 location3) (holdsany agent1))) (sometime (checked coffeetable_3)) (sometime (holds agent1 box_3)))
