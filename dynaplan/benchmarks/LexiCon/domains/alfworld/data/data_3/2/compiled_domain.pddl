(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r coffeetable_3) (checked coffeetable_3)) (hold_1)) (increase (total-cost) 1)))
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r coffeetable_3) (checked coffeetable_3)) (hold_1)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation box_3 location3) (not (and (= ?o box_3) (= ?l location3)))) (= ?a agent1) (holdsany agent1)) (hold_0)) (when (or (and (= ?a agent1) (= ?o box_3)) (holds agent1 box_3)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o box_3) (= ?l location3)) (objectatlocation box_3 location3) (and (holdsany agent1) (not (= ?a agent1)))) (hold_0)) (when (and (holds agent1 box_3) (not (and (= ?a agent1) (= ?o box_3)))) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
