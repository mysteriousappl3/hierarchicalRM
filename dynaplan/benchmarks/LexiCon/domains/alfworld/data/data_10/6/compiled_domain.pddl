(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (atlocation agent1 location2) (= ?l location1) (checked location1)) (hold_9)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_0)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o bowl_2) (checked bowl_2)) (hold_2)) (when (or (= ?o bowl_2) (checked bowl_2) (holdsany agent1)) (hold_3)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2)))) (checked location1)) (hold_9)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_0)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (and (or (and (= ?a agent1) (= ?o bread_1)) (holds agent1 bread_1)) (or (= ?a agent1) (holdsany agent1))) (hold_1)) (when (or (checked bowl_2) (= ?a agent1) (holdsany agent1)) (hold_3)) (when (or (= ?a agent1) (holdsany agent1)) (hold_6)) (when (and (or (= ?a agent1) (holdsany agent1)) (objectatlocation bread_1 location2) (not (and (= ?o bread_1) (= ?l location2)))) (hold_5)) (when (or (= ?a agent1) (holdsany agent1)) (hold_6)) (when (or (and (= ?a agent1) (= ?o bread_1)) (holds agent1 bread_1) (inreceptacleobject bread_1 bowl_2)) (hold_7)) (when (or (and (= ?a agent1) (= ?o bread_1)) (holds agent1 bread_1)) (hold_8)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 bread_1) (not (and (= ?a agent1) (= ?o bread_1))) (holdsany agent1) (not (= ?a agent1))) (hold_1)) (when (or (checked bowl_2) (and (holdsany agent1) (not (= ?a agent1)))) (hold_3)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_6)) (when (and (holdsany agent1) (not (= ?a agent1)) (or (and (= ?o bread_1) (= ?l location2)) (objectatlocation bread_1 location2))) (hold_5)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_6)) (when (or (and (holds agent1 bread_1) (not (and (= ?a agent1) (= ?o bread_1)))) (inreceptacleobject bread_1 bowl_2)) (hold_7)) (when (and (holds agent1 bread_1) (not (and (= ?a agent1) (= ?o bread_1)))) (hold_8)) (increase (total-cost) 1)))
 (:action cleanobject
