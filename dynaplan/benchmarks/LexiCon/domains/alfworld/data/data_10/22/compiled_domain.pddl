(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   microwave_6 sofa_3 fridge_7 - receptacle
   pan_4 plate_1 apple_3 bowl_5 winebottle_2 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (atlocation agent1 location5) (= ?l location4) (checked location4)) (hold_7)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r sofa_3) (checked sofa_3)) (hold_1)) (when (or (= ?r fridge_7) (checked fridge_7) (checked pan_4)) (hold_3)) (when (or (objectatlocation bowl_5 location1) (= ?r microwave_6) (checked microwave_6)) (hold_4)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o plate_1) (checked plate_1)) (hold_2)) (when (or (checked fridge_7) (= ?o pan_4) (checked pan_4)) (hold_3)) (when (or (= ?o winebottle_2) (checked winebottle_2)) (hold_5)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_6)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (checked location4)) (hold_7)) (when (or (holds agent1 pan_4) (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_9)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r sofa_3) (checked sofa_3)) (hold_1)) (when (or (= ?r fridge_7) (checked fridge_7) (checked pan_4)) (hold_3)) (when (or (objectatlocation bowl_5 location1) (= ?r microwave_6) (checked microwave_6)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation bowl_5 location1) (not (and (= ?o bowl_5) (= ?l location1)))) (checked microwave_6)) (hold_4)) (when (or (and (objectatlocation apple_3 location1) (not (and (= ?o apple_3) (= ?l location1)))) (and (= ?a agent1) (= ?o pan_4)) (holds agent1 pan_4)) (hold_8)) (when (or (and (= ?a agent1) (= ?o pan_4)) (holds agent1 pan_4) (atlocation agent1 location5)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o bowl_5) (= ?l location1)) (objectatlocation bowl_5 location1) (checked microwave_6)) (hold_4)) (when (or (and (= ?o apple_3) (= ?l location1)) (objectatlocation apple_3 location1) (and (holds agent1 pan_4) (not (and (= ?a agent1) (= ?o pan_4))))) (hold_8)) (when (or (and (holds agent1 pan_4) (not (and (= ?a agent1) (= ?o pan_4)))) (atlocation agent1 location5)) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
