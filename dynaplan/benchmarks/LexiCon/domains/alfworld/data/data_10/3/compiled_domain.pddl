(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   garbagecan_1 fridge_4 - receptacle
   egg_1 cup_2 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location2) (checked location2) (holdsany agent1)) (hold_5)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_4) (checked fridge_4) (holdsany agent1)) (hold_2)) (when (and (or (= ?r garbagecan_1) (checked garbagecan_1)) (holds agent1 cup_2)) (hold_3)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (holds agent1 egg_1) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_7)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_8)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_4) (checked fridge_4) (holdsany agent1)) (hold_2)) (when (and (or (= ?r garbagecan_1) (checked garbagecan_1)) (holds agent1 cup_2)) (hold_3)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o egg_1)) (holds agent1 egg_1)) (hold_9)) (when (or (checked fridge_4) (= ?a agent1) (holdsany agent1)) (hold_2)) (when (and (checked garbagecan_1) (or (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2))) (hold_3)) (when (or (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2)) (hold_4)) (when (or (checked location2) (= ?a agent1) (holdsany agent1)) (hold_5)) (when (or (= ?a agent1) (holdsany agent1)) (hold_6)) (when (or (and (= ?a agent1) (= ?o egg_1)) (holds agent1 egg_1) (atlocation agent1 location1)) (hold_7)) (when (or (and (= ?a agent1) (= ?o egg_1)) (holds agent1 egg_1)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 egg_1) (not (and (= ?a agent1) (= ?o egg_1)))) (hold_9)) (when (or (checked fridge_4) (and (holdsany agent1) (not (= ?a agent1)))) (hold_2)) (when (and (checked garbagecan_1) (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2)))) (hold_3)) (when (and (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2)))) (hold_4)) (when (or (checked location2) (and (holdsany agent1) (not (= ?a agent1)))) (hold_5)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_6)) (when (or (and (holds agent1 egg_1) (not (and (= ?a agent1) (= ?o egg_1)))) (atlocation agent1 location1)) (hold_7)) (when (and (holds agent1 egg_1) (not (and (= ?a agent1) (= ?o egg_1)))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
