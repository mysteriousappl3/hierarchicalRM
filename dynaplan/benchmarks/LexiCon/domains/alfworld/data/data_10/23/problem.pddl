(define (problem alfred-problem)
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 appletype) (receptacletype_0 ?r_0 coffeetabletype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (holds agent1 mug_2)) (sometime (or (atlocation agent1 location3) (objectatlocation fork_3 location1))) (sometime (or (holds agent1 fork_3) (checked fridge_7))) (sometime (checked location3)) (sometime (checked fork_3)) (sometime (or (objectatlocation fork_3 location3) (checked towelholder_5))) (sometime (atlocation agent1 location2)) (sometime (or (holds agent1 fork_3) (holds agent1 plate_1))) (sometime (or (objectatlocation plate_1 location3) (atlocation agent1 location5))) (sometime (checked location4)))
