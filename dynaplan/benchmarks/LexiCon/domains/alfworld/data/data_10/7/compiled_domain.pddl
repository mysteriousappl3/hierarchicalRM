(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   plate_2 pan_1 - obj
   towelholder_2 towelholder_1 microwave_3 - receptacle
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (and (holds agent1 pan_1) (or (= ?r microwave_3) (checked microwave_3))) (hold_2)) (when (or (objectatlocation pan_1 location2) (= ?r towelholder_2) (checked towelholder_2)) (hold_4)) (when (or (holds agent1 plate_2) (= ?r towelholder_1) (checked towelholder_1)) (hold_7)) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_9)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o pan_1) (checked pan_1)) (hold_0)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (and (holds agent1 plate_2) (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))))) (hold_5)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (= ?a agent1) (holdsany agent1) (inreceptacleobject plate_2 pan_1)) (hold_1)) (when (and (or (and (= ?a agent1) (= ?o pan_1)) (holds agent1 pan_1)) (checked microwave_3)) (hold_2)) (when (or (and (objectatlocation pan_1 location2) (not (and (= ?o pan_1) (= ?l location2)))) (checked towelholder_2)) (hold_4)) (when (and (or (and (= ?a agent1) (= ?o plate_2)) (holds agent1 plate_2)) (atlocation agent1 location1)) (hold_5)) (when (or (and (= ?a agent1) (= ?o plate_2)) (holds agent1 plate_2) (checked towelholder_1)) (hold_7)) (when (or (= ?a agent1) (holdsany agent1)) (hold_8)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holdsany agent1) (not (= ?a agent1))) (inreceptacleobject plate_2 pan_1)) (hold_1)) (when (and (holds agent1 pan_1) (not (and (= ?a agent1) (= ?o pan_1))) (checked microwave_3)) (hold_2)) (when (or (and (= ?o pan_1) (= ?l location2)) (objectatlocation pan_1 location2) (checked towelholder_2)) (hold_4)) (when (and (holds agent1 plate_2) (not (and (= ?a agent1) (= ?o plate_2))) (atlocation agent1 location1)) (hold_5)) (when (or (and (holds agent1 plate_2) (not (and (= ?a agent1) (= ?o plate_2)))) (checked towelholder_1)) (hold_7)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_8)) (increase (total-cost) 1)))
 (:action cleanobject
