(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 mugtype) (receptacletype_0 ?r_0 microwavetype))))))
 (:constraints (sometime (holds agent1 mug_1)) (sometime-before (holds agent1 mug_1) (atlocation agent1 location4)) (sometime (or (atlocation agent1 location2) (objectatlocation kettle_3 location2))) (sometime (holds agent1 kettle_3)) (sometime (holds agent1 kettle_3)) (sometime (or (objectatlocation mug_1 location1) (objectatlocation plate_5 location5))) (sometime (checked location5)) (sometime (or (objectatlocation kettle_3 location4) (atlocation agent1 location5))) (sometime (or (checked location1) (atlocation agent1 location5))) (sometime (objectatlocation soapbottle_4 location2)) (sometime (or (objectatlocation soapbottle_4 location2) (checked mug_1))))
