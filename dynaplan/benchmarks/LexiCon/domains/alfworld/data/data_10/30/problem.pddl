(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 cuptype) (receptacletype_0 ?r_0 dressertype))))))
 (:constraints (sometime (checked location2)) (sometime (holds agent1 cup_5)) (sometime-before (holds agent1 cup_5) (or (atlocation agent1 location2) (holds agent1 bread_1))) (sometime (atlocation agent1 location3)) (sometime (atlocation agent1 location5)) (sometime-before (atlocation agent1 location5) (or (checked location3) (checked agent1))) (sometime (checked fridge_7)) (sometime (checked shelf_3)) (sometime (or (checked fridge_7) (checked location2))) (sometime (checked bread_2)) (sometime (or (checked agent1) (holds agent1 bread_2))) (sometime (or (holds agent1 bread_1) (objectatlocation glassbottle_3 location1))))
