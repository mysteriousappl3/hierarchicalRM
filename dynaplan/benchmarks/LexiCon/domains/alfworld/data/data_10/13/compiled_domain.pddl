(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   bowl_2 vase_1 dishsponge_3 book_4 - obj
   location3 location4 location5 location1 - location
   agent1 - agent
   microwave_5 handtowelholder_4 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (objectatlocation book_4 location3) (= ?l location1) (checked location1)) (hold_4)) (when (or (= ?l location3) (checked location3) (atlocation agent1 location3)) (hold_7)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r handtowelholder_4) (checked handtowelholder_4)) (hold_0)) (when (or (holds agent1 vase_1) (= ?r microwave_5) (checked microwave_5)) (hold_3)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (atlocation agent1 location5) (= ?o dishsponge_3) (checked dishsponge_3)) (hold_1)) (when (or (objectatlocation dishsponge_3 location5) (= ?o vase_1) (checked vase_1)) (hold_2)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (checked dishsponge_3)) (hold_1)) (when (or (checked location3) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_7)) (when (or (holds agent1 vase_1) (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_8)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r handtowelholder_4) (checked handtowelholder_4)) (hold_0)) (when (or (holds agent1 vase_1) (= ?r microwave_5) (checked microwave_5)) (hold_3)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation dishsponge_3 location5) (not (and (= ?o dishsponge_3) (= ?l location5)))) (checked vase_1)) (hold_2)) (when (or (and (= ?a agent1) (= ?o vase_1)) (holds agent1 vase_1) (checked microwave_5)) (hold_3)) (when (or (and (objectatlocation book_4 location3) (not (and (= ?o book_4) (= ?l location3)))) (checked location1)) (hold_4)) (when (or (and (= ?a agent1) (= ?o dishsponge_3)) (holds agent1 dishsponge_3)) (hold_5)) (when (or (and (= ?a agent1) (= ?o vase_1)) (holds agent1 vase_1)) (hold_6)) (when (or (and (= ?a agent1) (= ?o vase_1)) (holds agent1 vase_1) (atlocation agent1 location4)) (hold_8)) (when (or (and (= ?a agent1) (= ?o bowl_2)) (holds agent1 bowl_2)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o dishsponge_3) (= ?l location5)) (objectatlocation dishsponge_3 location5) (checked vase_1)) (hold_2)) (when (or (and (holds agent1 vase_1) (not (and (= ?a agent1) (= ?o vase_1)))) (checked microwave_5)) (hold_3)) (when (or (and (= ?o book_4) (= ?l location3)) (objectatlocation book_4 location3) (checked location1)) (hold_4)) (when (and (holds agent1 dishsponge_3) (not (and (= ?a agent1) (= ?o dishsponge_3)))) (hold_5)) (when (and (holds agent1 vase_1) (not (and (= ?a agent1) (= ?o vase_1)))) (hold_6)) (when (or (and (holds agent1 vase_1) (not (and (= ?a agent1) (= ?o vase_1)))) (atlocation agent1 location4)) (hold_8)) (when (and (holds agent1 bowl_2) (not (and (= ?a agent1) (= ?o bowl_2)))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
