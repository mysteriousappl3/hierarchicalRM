(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 dishspongetype) (receptacletype_0 ?r_0 bathtubbasintype))))))
 (:constraints (sometime (checked handtowelholder_4)) (sometime (or (atlocation agent1 location5) (checked dishsponge_3))) (sometime (or (objectatlocation dishsponge_3 location5) (checked vase_1))) (sometime (or (holds agent1 vase_1) (checked microwave_5))) (sometime (or (objectatlocation book_4 location3) (checked location1))) (sometime (holds agent1 dishsponge_3)) (sometime (holds agent1 vase_1)) (sometime (or (checked location3) (atlocation agent1 location3))) (sometime (or (holds agent1 vase_1) (atlocation agent1 location4))) (sometime (holds agent1 bowl_2)))
