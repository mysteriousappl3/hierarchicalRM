(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   kettle_1 cup_2 - obj
   handtowelholder_2 microwave_3 - receptacle
 ...
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (holds agent1 kettle_1) (= ?a agent1) (checked agent1)) (hold_8)) (increase (total-cost) 1)))
 (:action examinereceptacle
  :parameters ( ?a - agent ?r - receptacle)
  :precondition (and (exists (?l_0 - location)
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (and (or (= ?r microwave_3) (checked microwave_3)) (holdsany agent1)) (hold_6)) (when (and (holdsany agent1) (or (= ?r handtowelholder_2) (checked handtowelholder_2))) (hold_7)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (and (holds agent1 kettle_1) (or (= ?o kettle_1) (checked kettle_1))) (hold_3)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (and (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (holds agent1 cup_2)) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (and (or (= ?r microwave_3) (checked microwave_3)) (holdsany agent1)) (hold_6)) (when (and (holdsany agent1) (or (= ?r handtowelholder_2) (checked handtowelholder_2))) (hold_7)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (= ?a agent1) (holdsany agent1)) (hold_0)) (when (and (atlocation agent1 location1) (or (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2))) (hold_1)) (when (or (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2)) (hold_2)) (when (and (or (and (= ?a agent1) (= ?o kettle_1)) (holds agent1 kettle_1)) (checked kettle_1)) (hold_3)) (when (or (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2) (= ?a agent1) (holdsany agent1)) (hold_4)) (when (and (objectatlocation cup_2 location2) (not (and (= ?o cup_2) (= ?l location2)))) (hold_5)) (when (and (checked microwave_3) (or (= ?a agent1) (holdsany agent1))) (hold_6)) (when (and (or (= ?a agent1) (holdsany agent1)) (checked handtowelholder_2)) (hold_7)) (when (or (and (= ?a agent1) (= ?o kettle_1)) (holds agent1 kettle_1) (checked agent1)) (hold_8)) (when (or (and (= ?a agent1) (= ?o kettle_1)) (holds agent1 kettle_1)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_0)) (when (and (atlocation agent1 location1) (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2)))) (hold_1)) (when (and (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2)))) (hold_2)) (when (and (holds agent1 kettle_1) (not (and (= ?a agent1) (= ?o kettle_1))) (checked kettle_1)) (hold_3)) (when (or (and (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2)))) (and (holdsany agent1) (not (= ?a agent1)))) (hold_4)) (when (or (and (= ?o cup_2) (= ?l location2)) (objectatlocation cup_2 location2)) (hold_5)) (when (and (checked microwave_3) (holdsany agent1) (not (= ?a agent1))) (hold_6)) (when (and (holdsany agent1) (not (= ?a agent1)) (checked handtowelholder_2)) (hold_7)) (when (or (and (holds agent1 kettle_1) (not (and (= ?a agent1) (= ?o kettle_1)))) (checked agent1)) (hold_8)) (when (and (holds agent1 kettle_1) (not (and (= ?a agent1) (= ?o kettle_1)))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
