(define (problem alfred-problem)
 ...
 (:constraints (sometime (holds agent1 mug_2)) (sometime (checked mug_2)) (sometime (atlocation agent1 location2)) (sometime (holdsany agent1)) (sometime (and (holdsany agent1) (checked location1))) (sometime (checked fridge_1)) (sometime (or (objectatlocation pot_1 location1) (holdsany agent1))) (sometime (or (atlocation agent1 location2) (holds agent1 mug_2))) (sometime (and (checked microwave_3) (holds agent1 pot_1))) (sometime (holds agent1 pot_1)))
