(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   fridge_1 microwave_3 - receptacle
   pot_1 mug_2 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (and (holdsany agent1) (or (= ?l location1) (checked location1))) (hold_4)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_1) (checked fridge_1)) (hold_5)) (when (and (or (= ?r microwave_3) (checked microwave_3)) (holds agent1 pot_1)) (hold_8)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o mug_2) (checked mug_2)) (hold_1)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_2)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2)))) (holds agent1 mug_2)) (hold_7)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_1) (checked fridge_1)) (hold_5)) (when (and (or (= ?r microwave_3) (checked microwave_3)) (holds agent1 pot_1)) (hold_8)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_2)) (holds agent1 mug_2)) (hold_0)) (when (or (= ?a agent1) (holdsany agent1)) (hold_3)) (when (and (or (= ?a agent1) (holdsany agent1)) (checked location1)) (hold_4)) (when (or (and (objectatlocation pot_1 location1) (not (and (= ?o pot_1) (= ?l location1)))) (= ?a agent1) (holdsany agent1)) (hold_6)) (when (or (atlocation agent1 location2) (and (= ?a agent1) (= ?o mug_2)) (holds agent1 mug_2)) (hold_7)) (when (and (checked microwave_3) (or (and (= ?a agent1) (= ?o pot_1)) (holds agent1 pot_1))) (hold_8)) (when (or (and (= ?a agent1) (= ?o pot_1)) (holds agent1 pot_1)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 mug_2) (not (and (= ?a agent1) (= ?o mug_2)))) (hold_0)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_3)) (when (and (holdsany agent1) (not (= ?a agent1)) (checked location1)) (hold_4)) (when (or (and (= ?o pot_1) (= ?l location1)) (objectatlocation pot_1 location1) (and (holdsany agent1) (not (= ?a agent1)))) (hold_6)) (when (or (atlocation agent1 location2) (and (holds agent1 mug_2) (not (and (= ?a agent1) (= ?o mug_2))))) (hold_7)) (when (and (checked microwave_3) (holds agent1 pot_1) (not (and (= ?a agent1) (= ?o pot_1)))) (hold_8)) (when (and (holds agent1 pot_1) (not (and (= ?a agent1) (= ?o pot_1)))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
