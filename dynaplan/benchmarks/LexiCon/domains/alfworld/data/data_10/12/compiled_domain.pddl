(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   bowl_2 plate_5 toiletpaper_3 handtowel_4 toiletpaperroll_1 - obj
   handtowelholder_5 - receptacle
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location2) (checked location2) (checked toiletpaper_3)) (hold_4)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r handtowelholder_5) (checked handtowelholder_5)) (hold_5)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (objectatlocation bowl_2 location5) (= ?o toiletpaper_3) (checked toiletpaper_3)) (hold_1)) (when (or (checked location2) (= ?o toiletpaper_3) (checked toiletpaper_3)) (hold_4)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (objectatlocation toiletpaperroll_1 location1)) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_8)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r handtowelholder_5) (checked handtowelholder_5)) (hold_5)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (atlocation agent1 location4) (and (objectatlocation toiletpaperroll_1 location1) (not (and (= ?o toiletpaperroll_1) (= ?l location1))))) (hold_0)) (when (or (and (objectatlocation bowl_2 location5) (not (and (= ?o bowl_2) (= ?l location5)))) (checked toiletpaper_3)) (hold_1)) (when (or (and (= ?a agent1) (= ?o toiletpaperroll_1)) (holds agent1 toiletpaperroll_1)) (hold_6)) (when (or (and (= ?a agent1) (= ?o bowl_2)) (holds agent1 bowl_2) (and (= ?a agent1) (= ?o handtowel_4)) (holds agent1 handtowel_4)) (hold_3)) (when (or (and (= ?a agent1) (= ?o toiletpaperroll_1)) (holds agent1 toiletpaperroll_1)) (hold_6)) (when (or (and (= ?a agent1) (= ?o toiletpaper_3)) (holds agent1 toiletpaper_3) (and (objectatlocation plate_5 location4) (not (and (= ?o plate_5) (= ?l location4))))) (hold_7)) (when (or (and (objectatlocation handtowel_4 location2) (not (and (= ?o handtowel_4) (= ?l location2)))) (and (= ?a agent1) (= ?o toiletpaper_3)) (holds agent1 toiletpaper_3)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (atlocation agent1 location4) (and (= ?o toiletpaperroll_1) (= ?l location1)) (objectatlocation toiletpaperroll_1 location1)) (hold_0)) (when (or (and (= ?o bowl_2) (= ?l location5)) (objectatlocation bowl_2 location5) (checked toiletpaper_3)) (hold_1)) (when (and (holds agent1 toiletpaperroll_1) (not (and (= ?a agent1) (= ?o toiletpaperroll_1)))) (hold_6)) (when (or (and (holds agent1 bowl_2) (not (and (= ?a agent1) (= ?o bowl_2)))) (and (holds agent1 handtowel_4) (not (and (= ?a agent1) (= ?o handtowel_4))))) (hold_3)) (when (and (holds agent1 toiletpaperroll_1) (not (and (= ?a agent1) (= ?o toiletpaperroll_1)))) (hold_6)) (when (or (and (holds agent1 toiletpaper_3) (not (and (= ?a agent1) (= ?o toiletpaper_3)))) (and (= ?o plate_5) (= ?l location4)) (objectatlocation plate_5 location4)) (hold_7)) (when (or (and (= ?o handtowel_4) (= ?l location2)) (objectatlocation handtowel_4 location2) (and (holds agent1 toiletpaper_3) (not (and (= ?a agent1) (= ?o toiletpaper_3))))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
