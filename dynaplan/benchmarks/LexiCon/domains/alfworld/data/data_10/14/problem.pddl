(define (problem alfred-problem)
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 remotecontroltype) (receptacletype_0 ?r_0 desktype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (checked location1)) (sometime (checked toiletpaper_2)) (sometime (checked handtowelholder_5)) (sometime (or (holds agent1 remotecontrol_1) (objectatlocation handtowel_4 location4))) (sometime (or (checked location5) (atlocation agent1 location5))) (sometime (or (checked handtowelholder_3) (holds agent1 remotecontrol_1))) (sometime (or (checked fridge_7) (objectatlocation toiletpaper_2 location4))) (sometime (holds agent1 cup_5)) (sometime (or (holds agent1 handtowel_4) (checked desk_1))) (sometime (or (checked toiletpaper_2) (holds agent1 toiletpaper_2))))
