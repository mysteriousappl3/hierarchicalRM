(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   handtowelholder_5 handtowelholder_3 desk_1 fridge_7 - receptacle
   cup_5 remotecontrol_1 toiletpaper_2 handtowel_4 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location1) (checked location1)) (hold_0)) (when (or (= ?l location5) (checked location5) (atlocation agent1 location5)) (hold_4)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r handtowelholder_5) (checked handtowelholder_5)) (hold_2)) (when (or (= ?r handtowelholder_3) (checked handtowelholder_3) (holds agent1 remotecontrol_1)) (hold_5)) (when (or (= ?r fridge_7) (checked fridge_7) (objectatlocation toiletpaper_2 location4)) (hold_6)) (when (or (holds agent1 handtowel_4) (= ?r desk_1) (checked desk_1)) (hold_8)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o toiletpaper_2) (checked toiletpaper_2)) (hold_1)) (when (or (= ?o toiletpaper_2) (checked toiletpaper_2) (holds agent1 toiletpaper_2)) (hold_9)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (checked location5) (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r handtowelholder_5) (checked handtowelholder_5)) (hold_2)) (when (or (= ?r handtowelholder_3) (checked handtowelholder_3) (holds agent1 remotecontrol_1)) (hold_5)) (when (or (= ?r fridge_7) (checked fridge_7) (objectatlocation toiletpaper_2 location4)) (hold_6)) (when (or (holds agent1 handtowel_4) (= ?r desk_1) (checked desk_1)) (hold_8)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o remotecontrol_1)) (holds agent1 remotecontrol_1) (and (objectatlocation handtowel_4 location4) (not (and (= ?o handtowel_4) (= ?l location4))))) (hold_3)) (when (or (checked handtowelholder_3) (and (= ?a agent1) (= ?o remotecontrol_1)) (holds agent1 remotecontrol_1)) (hold_5)) (when (or (checked fridge_7) (and (objectatlocation toiletpaper_2 location4) (not (and (= ?o toiletpaper_2) (= ?l location4))))) (hold_6)) (when (or (and (= ?a agent1) (= ?o cup_5)) (holds agent1 cup_5)) (hold_7)) (when (or (and (= ?a agent1) (= ?o handtowel_4)) (holds agent1 handtowel_4) (checked desk_1)) (hold_8)) (when (or (checked toiletpaper_2) (and (= ?a agent1) (= ?o toiletpaper_2)) (holds agent1 toiletpaper_2)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 remotecontrol_1) (not (and (= ?a agent1) (= ?o remotecontrol_1)))) (and (= ?o handtowel_4) (= ?l location4)) (objectatlocation handtowel_4 location4)) (hold_3)) (when (or (checked handtowelholder_3) (and (holds agent1 remotecontrol_1) (not (and (= ?a agent1) (= ?o remotecontrol_1))))) (hold_5)) (when (or (checked fridge_7) (and (= ?o toiletpaper_2) (= ?l location4)) (objectatlocation toiletpaper_2 location4)) (hold_6)) (when (and (holds agent1 cup_5) (not (and (= ?a agent1) (= ?o cup_5)))) (hold_7)) (when (or (and (holds agent1 handtowel_4) (not (and (= ?a agent1) (= ?o handtowel_4)))) (checked desk_1)) (hold_8)) (when (or (checked toiletpaper_2) (and (holds agent1 toiletpaper_2) (not (and (= ?a agent1) (= ?o toiletpaper_2))))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
