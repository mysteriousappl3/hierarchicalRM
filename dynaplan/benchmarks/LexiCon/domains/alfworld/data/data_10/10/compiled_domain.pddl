(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   alarmclock_1 pan_5 winebottle_3 - obj
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location3) (checked location3) (objectatlocation pan_5 location3)) (hold_1)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (atlocation agent1 location3) (= ?r stoveburner_3) (checked stoveburner_3)) (hold_9)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_3)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (holds agent1 pan_5)) (hold_4)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (objectatlocation pan_5 location1)) (hold_5)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_6)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_8)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (checked stoveburner_3)) (hold_9)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (atlocation agent1 location3) (= ?r stoveburner_3) (checked stoveburner_3)) (hold_9)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o winebottle_3)) (holds agent1 winebottle_3)) (hold_0)) (when (or (checked location3) (and (objectatlocation pan_5 location3) (not (and (= ?o pan_5) (= ?l location3))))) (hold_1)) (when (or (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5)) (hold_2)) (when (or (atlocation agent1 location3) (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5)) (hold_4)) (when (or (atlocation agent1 location5) (and (objectatlocation pan_5 location1) (not (and (= ?o pan_5) (= ?l location1))))) (hold_5)) (when (or (and (= ?a agent1) (= ?o alarmclock_1)) (holds agent1 alarmclock_1) (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5)) (hold_7)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 winebottle_3) (not (and (= ?a agent1) (= ?o winebottle_3)))) (hold_0)) (when (or (checked location3) (and (= ?o pan_5) (= ?l location3)) (objectatlocation pan_5 location3)) (hold_1)) (when (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5)))) (hold_2)) (when (or (atlocation agent1 location3) (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5))))) (hold_4)) (when (or (atlocation agent1 location5) (and (= ?o pan_5) (= ?l location1)) (objectatlocation pan_5 location1)) (hold_5)) (when (or (and (holds agent1 alarmclock_1) (not (and (= ?a agent1) (= ?o alarmclock_1)))) (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5))))) (hold_7)) (increase (total-cost) 1)))
 (:action cleanobject
