(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 platetype) (receptacletype_0 ?r_0 dressertype))))))
 (:constraints (sometime (or (checked fridge_4) (inreceptacleobject plate_2 plate_2))) (sometime (and (checked plate_2) (holdsany agent1))) (sometime (objectatlocation plate_2 location2)) (sometime (checked location1)) (sometime (and (holds agent1 plate_2) (atlocation agent1 location2))) (sometime (or (holdsany agent1) (objectatlocation egg_1 location1))) (sometime (and (checked microwave_3) (holdsany agent1))) (sometime (atlocation agent1 location2)) (sometime (or (holds agent1 egg_1) (holdsany agent1))) (sometime (holds agent1 plate_2)))
