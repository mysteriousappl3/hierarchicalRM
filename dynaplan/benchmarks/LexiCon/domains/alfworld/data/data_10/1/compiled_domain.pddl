(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   fridge_4 microwave_3 - receptacle
   plate_2 egg_1 - obj
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location1) (checked location1)) (hold_3)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_4) (checked fridge_4) (inreceptacleobject plate_2 plate_2)) (hold_0)) (when (and (or (= ?r microwave_3) (checked microwave_3)) (holdsany agent1)) (hold_6)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (and (or (= ?o plate_2) (checked plate_2)) (holdsany agent1)) (hold_1)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (and (holds agent1 plate_2) (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2)))))) (hold_4)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_7)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_4) (checked fridge_4) (inreceptacleobject plate_2 plate_2)) (hold_0)) (when (and (or (= ?r microwave_3) (checked microwave_3)) (holdsany agent1)) (hold_6)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (and (checked plate_2) (or (= ?a agent1) (holdsany agent1))) (hold_1)) (when (and (objectatlocation plate_2 location2) (not (and (= ?o plate_2) (= ?l location2)))) (hold_2)) (when (and (or (and (= ?a agent1) (= ?o plate_2)) (holds agent1 plate_2)) (atlocation agent1 location2)) (hold_4)) (when (or (= ?a agent1) (holdsany agent1) (and (objectatlocation egg_1 location1) (not (and (= ?o egg_1) (= ?l location1))))) (hold_5)) (when (and (checked microwave_3) (or (= ?a agent1) (holdsany agent1))) (hold_6)) (when (or (and (= ?a agent1) (= ?o egg_1)) (holds agent1 egg_1) (= ?a agent1) (holdsany agent1)) (hold_8)) (when (or (and (= ?a agent1) (= ?o plate_2)) (holds agent1 plate_2)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (checked plate_2) (holdsany agent1) (not (= ?a agent1))) (hold_1)) (when (or (and (= ?o plate_2) (= ?l location2)) (objectatlocation plate_2 location2)) (hold_2)) (when (and (holds agent1 plate_2) (not (and (= ?a agent1) (= ?o plate_2))) (atlocation agent1 location2)) (hold_4)) (when (or (and (holdsany agent1) (not (= ?a agent1))) (and (= ?o egg_1) (= ?l location1)) (objectatlocation egg_1 location1)) (hold_5)) (when (and (checked microwave_3) (holdsany agent1) (not (= ?a agent1))) (hold_6)) (when (or (and (holds agent1 egg_1) (not (and (= ?a agent1) (= ?o egg_1)))) (and (holdsany agent1) (not (= ?a agent1)))) (hold_8)) (when (and (holds agent1 plate_2) (not (and (= ?a agent1) (= ?o plate_2)))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
