(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 wateringcantype) (receptacletype_0 ?r_0 coffeetabletype))))))
 (:constraints (sometime (or (objectatlocation wateringcan_1 location1) (atlocation agent1 location4))) (sometime (or (holds agent1 cup_5) (holds agent1 pencil_2))) (sometime (or (holds agent1 cup_4) (checked location5))) (sometime (or (holds agent1 pencil_2) (objectatlocation wateringcan_1 location4))) (sometime (or (checked handtowelholder_1) (atlocation agent1 location3))) (sometime (atlocation agent1 location4)) (sometime (checked tvstand_4)) (sometime (or (checked coffeetable_3) (atlocation agent1 location3))) (sometime (or (atlocation agent1 location3) (holds agent1 wateringcan_1))) (sometime (or (atlocation agent1 location4) (holds agent1 cup_5))))
