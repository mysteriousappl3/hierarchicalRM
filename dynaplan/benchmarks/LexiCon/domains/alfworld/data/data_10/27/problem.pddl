(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r_0) (objecttype_0 ?o1 clothtype) (receptacletype_0 ?r_0 ottomantype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 booktype) (receptacletype_0 ?r_0 ottomantype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (holds agent1 knife_4) (atlocation agent1 location4))) (sometime (checked location2)) (sometime (atlocation agent1 location1)) (sometime (atlocation agent1 location3)) (sometime (atlocation agent1 location2)) (sometime (checked basketball_2)) (sometime (or (holds agent1 mug_5) (holds agent1 basketball_2))) (sometime (or (holds agent1 knife_4) (checked sinkbasin_2))) (sometime (or (holds agent1 cloth_3) (holds agent1 mug_5))) (sometime (checked bathtubbasin_1)))
