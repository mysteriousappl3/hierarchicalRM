(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   cloth_3 mug_5 knife_4 basketball_2 - obj
   bathtubbasin_1 sinkbasin_2 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location2) (checked location2)) (hold_1)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (holds agent1 knife_4) (= ?r sinkbasin_2) (checked sinkbasin_2)) (hold_7)) (when (or (= ?r bathtubbasin_1) (checked bathtubbasin_1)) (hold_9)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o basketball_2) (checked basketball_2)) (hold_5)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (holds agent1 knife_4) (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_2)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_3)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (holds agent1 knife_4) (= ?r sinkbasin_2) (checked sinkbasin_2)) (hold_7)) (when (or (= ?r bathtubbasin_1) (checked bathtubbasin_1)) (hold_9)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o knife_4)) (holds agent1 knife_4) (atlocation agent1 location4)) (hold_0)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5) (and (= ?a agent1) (= ?o basketball_2)) (holds agent1 basketball_2)) (hold_6)) (when (or (and (= ?a agent1) (= ?o knife_4)) (holds agent1 knife_4) (checked sinkbasin_2)) (hold_7)) (when (or (and (= ?a agent1) (= ?o cloth_3)) (holds agent1 cloth_3) (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5)) (hold_8)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 knife_4) (not (and (= ?a agent1) (= ?o knife_4)))) (atlocation agent1 location4)) (hold_0)) (when (or (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (and (holds agent1 basketball_2) (not (and (= ?a agent1) (= ?o basketball_2))))) (hold_6)) (when (or (and (holds agent1 knife_4) (not (and (= ?a agent1) (= ?o knife_4)))) (checked sinkbasin_2)) (hold_7)) (when (or (and (holds agent1 cloth_3) (not (and (= ?a agent1) (= ?o cloth_3)))) (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5))))) (hold_8)) (increase (total-cost) 1)))
 (:action cleanobject
