(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   papertowel_3 soapbottle_1 egg_2 tissuebox_4 bowl_5 - obj
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location4) (checked location4)) (hold_0)) (when (or (objectatlocation tissuebox_4 location4) (= ?l location3) (checked location3)) (hold_3)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (objectatlocation soapbottle_1 location5)) (hold_4)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o egg_2)) (holds agent1 egg_2)) (hold_1)) (when (or (and (objectatlocation tissuebox_4 location4) (not (and (= ?o tissuebox_4) (= ?l location4)))) (and (objectatlocation egg_2 location3) (not (and (= ?o egg_2) (= ?l location3))))) (hold_2)) (when (or (and (objectatlocation tissuebox_4 location4) (not (and (= ?o tissuebox_4) (= ?l location4)))) (checked location3)) (hold_3)) (when (or (atlocation agent1 location4) (and (objectatlocation soapbottle_1 location5) (not (and (= ?o soapbottle_1) (= ?l location5))))) (hold_4)) (when (or (and (= ?a agent1) (= ?o papertowel_3)) (holds agent1 papertowel_3)) (hold_5)) (when (or (and (objectatlocation tissuebox_4 location1) (not (and (= ?o tissuebox_4) (= ?l location1)))) (and (= ?a agent1) (= ?o tissuebox_4)) (holds agent1 tissuebox_4)) (hold_7)) (when (or (and (objectatlocation bowl_5 location5) (not (and (= ?o bowl_5) (= ?l location5)))) (and (= ?a agent1) (= ?o tissuebox_4)) (holds agent1 tissuebox_4)) (hold_8)) (when (or (and (= ?a agent1) (= ?o tissuebox_4)) (holds agent1 tissuebox_4) (and (= ?a agent1) (= ?o papertowel_3)) (holds agent1 papertowel_3)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 egg_2) (not (and (= ?a agent1) (= ?o egg_2)))) (hold_1)) (when (or (and (= ?o tissuebox_4) (= ?l location4)) (objectatlocation tissuebox_4 location4) (and (= ?o egg_2) (= ?l location3)) (objectatlocation egg_2 location3)) (hold_2)) (when (or (and (= ?o tissuebox_4) (= ?l location4)) (objectatlocation tissuebox_4 location4) (checked location3)) (hold_3)) (when (or (atlocation agent1 location4) (and (= ?o soapbottle_1) (= ?l location5)) (objectatlocation soapbottle_1 location5)) (hold_4)) (when (and (holds agent1 papertowel_3) (not (and (= ?a agent1) (= ?o papertowel_3)))) (hold_5)) (when (or (and (= ?o tissuebox_4) (= ?l location1)) (objectatlocation tissuebox_4 location1) (and (holds agent1 tissuebox_4) (not (and (= ?a agent1) (= ?o tissuebox_4))))) (hold_7)) (when (or (and (= ?o bowl_5) (= ?l location5)) (objectatlocation bowl_5 location5) (and (holds agent1 tissuebox_4) (not (and (= ?a agent1) (= ?o tissuebox_4))))) (hold_8)) (when (or (and (holds agent1 tissuebox_4) (not (and (= ?a agent1) (= ?o tissuebox_4)))) (and (holds agent1 papertowel_3) (not (and (= ?a agent1) (= ?o papertowel_3))))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
