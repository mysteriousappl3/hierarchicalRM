(define (problem alfred-problem)
 ...
 (:objects
   ...
   soapbottle_1 egg_2 papertowel_3 tissuebox_4 bowl_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 tissueboxtype) (receptacletype_0 ?r_0 toilettype))))))
 (:constraints (sometime (checked location4)) (sometime (holds agent1 egg_2)) (sometime (or (objectatlocation tissuebox_4 location4) (objectatlocation egg_2 location3))) (sometime (or (objectatlocation tissuebox_4 location4) (checked location3))) (sometime (or (atlocation agent1 location4) (objectatlocation soapbottle_1 location5))) (sometime (holds agent1 papertowel_3)) (sometime (atlocation agent1 location4)) (sometime (or (objectatlocation tissuebox_4 location1) (holds agent1 tissuebox_4))) (sometime (or (objectatlocation bowl_5 location5) (holds agent1 tissuebox_4))) (sometime (or (holds agent1 tissuebox_4) (holds agent1 papertowel_3))))
