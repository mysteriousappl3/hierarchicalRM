(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   location3 location5 location4 location2 location1 - location
   agent1 - agent
   potato_4 pot_3 potato_2 handtowel_1 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location3) (checked location3) (atlocation agent1 location1)) (hold_4)) (when (or (= ?l location5) (checked location5)) (hold_8)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (= ?a agent1) (checked agent1) (objectatlocation pot_3 location2)) (hold_7)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (objectatlocation handtowel_1 location1)) (hold_1)) (when (or (checked location3) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_4)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (holds agent1 handtowel_1)) (hold_5)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (objectatlocation potato_4 location3)) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o handtowel_1)) (holds agent1 handtowel_1) (and (objectatlocation handtowel_1 location5) (not (and (= ?o handtowel_1) (= ?l location5))))) (hold_0)) (when (or (atlocation agent1 location4) (and (objectatlocation handtowel_1 location1) (not (and (= ?o handtowel_1) (= ?l location1))))) (hold_1)) (when (or (and (objectatlocation pot_3 location2) (not (and (= ?o pot_3) (= ?l location2)))) (and (= ?a agent1) (= ?o potato_2)) (holds agent1 potato_2)) (hold_2)) (when (or (and (= ?a agent1) (= ?o potato_4)) (holds agent1 potato_4) (and (objectatlocation handtowel_1 location1) (not (and (= ?o handtowel_1) (= ?l location1))))) (hold_3)) (when (or (atlocation agent1 location5) (and (= ?a agent1) (= ?o handtowel_1)) (holds agent1 handtowel_1)) (hold_5)) (when (or (atlocation agent1 location3) (and (objectatlocation potato_4 location3) (not (and (= ?o potato_4) (= ?l location3))))) (hold_6)) (when (or (checked agent1) (and (objectatlocation pot_3 location2) (not (and (= ?o pot_3) (= ?l location2))))) (hold_7)) (when (or (and (objectatlocation potato_2 location3) (not (and (= ?o potato_2) (= ?l location3)))) (and (objectatlocation handtowel_1 location1) (not (and (= ?o handtowel_1) (= ?l location1))))) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 handtowel_1) (not (and (= ?a agent1) (= ?o handtowel_1)))) (and (= ?o handtowel_1) (= ?l location5)) (objectatlocation handtowel_1 location5)) (hold_0)) (when (or (atlocation agent1 location4) (and (= ?o handtowel_1) (= ?l location1)) (objectatlocation handtowel_1 location1)) (hold_1)) (when (or (and (= ?o pot_3) (= ?l location2)) (objectatlocation pot_3 location2) (and (holds agent1 potato_2) (not (and (= ?a agent1) (= ?o potato_2))))) (hold_2)) (when (or (and (holds agent1 potato_4) (not (and (= ?a agent1) (= ?o potato_4)))) (and (= ?o handtowel_1) (= ?l location1)) (objectatlocation handtowel_1 location1)) (hold_3)) (when (or (atlocation agent1 location5) (and (holds agent1 handtowel_1) (not (and (= ?a agent1) (= ?o handtowel_1))))) (hold_5)) (when (or (atlocation agent1 location3) (and (= ?o potato_4) (= ?l location3)) (objectatlocation potato_4 location3)) (hold_6)) (when (or (checked agent1) (and (= ?o pot_3) (= ?l location2)) (objectatlocation pot_3 location2)) (hold_7)) (when (or (and (= ?o potato_2) (= ?l location3)) (objectatlocation potato_2 location3) (and (= ?o handtowel_1) (= ?l location1)) (objectatlocation handtowel_1 location1)) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
