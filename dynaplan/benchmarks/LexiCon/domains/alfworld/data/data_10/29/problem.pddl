(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r_0) (objecttype_0 ?o1 creditcardtype) (receptacletype_0 ?r_0 diningtabletype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 forktype) (receptacletype_0 ?r_0 diningtabletype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (objectatlocation fork_3 location3) (checked location1))) (sometime (or (checked microwave_6) (holds agent1 creditcard_2))) (sometime (holds agent1 apple_1)) (sometime (holds agent1 creditcard_2)) (sometime (or (holds agent1 egg_4) (checked diningtable_5))) (sometime (atlocation agent1 location5)) (sometime (checked microwave_6)) (sometime (objectatlocation cup_5 location4)) (sometime (or (checked coffeemachine_2) (objectatlocation egg_4 location3))) (sometime (or (objectatlocation creditcard_2 location3) (checked egg_4))))
