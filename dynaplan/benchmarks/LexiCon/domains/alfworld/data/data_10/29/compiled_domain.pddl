(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   cup_5 egg_4 apple_1 creditcard_2 fork_3 - obj
   location3 location5 location4 location1 - location
   microwave_6 coffeemachine_2 diningtable_5 - receptacle
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (objectatlocation fork_3 location3) (= ?l location1) (checked location1)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r microwave_6) (checked microwave_6) (holds agent1 creditcard_2)) (hold_1)) (when (or (holds agent1 egg_4) (= ?r diningtable_5) (checked diningtable_5)) (hold_4)) (when (or (= ?r microwave_6) (checked microwave_6)) (hold_6)) (when (or (= ?r coffeemachine_2) (checked coffeemachine_2) (objectatlocation egg_4 location3)) (hold_8)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (objectatlocation creditcard_2 location3) (= ?o egg_4) (checked egg_4)) (hold_9)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_5)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r microwave_6) (checked microwave_6) (holds agent1 creditcard_2)) (hold_1)) (when (or (holds agent1 egg_4) (= ?r diningtable_5) (checked diningtable_5)) (hold_4)) (when (or (= ?r microwave_6) (checked microwave_6)) (hold_6)) (when (or (= ?r coffeemachine_2) (checked coffeemachine_2) (objectatlocation egg_4 location3)) (hold_8)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation fork_3 location3) (not (and (= ?o fork_3) (= ?l location3)))) (checked location1)) (hold_0)) (when (or (checked microwave_6) (and (= ?a agent1) (= ?o creditcard_2)) (holds agent1 creditcard_2)) (hold_1)) (when (or (and (= ?a agent1) (= ?o apple_1)) (holds agent1 apple_1)) (hold_2)) (when (or (and (= ?a agent1) (= ?o creditcard_2)) (holds agent1 creditcard_2)) (hold_3)) (when (or (and (= ?a agent1) (= ?o egg_4)) (holds agent1 egg_4) (checked diningtable_5)) (hold_4)) (when (and (objectatlocation cup_5 location4) (not (and (= ?o cup_5) (= ?l location4)))) (hold_7)) (when (or (checked coffeemachine_2) (and (objectatlocation egg_4 location3) (not (and (= ?o egg_4) (= ?l location3))))) (hold_8)) (when (or (and (objectatlocation creditcard_2 location3) (not (and (= ?o creditcard_2) (= ?l location3)))) (checked egg_4)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o fork_3) (= ?l location3)) (objectatlocation fork_3 location3) (checked location1)) (hold_0)) (when (or (checked microwave_6) (and (holds agent1 creditcard_2) (not (and (= ?a agent1) (= ?o creditcard_2))))) (hold_1)) (when (and (holds agent1 apple_1) (not (and (= ?a agent1) (= ?o apple_1)))) (hold_2)) (when (and (holds agent1 creditcard_2) (not (and (= ?a agent1) (= ?o creditcard_2)))) (hold_3)) (when (or (and (holds agent1 egg_4) (not (and (= ?a agent1) (= ?o egg_4)))) (checked diningtable_5)) (hold_4)) (when (or (and (= ?o cup_5) (= ?l location4)) (objectatlocation cup_5 location4)) (hold_7)) (when (or (checked coffeemachine_2) (and (= ?o egg_4) (= ?l location3)) (objectatlocation egg_4 location3)) (hold_8)) (when (or (and (= ?o creditcard_2) (= ?l location3)) (objectatlocation creditcard_2 location3) (checked egg_4)) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
