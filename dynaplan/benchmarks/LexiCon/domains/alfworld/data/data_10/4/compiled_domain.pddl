(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   mug_2 apple_1 - obj
   drawer_2 fridge_4 microwave_3 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location2) (checked location2)) (hold_4)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (atlocation agent1 location2) (= ?a agent1) (checked agent1)) (hold_6)) (increase (total-cost) 1)))
 (:action examinereceptacle
  :parameters ( ?a - agent ?r - receptacle)
  :precondition (and (exists (?l_0 - location)
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (holds agent1 apple_1) (= ?r drawer_2) (checked drawer_2)) (hold_1)) (when (or (= ?r fridge_4) (checked fridge_4)) (hold_2)) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_5)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2)))) (checked agent1)) (hold_6)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2)))) (inreceptacleobject apple_1 mug_2)) (hold_8)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_9)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (holds agent1 apple_1) (= ?r drawer_2) (checked drawer_2)) (hold_1)) (when (or (= ?r fridge_4) (checked fridge_4)) (hold_2)) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_5)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (and (or (= ?a agent1) (holdsany agent1)) (or (and (= ?a agent1) (= ?o apple_1)) (holds agent1 apple_1))) (hold_0)) (when (or (and (= ?a agent1) (= ?o apple_1)) (holds agent1 apple_1) (checked drawer_2)) (hold_1)) (when (or (= ?a agent1) (holdsany agent1)) (hold_3)) (when (or (and (= ?a agent1) (= ?o apple_1)) (holds agent1 apple_1)) (hold_7)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holdsany agent1) (not (= ?a agent1)) (holds agent1 apple_1) (not (and (= ?a agent1) (= ?o apple_1)))) (hold_0)) (when (or (and (holds agent1 apple_1) (not (and (= ?a agent1) (= ?o apple_1)))) (checked drawer_2)) (hold_1)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_3)) (when (and (holds agent1 apple_1) (not (and (= ?a agent1) (= ?o apple_1)))) (hold_7)) (increase (total-cost) 1)))
 (:action cleanobject
