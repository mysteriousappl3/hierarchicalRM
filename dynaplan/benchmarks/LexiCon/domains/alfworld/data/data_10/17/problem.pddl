(define (problem alfred-problem)
 ...
 (:constraints (sometime (or (holds agent1 pot_5) (checked remotecontrol_4))) (sometime (holds agent1 lettuce_1)) (sometime (objectatlocation bowl_3 location4)) (sometime (or (holds agent1 bowl_3) (holds agent1 remotecontrol_4))) (sometime (objectatlocation lettuce_1 location3)) (sometime (or (checked location3) (checked agent1))) (sometime (or (checked bowl_3) (atlocation agent1 location3))) (sometime (or (objectatlocation bowl_3 location1) (holds agent1 pot_5))) (sometime (atlocation agent1 location2)) (sometime (holds agent1 remotecontrol_2)))
