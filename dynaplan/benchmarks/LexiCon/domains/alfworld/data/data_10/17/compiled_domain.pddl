(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   lettuce_1 remotecontrol_2 remotecontrol_4 pot_5 bowl_3 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location3) (checked location3) (checked agent1)) (hold_5)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (checked location3) (= ?a agent1) (checked agent1)) (hold_5)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (holds agent1 pot_5) (= ?o remotecontrol_4) (checked remotecontrol_4)) (hold_0)) (when (or (= ?o bowl_3) (checked bowl_3) (atlocation agent1 location3)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (checked bowl_3) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_6)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_8)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o pot_5)) (holds agent1 pot_5) (checked remotecontrol_4)) (hold_0)) (when (or (and (= ?a agent1) (= ?o lettuce_1)) (holds agent1 lettuce_1)) (hold_1)) (when (and (objectatlocation bowl_3 location4) (not (and (= ?o bowl_3) (= ?l location4)))) (hold_2)) (when (or (and (= ?a agent1) (= ?o bowl_3)) (holds agent1 bowl_3) (and (= ?a agent1) (= ?o remotecontrol_4)) (holds agent1 remotecontrol_4)) (hold_3)) (when (and (objectatlocation lettuce_1 location3) (not (and (= ?o lettuce_1) (= ?l location3)))) (hold_4)) (when (or (and (objectatlocation bowl_3 location1) (not (and (= ?o bowl_3) (= ?l location1)))) (and (= ?a agent1) (= ?o pot_5)) (holds agent1 pot_5)) (hold_7)) (when (or (and (= ?a agent1) (= ?o remotecontrol_2)) (holds agent1 remotecontrol_2)) (hold_9)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 pot_5) (not (and (= ?a agent1) (= ?o pot_5)))) (checked remotecontrol_4)) (hold_0)) (when (and (holds agent1 lettuce_1) (not (and (= ?a agent1) (= ?o lettuce_1)))) (hold_1)) (when (or (and (= ?o bowl_3) (= ?l location4)) (objectatlocation bowl_3 location4)) (hold_2)) (when (or (and (holds agent1 bowl_3) (not (and (= ?a agent1) (= ?o bowl_3)))) (and (holds agent1 remotecontrol_4) (not (and (= ?a agent1) (= ?o remotecontrol_4))))) (hold_3)) (when (or (and (= ?o lettuce_1) (= ?l location3)) (objectatlocation lettuce_1 location3)) (hold_4)) (when (or (and (= ?o bowl_3) (= ?l location1)) (objectatlocation bowl_3 location1) (and (holds agent1 pot_5) (not (and (= ?a agent1) (= ?o pot_5))))) (hold_7)) (when (and (holds agent1 remotecontrol_2) (not (and (= ?a agent1) (= ?o remotecontrol_2)))) (hold_9)) (increase (total-cost) 1)))
 (:action cleanobject
