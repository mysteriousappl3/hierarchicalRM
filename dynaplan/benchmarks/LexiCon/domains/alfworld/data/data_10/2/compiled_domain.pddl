(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (and (checked microwave_3) (or (= ?l location1) (checked location1))) (hold_2)) (when (or (= ?l location1) (checked location1)) (hold_7)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r microwave_3) (checked microwave_3) (inreceptacleobject plate_1 cup_2)) (hold_0)) (when (and (or (= ?r microwave_3) (checked microwave_3)) (checked location1)) (hold_2)) (when (and (atlocation agent1 location2) (or (= ?r fridge_4) (checked fridge_4))) (hold_6)) (when (or (= ?r fridge_4) (checked fridge_4)) (hold_9)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o plate_1) (checked plate_1)) (hold_5)) (when (or (= ?o plate_1) (checked plate_1) (holds agent1 cup_2)) (hold_8)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_3)) (when (or (holdsany agent1) (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_4)) (when (and (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (checked fridge_4)) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r microwave_3) (checked microwave_3) (inreceptacleobject plate_1 cup_2)) (hold_0)) (when (and (or (= ?r microwave_3) (checked microwave_3)) (checked location1)) (hold_2)) (when (and (atlocation agent1 location2) (or (= ?r fridge_4) (checked fridge_4))) (hold_6)) (when (or (= ?r fridge_4) (checked fridge_4)) (hold_9)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (= ?a agent1) (holdsany agent1)) (hold_1)) (when (or (= ?a agent1) (holdsany agent1) (atlocation agent1 location2)) (hold_4)) (when (or (checked plate_1) (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2)) (hold_8)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holdsany agent1) (not (= ?a agent1))) (hold_1)) (when (or (and (holdsany agent1) (not (= ?a agent1))) (atlocation agent1 location2)) (hold_4)) (when (or (checked plate_1) (and (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2))))) (hold_8)) (increase (total-cost) 1)))
 (:action cleanobject
