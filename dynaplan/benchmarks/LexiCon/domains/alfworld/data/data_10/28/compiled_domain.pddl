(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   plate_5 butterknife_2 winebottle_1 tennisracket_3 box_4 - obj
   handtowelholder_3 laundryhamper_4 towelholder_2 fridge_7 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (atlocation agent1 location5) (= ?l location4) (checked location4)) (hold_1)) (when (or (= ?l location3) (checked location3) (holds agent1 tennisracket_3)) (hold_5)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4)) (hold_0)) (when (or (= ?r fridge_7) (checked fridge_7) (objectatlocation butterknife_2 location2)) (hold_2)) (when (or (= ?r handtowelholder_3) (checked handtowelholder_3) (holds agent1 winebottle_1)) (hold_4)) (when (or (= ?r towelholder_2) (checked towelholder_2)) (hold_9)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (atlocation agent1 location1) (= ?o tennisracket_3) (checked tennisracket_3)) (hold_8)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (checked location4)) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))) (checked tennisracket_3)) (hold_8)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4)) (hold_0)) (when (or (= ?r fridge_7) (checked fridge_7) (objectatlocation butterknife_2 location2)) (hold_2)) (when (or (= ?r handtowelholder_3) (checked handtowelholder_3) (holds agent1 winebottle_1)) (hold_4)) (when (or (= ?r towelholder_2) (checked towelholder_2)) (hold_9)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (checked fridge_7) (and (objectatlocation butterknife_2 location2) (not (and (= ?o butterknife_2) (= ?l location2))))) (hold_2)) (when (or (and (= ?a agent1) (= ?o butterknife_2)) (holds agent1 butterknife_2)) (hold_3)) (when (or (checked handtowelholder_3) (and (= ?a agent1) (= ?o winebottle_1)) (holds agent1 winebottle_1)) (hold_4)) (when (or (checked location3) (and (= ?a agent1) (= ?o tennisracket_3)) (holds agent1 tennisracket_3)) (hold_5)) (when (and (objectatlocation plate_5 location1) (not (and (= ?o plate_5) (= ?l location1)))) (hold_6)) (when (and (objectatlocation box_4 location3) (not (and (= ?o box_4) (= ?l location3)))) (hold_7)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (checked fridge_7) (and (= ?o butterknife_2) (= ?l location2)) (objectatlocation butterknife_2 location2)) (hold_2)) (when (and (holds agent1 butterknife_2) (not (and (= ?a agent1) (= ?o butterknife_2)))) (hold_3)) (when (or (checked handtowelholder_3) (and (holds agent1 winebottle_1) (not (and (= ?a agent1) (= ?o winebottle_1))))) (hold_4)) (when (or (checked location3) (and (holds agent1 tennisracket_3) (not (and (= ?a agent1) (= ?o tennisracket_3))))) (hold_5)) (when (or (and (= ?o plate_5) (= ?l location1)) (objectatlocation plate_5 location1)) (hold_6)) (when (or (and (= ?o box_4) (= ?l location3)) (objectatlocation box_4 location3)) (hold_7)) (increase (total-cost) 1)))
 (:action cleanobject
