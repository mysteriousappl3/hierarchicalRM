(define (problem alfred-problem)
 ...
 (:objects
   ...
   winebottle_1 butterknife_2 tennisracket_3 box_4 plate_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 butterknifetype) (receptacletype_0 ?r_0 countertoptype))))))
 (:constraints (sometime (checked laundryhamper_4)) (sometime (or (atlocation agent1 location5) (checked location4))) (sometime (or (checked fridge_7) (objectatlocation butterknife_2 location2))) (sometime (holds agent1 butterknife_2)) (sometime (or (checked handtowelholder_3) (holds agent1 winebottle_1))) (sometime (or (checked location3) (holds agent1 tennisracket_3))) (sometime (objectatlocation plate_5 location1)) (sometime (objectatlocation box_4 location3)) (sometime (or (atlocation agent1 location1) (checked tennisracket_3))) (sometime (checked towelholder_2)))
