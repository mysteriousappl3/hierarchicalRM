(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   microwave_6 armchair_1 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (and (holds agent1 plate_5) (not (or (= ?l location5) (checked location5)))) (not (hold_1))) (when (or (= ?l location5) (checked location5)) (hold_1)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r armchair_1) (checked armchair_1) (atlocation agent1 location1)) (hold_2)) (when (or (holds agent1 plate_5) (= ?r microwave_6) (checked microwave_6)) (seen_psi_4)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (checked armchair_1) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_2)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_3)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_5)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r armchair_1) (checked armchair_1) (atlocation agent1 location1)) (hold_2)) (when (or (holds agent1 plate_5) (= ?r microwave_6) (checked microwave_6)) (seen_psi_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5)))) (hold_0)) (when (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5))) (not (checked location5))) (not (hold_1))) (when (or (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5)))) (checked microwave_6)) (seen_psi_4)) (increase (total-cost) 1)))
 (:action cleanobject
