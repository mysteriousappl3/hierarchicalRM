(define (problem alfred-problem)
 ...
 (:objects
   ...
   butterknife_1 fork_2 cellphone_3 potato_4 mug_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 cellphonetype) (receptacletype_0 ?r_0 sofatype))))))
 (:constraints (sometime (holds agent1 potato_4)) (sometime (or (holds agent1 butterknife_1) (checked mug_5))) (sometime (holds agent1 cellphone_3)) (sometime (checked location3)) (sometime (checked location2)))
