(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   butterknife_1 mug_5 cellphone_3 potato_4 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location3) (checked location3)) (hold_3)) (when (or (= ?l location2) (checked location2)) (hold_4)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (holds agent1 butterknife_1) (= ?o mug_5) (checked mug_5)) (hold_1)) (increase (total-cost) 1)))
 (:action gotolocation
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o potato_4)) (holds agent1 potato_4)) (hold_0)) (when (or (and (= ?a agent1) (= ?o butterknife_1)) (holds agent1 butterknife_1) (checked mug_5)) (hold_1)) (when (or (and (= ?a agent1) (= ?o cellphone_3)) (holds agent1 cellphone_3)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 potato_4) (not (and (= ?a agent1) (= ?o potato_4)))) (hold_0)) (when (or (and (holds agent1 butterknife_1) (not (and (= ?a agent1) (= ?o butterknife_1)))) (checked mug_5)) (hold_1)) (when (and (holds agent1 cellphone_3) (not (and (= ?a agent1) (= ?o cellphone_3)))) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
