(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   location1 location3 location4 location2 - location
   agent1 - agent
   box_4 cup_5 - obj
   fridge_7 - receptacle
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location4) (checked location4) (atlocation agent1 location2)) (hold_1)) (when (or (= ?l location3) (checked location3) (objectatlocation cup_5 location4)) (hold_3)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7)) (hold_0)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (checked location4) (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7)) (hold_0)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o box_4)) (holds agent1 box_4)) (hold_2)) (when (or (checked location3) (and (objectatlocation cup_5 location4) (not (and (= ?o cup_5) (= ?l location4))))) (hold_3)) (when (and (objectatlocation cup_5 location1) (not (and (= ?o cup_5) (= ?l location1)))) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 box_4) (not (and (= ?a agent1) (= ?o box_4)))) (hold_2)) (when (or (checked location3) (and (= ?o cup_5) (= ?l location4)) (objectatlocation cup_5 location4)) (hold_3)) (when (or (and (= ?o cup_5) (= ?l location1)) (objectatlocation cup_5 location1)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
