(define (problem alfred-problem)
 ...
 (:objects
   ...
   fork_1 toiletpaperroll_2 box_3 box_4 cup_5 - obj
 )
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 cuptype) (receptacletype_0 ?r_0 shelftype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (checked fridge_7)) (sometime (or (checked location4) (atlocation agent1 location2))) (sometime (holds agent1 box_4)) (sometime (or (checked location3) (objectatlocation cup_5 location4))) (sometime (objectatlocation cup_5 location1)))
