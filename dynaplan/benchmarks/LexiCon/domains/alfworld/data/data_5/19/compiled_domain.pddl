(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   dishsponge_2 dishsponge_3 pan_5 - obj
   desk_2 - receptacle
   location3 - location
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (holds agent1 pan_5) (= ?r desk_2) (checked desk_2)) (hold_0)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o pan_5) (checked pan_5)) (hold_1)) (when (or (= ?o dishsponge_2) (checked dishsponge_2) (holds agent1 pan_5)) (hold_4)) (increase (total-cost) 1)))
 (:action gotolocation
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (holds agent1 pan_5) (= ?r desk_2) (checked desk_2)) (hold_0)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5) (checked desk_2)) (hold_0)) (when (and (objectatlocation dishsponge_3 location3) (not (and (= ?o dishsponge_3) (= ?l location3)))) (hold_2)) (when (or (and (= ?a agent1) (= ?o dishsponge_3)) (holds agent1 dishsponge_3)) (hold_3)) (when (or (checked dishsponge_2) (and (= ?a agent1) (= ?o pan_5)) (holds agent1 pan_5)) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5)))) (checked desk_2)) (hold_0)) (when (or (and (= ?o dishsponge_3) (= ?l location3)) (objectatlocation dishsponge_3 location3)) (hold_2)) (when (and (holds agent1 dishsponge_3) (not (and (= ?a agent1) (= ?o dishsponge_3)))) (hold_3)) (when (or (checked dishsponge_2) (and (holds agent1 pan_5) (not (and (= ?a agent1) (= ?o pan_5))))) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
