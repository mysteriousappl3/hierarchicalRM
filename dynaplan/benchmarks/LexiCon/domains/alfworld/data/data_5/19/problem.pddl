(define (problem alfred-problem)
 ...
 (:constraints (sometime (or (holds agent1 pan_5) (checked desk_2))) (sometime (checked pan_5)) (sometime (objectatlocation dishsponge_3 location3)) (sometime (holds agent1 dishsponge_3)) (sometime (or (checked dishsponge_2) (holds agent1 pan_5))))
