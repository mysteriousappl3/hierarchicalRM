(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (checked location1) (= ?o cup_5) (checked cup_5)) (hold_3)) (when (or (holds agent1 toiletpaperroll_4) (= ?o egg_3) (checked egg_3)) (seen_psi_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart) (or (not (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))))) (seen_psi_6)))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (and (holds agent1 cup_5) (not (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))) (holds agent1 tissuebox_1)))) (not (hold_1))) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))) (holds agent1 tissuebox_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_5)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o cup_5)) (holds agent1 cup_5)) (hold_0)) (when (and (or (and (= ?a agent1) (= ?o cup_5)) (holds agent1 cup_5)) (not (or (atlocation agent1 location1) (and (= ?a agent1) (= ?o tissuebox_1)) (holds agent1 tissuebox_1)))) (not (hold_1))) (when (or (atlocation agent1 location1) (and (= ?a agent1) (= ?o tissuebox_1)) (holds agent1 tissuebox_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?o tissuebox_1)) (holds agent1 tissuebox_1) (checked agent1)) (hold_2)) (when (or (checked agent1) (and (= ?a agent1) (= ?o egg_3)) (holds agent1 egg_3)) (hold_4)) (when (or (and (= ?a agent1) (= ?o toiletpaperroll_4)) (holds agent1 toiletpaperroll_4) (checked egg_3)) (seen_psi_6)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 cup_5) (not (and (= ?a agent1) (= ?o cup_5)))) (hold_0)) (when (and (holds agent1 cup_5) (not (and (= ?a agent1) (= ?o cup_5))) (not (or (atlocation agent1 location1) (and (holds agent1 tissuebox_1) (not (and (= ?a agent1) (= ?o tissuebox_1))))))) (not (hold_1))) (when (or (atlocation agent1 location1) (and (holds agent1 tissuebox_1) (not (and (= ?a agent1) (= ?o tissuebox_1))))) (hold_1)) (when (or (and (holds agent1 tissuebox_1) (not (and (= ?a agent1) (= ?o tissuebox_1)))) (checked agent1)) (hold_2)) (when (or (checked agent1) (and (holds agent1 egg_3) (not (and (= ?a agent1) (= ?o egg_3))))) (hold_4)) (when (or (and (holds agent1 toiletpaperroll_4) (not (and (= ?a agent1) (= ?o toiletpaperroll_4)))) (checked egg_3)) (seen_psi_6)) (increase (total-cost) 1)))
 (:action cleanobject
