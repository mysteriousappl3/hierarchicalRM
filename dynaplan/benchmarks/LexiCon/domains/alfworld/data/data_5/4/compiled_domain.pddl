(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o plate_5) (checked plate_5)) (hold_0)) (when (and (holds agent1 tomato_3) (not (or (= ?o remotecontrol_1) (checked remotecontrol_1) (holds agent1 saltshaker_2)))) (not (hold_2))) (when (or (= ?o remotecontrol_1) (checked remotecontrol_1) (holds agent1 saltshaker_2)) (hold_2)) (when (or (checked location5) (= ?o remotecontrol_1) (checked remotecontrol_1)) (seen_psi_4)) (when (or (= ?o tomato_3) (checked tomato_3) (holds agent1 plate_5)) (hold_5)) (increase (total-cost) 1)))
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_3)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o tomato_3)) (holds agent1 tomato_3)) (hold_1)) (when (and (or (and (= ?a agent1) (= ?o tomato_3)) (holds agent1 tomato_3)) (not (or (checked remotecontrol_1) (and (= ?a agent1) (= ?o saltshaker_2)) (holds agent1 saltshaker_2)))) (not (hold_2))) (when (or (checked remotecontrol_1) (and (= ?a agent1) (= ?o saltshaker_2)) (holds agent1 saltshaker_2)) (hold_2)) (when (or (checked tomato_3) (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5)) (hold_5)) (when (or (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5)) (hold_6)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 tomato_3) (not (and (= ?a agent1) (= ?o tomato_3)))) (hold_1)) (when (and (holds agent1 tomato_3) (not (and (= ?a agent1) (= ?o tomato_3))) (not (or (checked remotecontrol_1) (and (holds agent1 saltshaker_2) (not (and (= ?a agent1) (= ?o saltshaker_2))))))) (not (hold_2))) (when (or (checked remotecontrol_1) (and (holds agent1 saltshaker_2) (not (and (= ?a agent1) (= ?o saltshaker_2))))) (hold_2)) (when (or (checked tomato_3) (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5))))) (hold_5)) (when (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5)))) (hold_6)) (increase (total-cost) 1)))
 (:action cleanobject
