(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (coolable ?o_0) (objecttype_0 ?o_0 tomatotype) (receptacletype_0 ?r_0 countertoptype) (iscool ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (checked plate_5)) (sometime (holds agent1 tomato_3)) (sometime-after (holds agent1 tomato_3) (or (checked remotecontrol_1) (holds agent1 saltshaker_2))) (sometime (atlocation agent1 location2)) (sometime-before (atlocation agent1 location2) (or (checked location5) (checked remotecontrol_1))) (sometime (or (checked tomato_3) (holds agent1 plate_5))) (sometime (holds agent1 plate_5)))
