(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   agent1 - agent
   peppershaker_4 book_2 ladle_1 keychain_3 - obj
   location3 location5 - location
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4) (holds agent1 ladle_1)) (hold_1)) (when (or (holds agent1 peppershaker_4) (= ?r countertop_1) (checked countertop_1)) (hold_2)) (when (or (= ?r countertop_1) (checked countertop_1)) (hold_3)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r laundryhamper_4) (checked laundryhamper_4) (holds agent1 ladle_1)) (hold_1)) (when (or (holds agent1 peppershaker_4) (= ?r countertop_1) (checked countertop_1)) (hold_2)) (when (or (= ?r countertop_1) (checked countertop_1)) (hold_3)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o book_2)) (holds agent1 book_2) (and (objectatlocation keychain_3 location5) (not (and (= ?o keychain_3) (= ?l location5))))) (hold_0)) (when (or (checked laundryhamper_4) (and (= ?a agent1) (= ?o ladle_1)) (holds agent1 ladle_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?o peppershaker_4)) (holds agent1 peppershaker_4) (checked countertop_1)) (hold_2)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 book_2) (not (and (= ?a agent1) (= ?o book_2)))) (and (= ?o keychain_3) (= ?l location5)) (objectatlocation keychain_3 location5)) (hold_0)) (when (or (checked laundryhamper_4) (and (holds agent1 ladle_1) (not (and (= ?a agent1) (= ?o ladle_1))))) (hold_1)) (when (or (and (holds agent1 peppershaker_4) (not (and (= ?a agent1) (= ?o peppershaker_4)))) (checked countertop_1)) (hold_2)) (increase (total-cost) 1)))
 (:action cleanobject
