(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 booktype) (receptacletype_0 ?r_0 countertoptype))))))
 (:constraints (sometime (or (holds agent1 book_2) (objectatlocation keychain_3 location5))) (sometime (or (checked laundryhamper_4) (holds agent1 ladle_1))) (sometime (or (holds agent1 peppershaker_4) (checked countertop_1))) (sometime (checked countertop_1)) (sometime (atlocation agent1 location3)))
