(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 vasetype) (receptacletype_0 ?r_0 diningtabletype))))))
 (:constraints (sometime (or (checked fridge_7) (holds agent1 vase_4))) (sometime (holds agent1 vase_4)) (sometime (atlocation agent1 location3)) (sometime (holds agent1 mug_1)) (sometime (or (objectatlocation tennisracket_2 location5) (atlocation agent1 location3))))
