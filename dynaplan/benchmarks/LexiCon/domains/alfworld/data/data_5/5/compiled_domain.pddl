(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   fridge_7 - receptacle
   agent1 - agent
   mug_1 tennisracket_2 vase_4 - obj
   location5 location3 - location
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7) (holds agent1 vase_4)) (hold_0)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_2)) (when (or (objectatlocation tennisracket_2 location5) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r fridge_7) (checked fridge_7) (holds agent1 vase_4)) (hold_0)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (checked fridge_7) (and (= ?a agent1) (= ?o vase_4)) (holds agent1 vase_4)) (hold_0)) (when (or (and (= ?a agent1) (= ?o vase_4)) (holds agent1 vase_4)) (hold_1)) (when (or (and (= ?a agent1) (= ?o mug_1)) (holds agent1 mug_1)) (hold_3)) (when (or (and (objectatlocation tennisracket_2 location5) (not (and (= ?o tennisracket_2) (= ?l location5)))) (atlocation agent1 location3)) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (checked fridge_7) (and (holds agent1 vase_4) (not (and (= ?a agent1) (= ?o vase_4))))) (hold_0)) (when (and (holds agent1 vase_4) (not (and (= ?a agent1) (= ?o vase_4)))) (hold_1)) (when (and (holds agent1 mug_1) (not (and (= ?a agent1) (= ?o mug_1)))) (hold_3)) (when (or (and (= ?o tennisracket_2) (= ?l location5)) (objectatlocation tennisracket_2 location5) (atlocation agent1 location3)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
