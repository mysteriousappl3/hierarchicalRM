(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r microwave_6) (checked microwave_6)) (hold_3)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (holds agent1 plate_5)) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_1)) (when (and (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (not (or (checked location5) (holds agent1 candle_1)))) (not (hold_2))) (when (or (objectatlocation plate_5 location4) (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r microwave_6) (checked microwave_6)) (hold_3)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o pot_4)) (holds agent1 pot_4))) (seen_psi_5)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (atlocation agent1 location5) (and (= ?a agent1) (= ?o plate_5)) (holds agent1 plate_5)) (hold_0)) (when (and (atlocation agent1 location2) (not (or (checked location5) (and (= ?a agent1) (= ?o candle_1)) (holds agent1 candle_1)))) (not (hold_2))) (when (or (checked location5) (and (= ?a agent1) (= ?o candle_1)) (holds agent1 candle_1)) (hold_2)) (when (or (and (= ?a agent1) (= ?o pot_4)) (holds agent1 pot_4)) (hold_4)) (when (or (and (objectatlocation plate_5 location4) (not (and (= ?o plate_5) (= ?l location4)))) (atlocation agent1 location5)) (hold_6)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 pot_4) (not (and (= ?a agent1) (= ?o pot_4))))) (seen_psi_5)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (atlocation agent1 location5) (and (holds agent1 plate_5) (not (and (= ?a agent1) (= ?o plate_5))))) (hold_0)) (when (and (atlocation agent1 location2) (not (or (checked location5) (and (holds agent1 candle_1) (not (and (= ?a agent1) (= ?o candle_1))))))) (not (hold_2))) (when (or (checked location5) (and (holds agent1 candle_1) (not (and (= ?a agent1) (= ?o candle_1))))) (hold_2)) (when (and (holds agent1 pot_4) (not (and (= ?a agent1) (= ?o pot_4)))) (hold_4)) (when (or (and (= ?o plate_5) (= ?l location4)) (objectatlocation plate_5 location4) (atlocation agent1 location5)) (hold_6)) (increase (total-cost) 1)))
 (:action cleanobject
