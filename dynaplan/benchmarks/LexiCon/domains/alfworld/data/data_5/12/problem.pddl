(define (problem alfred-problem)
 ...
 (:objects
   ...
   watch_1 butterknife_2 mug_3 apple_4 box_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 watchtype) (receptacletype_0 ?r_0 coffeetabletype))))))
 (:constraints (sometime (atlocation agent1 location5)) (sometime (atlocation agent1 location1)) (sometime (checked box_5)) (sometime (checked watch_1)) (sometime (or (checked location5) (atlocation agent1 location2))))
