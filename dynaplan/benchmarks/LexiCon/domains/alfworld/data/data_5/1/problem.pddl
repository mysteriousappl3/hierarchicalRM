(define (problem alfred-problem)
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 knifetype) (receptacletype_0 ?r_0 sinkbasintype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (holds agent1 mug_5) (atlocation agent1 location3))) (sometime (or (atlocation agent1 location4) (holds agent1 knife_1))) (sometime (or (objectatlocation mug_4 location5) (checked mug_4))) (sometime (or (objectatlocation mug_4 location5) (checked microwave_3))) (sometime (checked microwave_3)))
