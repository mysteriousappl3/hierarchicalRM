(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (objectatlocation mug_4 location5) (= ?r microwave_3) (checked microwave_3)) (hold_3)) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_4)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (objectatlocation mug_4 location5) (= ?o mug_4) (checked mug_4)) (hold_2)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (holds agent1 mug_5) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (holds agent1 knife_1)) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (objectatlocation mug_4 location5) (= ?r microwave_3) (checked microwave_3)) (hold_3)) (when (or (= ?r microwave_3) (checked microwave_3)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5) (atlocation agent1 location3)) (hold_0)) (when (or (atlocation agent1 location4) (and (= ?a agent1) (= ?o knife_1)) (holds agent1 knife_1)) (hold_1)) (when (or (and (objectatlocation mug_4 location5) (not (and (= ?o mug_4) (= ?l location5)))) (checked mug_4)) (hold_2)) (when (or (and (objectatlocation mug_4 location5) (not (and (= ?o mug_4) (= ?l location5)))) (checked microwave_3)) (hold_3)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (atlocation agent1 location3)) (hold_0)) (when (or (atlocation agent1 location4) (and (holds agent1 knife_1) (not (and (= ?a agent1) (= ?o knife_1))))) (hold_1)) (when (or (and (= ?o mug_4) (= ?l location5)) (objectatlocation mug_4 location5) (checked mug_4)) (hold_2)) (when (or (and (= ?o mug_4) (= ?l location5)) (objectatlocation mug_4 location5) (checked microwave_3)) (hold_3)) (increase (total-cost) 1)))
 (:action cleanobject
