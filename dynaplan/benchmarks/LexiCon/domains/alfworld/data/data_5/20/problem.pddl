(define (problem alfred-problem)
 ...
 (:objects
   ...
   potato_1 pencil_2 keychain_3 pot_4 cup_5 - obj
 )
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 potatotype) (receptacletype_0 ?r_0 garbagecantype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (holds agent1 potato_1)) (sometime-before (holds agent1 potato_1) (objectatlocation pot_4 location3)) (sometime (or (objectatlocation pot_4 location5) (atlocation agent1 location1))) (sometime (holds agent1 keychain_3)) (sometime (checked drawer_4)) (sometime (atlocation agent1 location5)) (sometime-before (atlocation agent1 location5) (checked location4)))
