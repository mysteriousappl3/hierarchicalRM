(define (domain liftedtcore_alfred-domain)
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location4) (checked location4)) (seen_psi_6)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r drawer_4) (checked drawer_4)) (hold_4)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :precondition (and (atlocation ?a ?lstart) (or (not (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))))) (seen_psi_6)))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (objectatlocation pot_4 location5) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_2)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_5)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r drawer_4) (checked drawer_4)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o potato_1)) (holds agent1 potato_1))) (seen_psi_1)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o potato_1)) (holds agent1 potato_1)) (hold_0)) (when (and (objectatlocation pot_4 location3) (not (and (= ?o pot_4) (= ?l location3)))) (seen_psi_1)) (when (or (and (objectatlocation pot_4 location5) (not (and (= ?o pot_4) (= ?l location5)))) (atlocation agent1 location1)) (hold_2)) (when (or (and (= ?a agent1) (= ?o keychain_3)) (holds agent1 keychain_3)) (hold_3)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 potato_1) (not (and (= ?a agent1) (= ?o potato_1))))) (seen_psi_1)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 potato_1) (not (and (= ?a agent1) (= ?o potato_1)))) (hold_0)) (when (or (and (= ?o pot_4) (= ?l location3)) (objectatlocation pot_4 location3)) (seen_psi_1)) (when (or (and (= ?o pot_4) (= ?l location5)) (objectatlocation pot_4 location5) (atlocation agent1 location1)) (hold_2)) (when (and (holds agent1 keychain_3) (not (and (= ?a agent1) (= ?o keychain_3)))) (hold_3)) (increase (total-cost) 1)))
 (:action cleanobject
