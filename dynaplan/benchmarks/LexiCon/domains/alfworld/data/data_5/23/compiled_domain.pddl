(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   ...
   toiletpaperhanger_4 - receptacle
   soapbottle_3 dishsponge_1 - obj
   agent1 - agent
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location3) (checked location3)) (hold_4)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r toiletpaperhanger_4) (checked toiletpaperhanger_4) (checked dishsponge_1)) (hold_2)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (checked toiletpaperhanger_4) (= ?o dishsponge_1) (checked dishsponge_1)) (hold_2)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_0)) (when (or (objectatlocation soapbottle_3 location4) (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_1)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r toiletpaperhanger_4) (checked toiletpaperhanger_4) (checked dishsponge_1)) (hold_2)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation soapbottle_3 location4) (not (and (= ?o soapbottle_3) (= ?l location4)))) (atlocation agent1 location5)) (hold_1)) (when (or (and (= ?a agent1) (= ?o soapbottle_3)) (holds agent1 soapbottle_3)) (hold_3)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o soapbottle_3) (= ?l location4)) (objectatlocation soapbottle_3 location4) (atlocation agent1 location5)) (hold_1)) (when (and (holds agent1 soapbottle_3) (not (and (= ?a agent1) (= ?o soapbottle_3)))) (hold_3)) (increase (total-cost) 1)))
 (:action cleanobject
