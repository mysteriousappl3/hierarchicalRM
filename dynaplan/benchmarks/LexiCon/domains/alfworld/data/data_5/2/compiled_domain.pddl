(define (domain liftedtcore_alfred-domain)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_3)) (when (and (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (not (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))))) (not (hold_4))) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_4)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_5)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_6)) (when (and (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (not (objectatlocation mug_5 location3))) (not (hold_7))) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2))) (seen_psi_2)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation fork_3 location3) (not (and (= ?o fork_3) (= ?l location3)))) (checked location1)) (hold_0)) (when (or (and (= ?a agent1) (= ?o cup_2)) (holds agent1 cup_2)) (hold_1)) (when (or (and (= ?a agent1) (= ?o fork_3)) (holds agent1 fork_3)) (seen_psi_2)) (when (and (atlocation agent1 location3) (not (and (objectatlocation mug_5 location3) (not (and (= ?o mug_5) (= ?l location3)))))) (not (hold_7))) (when (and (objectatlocation mug_5 location3) (not (and (= ?o mug_5) (= ?l location3)))) (hold_7)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2))))) (seen_psi_2)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o fork_3) (= ?l location3)) (objectatlocation fork_3 location3) (checked location1)) (hold_0)) (when (and (holds agent1 cup_2) (not (and (= ?a agent1) (= ?o cup_2)))) (hold_1)) (when (and (holds agent1 fork_3) (not (and (= ?a agent1) (= ?o fork_3)))) (seen_psi_2)) (when (and (atlocation agent1 location3) (not (or (and (= ?o mug_5) (= ?l location3)) (objectatlocation mug_5 location3)))) (not (hold_7))) (when (or (and (= ?o mug_5) (= ?l location3)) (objectatlocation mug_5 location3)) (hold_7)) (increase (total-cost) 1)))
 (:action cleanobject
