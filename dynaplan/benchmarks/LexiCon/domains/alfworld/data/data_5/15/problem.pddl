(define (problem alfred-problem)
 ...
 (:objects
   ...
   tomato_1 remotecontrol_2 apple_3 spatula_4 cup_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (heatable ?o_0) (objecttype_0 ?o_0 appletype) (receptacletype_0 ?r_0 countertoptype) (ishot ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (holds agent1 apple_3)) (sometime-before (holds agent1 apple_3) (or (holds agent1 cup_5) (atlocation agent1 location4))) (sometime (checked spatula_4)) (sometime (or (atlocation agent1 location4) (checked sidetable_1))) (sometime (or (atlocation agent1 location3) (checked location4))) (sometime (or (holds agent1 remotecontrol_2) (atlocation agent1 location5))))
