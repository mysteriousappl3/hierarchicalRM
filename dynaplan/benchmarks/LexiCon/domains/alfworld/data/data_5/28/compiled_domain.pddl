(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (atlocation agent1 location3) (= ?o baseballbat_4) (checked baseballbat_4)) (seen_psi_5)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (checked baseballbat_4)) (seen_psi_5)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (checked location2)) (hold_6)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o ladle_3)) (holds agent1 ladle_3))) (seen_psi_3)) (or (not (or (and (= ?a agent1) (= ?o tomato_2)) (holds agent1 tomato_2))) (seen_psi_5)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5) (and (objectatlocation baseballbat_4 location5) (not (and (= ?o baseballbat_4) (= ?l location5))))) (hold_0)) (when (and (objectatlocation mug_5 location4) (not (and (= ?o mug_5) (= ?l location4)))) (hold_1)) (when (or (and (= ?a agent1) (= ?o ladle_3)) (holds agent1 ladle_3)) (hold_2)) (when (and (objectatlocation baseballbat_4 location5) (not (and (= ?o baseballbat_4) (= ?l location5)))) (seen_psi_3)) (when (or (and (= ?a agent1) (= ?o tomato_2)) (holds agent1 tomato_2)) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 ladle_3) (not (and (= ?a agent1) (= ?o ladle_3))))) (seen_psi_3)) (or (not (and (holds agent1 tomato_2) (not (and (= ?a agent1) (= ?o tomato_2))))) (seen_psi_5)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (and (= ?o baseballbat_4) (= ?l location5)) (objectatlocation baseballbat_4 location5)) (hold_0)) (when (or (and (= ?o mug_5) (= ?l location4)) (objectatlocation mug_5 location4)) (hold_1)) (when (and (holds agent1 ladle_3) (not (and (= ?a agent1) (= ?o ladle_3)))) (hold_2)) (when (or (and (= ?o baseballbat_4) (= ?l location5)) (objectatlocation baseballbat_4 location5)) (seen_psi_3)) (when (and (holds agent1 tomato_2) (not (and (= ?a agent1) (= ?o tomato_2)))) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
