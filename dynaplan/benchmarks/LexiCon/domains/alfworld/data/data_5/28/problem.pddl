(define (problem alfred-problem)
 ...
 (exists (?o1 - obj)
 (and (inreceptacle ?o1 ?r_0) (objecttype_0 ?o1 tomatotype) (receptacletype_0 ?r_0 sidetabletype) (exists (?o2 - obj)
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 ladletype) (receptacletype_0 ?r_0 sidetabletype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (holds agent1 mug_5) (objectatlocation baseballbat_4 location5))) (sometime (objectatlocation mug_5 location4)) (sometime (holds agent1 ladle_3)) (sometime-before (holds agent1 ladle_3) (objectatlocation baseballbat_4 location5)) (sometime (holds agent1 tomato_2)) (sometime-before (holds agent1 tomato_2) (or (atlocation agent1 location3) (checked baseballbat_4))) (sometime (or (atlocation agent1 location3) (checked location2))))
