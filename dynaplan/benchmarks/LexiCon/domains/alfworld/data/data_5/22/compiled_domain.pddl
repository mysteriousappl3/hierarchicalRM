(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   laptop_4 keychain_3 saltshaker_1 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (holds agent1 saltshaker_1) (= ?l location4) (checked location4)) (hold_4)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (= ?a agent1) (checked agent1)) (hold_1)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (holds agent1 saltshaker_1)) (hold_2)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_3)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation keychain_3 location2) (not (and (= ?o keychain_3) (= ?l location2)))) (and (= ?a agent1) (= ?o laptop_4)) (holds agent1 laptop_4)) (hold_0)) (when (or (atlocation agent1 location4) (and (= ?a agent1) (= ?o saltshaker_1)) (holds agent1 saltshaker_1)) (hold_2)) (when (or (and (= ?a agent1) (= ?o saltshaker_1)) (holds agent1 saltshaker_1) (checked location4)) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o keychain_3) (= ?l location2)) (objectatlocation keychain_3 location2) (and (holds agent1 laptop_4) (not (and (= ?a agent1) (= ?o laptop_4))))) (hold_0)) (when (or (atlocation agent1 location4) (and (holds agent1 saltshaker_1) (not (and (= ?a agent1) (= ?o saltshaker_1))))) (hold_2)) (when (or (and (holds agent1 saltshaker_1) (not (and (= ?a agent1) (= ?o saltshaker_1)))) (checked location4)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
