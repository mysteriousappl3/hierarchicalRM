(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o plate_2) (checked plate_2) (atlocation agent1 location1)) (hold_5)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart) (or (not (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))))) (seen_psi_1)))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (holds agent1 wateringcan_1)) (seen_psi_1)) (when (and (holds agent1 plate_2) (not (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (objectatlocation statue_3 location2)))) (not (hold_3))) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (objectatlocation statue_3 location2)) (hold_3)) (when (or (checked plate_2) (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1))))) (hold_5)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_6)) (when (and (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (not (checked location1))) (not (hold_7))) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (atlocation agent1 location3) (and (= ?a agent1) (= ?o wateringcan_1)) (holds agent1 wateringcan_1)) (seen_psi_1)) (when (or (and (= ?a agent1) (= ?o plate_2)) (holds agent1 plate_2)) (hold_2)) (when (and (or (and (= ?a agent1) (= ?o plate_2)) (holds agent1 plate_2)) (not (or (atlocation agent1 location5) (and (objectatlocation statue_3 location2) (not (and (= ?o statue_3) (= ?l location2))))))) (not (hold_3))) (when (or (atlocation agent1 location5) (and (objectatlocation statue_3 location2) (not (and (= ?o statue_3) (= ?l location2))))) (hold_3)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (atlocation agent1 location3) (and (holds agent1 wateringcan_1) (not (and (= ?a agent1) (= ?o wateringcan_1))))) (seen_psi_1)) (when (and (holds agent1 plate_2) (not (and (= ?a agent1) (= ?o plate_2)))) (hold_2)) (when (and (holds agent1 plate_2) (not (and (= ?a agent1) (= ?o plate_2))) (not (or (atlocation agent1 location5) (and (= ?o statue_3) (= ?l location2)) (objectatlocation statue_3 location2)))) (not (hold_3))) (when (or (atlocation agent1 location5) (and (= ?o statue_3) (= ?l location2)) (objectatlocation statue_3 location2)) (hold_3)) (increase (total-cost) 1)))
 (:action cleanobject
