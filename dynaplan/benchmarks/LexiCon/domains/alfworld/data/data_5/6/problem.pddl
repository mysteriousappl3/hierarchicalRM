(define (problem alfred-problem)
 ...
 (:objects
   ...
   wateringcan_1 plate_2 statue_3 plunger_4 pot_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 platetype) (receptacletype_0 ?r_0 microwavetype))))))
 (:constraints (sometime (atlocation agent1 location4)) (sometime-before (atlocation agent1 location4) (or (atlocation agent1 location3) (holds agent1 wateringcan_1))) (sometime (holds agent1 plate_2)) (sometime-after (holds agent1 plate_2) (or (atlocation agent1 location5) (objectatlocation statue_3 location2))) (sometime (checked location5)) (sometime (or (checked plate_2) (atlocation agent1 location1))) (sometime (atlocation agent1 location5)) (sometime-after (atlocation agent1 location5) (checked location1)))
