(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   location1 location5 location3 location2 - location
   pot_5 dishsponge_4 butterknife_3 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (atlocation agent1 location1) (= ?l location3) (checked location3)) (hold_2)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_0)) (when (or (holds agent1 dishsponge_4) (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location1)) (and (atlocation agent1 location1) (not (and (= ?a agent1) (= ?lstart location1)))) (checked location3)) (hold_2)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o dishsponge_4)) (holds agent1 dishsponge_4) (atlocation agent1 location5)) (hold_1)) (when (or (and (= ?a agent1) (= ?o pot_5)) (holds agent1 pot_5) (and (= ?a agent1) (= ?o butterknife_3)) (holds agent1 butterknife_3)) (hold_3)) (when (or (and (= ?a agent1) (= ?o pot_5)) (holds agent1 pot_5)) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (holds agent1 dishsponge_4) (not (and (= ?a agent1) (= ?o dishsponge_4)))) (atlocation agent1 location5)) (hold_1)) (when (or (and (holds agent1 pot_5) (not (and (= ?a agent1) (= ?o pot_5)))) (and (holds agent1 butterknife_3) (not (and (= ?a agent1) (= ?o butterknife_3))))) (hold_3)) (when (and (holds agent1 pot_5) (not (and (= ?a agent1) (= ?o pot_5)))) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
