(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 pottype) (receptacletype_0 ?r_0 sidetabletype))))))
 (:constraints (sometime (atlocation agent1 location2)) (sometime (or (holds agent1 dishsponge_4) (atlocation agent1 location5))) (sometime (or (atlocation agent1 location1) (checked location3))) (sometime (or (holds agent1 pot_5) (holds agent1 butterknife_3))) (sometime (holds agent1 pot_5)))
