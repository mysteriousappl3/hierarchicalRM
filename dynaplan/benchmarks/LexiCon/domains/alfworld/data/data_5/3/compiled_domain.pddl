(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   mug_5 bowl_4 alarmclock_1 watch_2 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (holds agent1 bowl_4) (= ?l location5) (checked location5)) (hold_2)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (= ?r handtowelholder_1) (checked handtowelholder_1) (atlocation agent1 location3)) (hold_4)) (increase (total-cost) 1)))
 ...
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (objectatlocation alarmclock_1 location1) (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (hold_0)) (when (or (checked handtowelholder_1) (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (or (= ?r handtowelholder_1) (checked handtowelholder_1) (atlocation agent1 location3)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (objectatlocation alarmclock_1 location1) (not (and (= ?o alarmclock_1) (= ?l location1)))) (atlocation agent1 location4)) (hold_0)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5) (and (= ?a agent1) (= ?o watch_2)) (holds agent1 watch_2)) (hold_1)) (when (or (and (= ?a agent1) (= ?o bowl_4)) (holds agent1 bowl_4) (checked location5)) (hold_2)) (when (or (and (= ?a agent1) (= ?o watch_2)) (holds agent1 watch_2) (and (objectatlocation alarmclock_1 location4) (not (and (= ?o alarmclock_1) (= ?l location4))))) (hold_3)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (and (= ?o alarmclock_1) (= ?l location1)) (objectatlocation alarmclock_1 location1) (atlocation agent1 location4)) (hold_0)) (when (or (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (and (holds agent1 watch_2) (not (and (= ?a agent1) (= ?o watch_2))))) (hold_1)) (when (or (and (holds agent1 bowl_4) (not (and (= ?a agent1) (= ?o bowl_4)))) (checked location5)) (hold_2)) (when (or (and (holds agent1 watch_2) (not (and (= ?a agent1) (= ?o watch_2)))) (and (= ?o alarmclock_1) (= ?l location4)) (objectatlocation alarmclock_1 location4)) (hold_3)) (increase (total-cost) 1)))
 (:action cleanobject
