(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 alarmclocktype) (receptacletype_0 ?r_0 coffeetabletype))))))
 (:constraints (sometime (or (objectatlocation alarmclock_1 location1) (atlocation agent1 location4))) (sometime (or (holds agent1 mug_5) (holds agent1 watch_2))) (sometime (or (holds agent1 bowl_4) (checked location5))) (sometime (or (holds agent1 watch_2) (objectatlocation alarmclock_1 location4))) (sometime (or (checked handtowelholder_1) (atlocation agent1 location3))))
