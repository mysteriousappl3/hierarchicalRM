(define (problem alfred-problem)
 ...
 (:constraints (sometime (or (checked location4) (holds agent1 pot_5))) (sometime (holds agent1 plate_1)) (sometime (or (holds agent1 alarmclock_4) (holds agent1 butterknife_2))) (sometime (checked agent1)) (sometime (or (holds agent1 pot_5) (checked handtowelholder_5))))
