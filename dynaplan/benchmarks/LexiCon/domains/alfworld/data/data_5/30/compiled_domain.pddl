(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   location4 - location
   agent1 - agent
   pot_5 plate_1 butterknife_2 alarmclock_4 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (= ?l location4) (checked location4) (holds agent1 pot_5)) (hold_0)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
  :effect (and (checked ?a) (when (or (= ?a agent1) (checked agent1)) (hold_3)) (increase (total-cost) 1)))
 (:action examinereceptacle
  :parameters ( ?a - agent ?r - receptacle)
  :precondition (and (exists (?l_0 - location)
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (or (holds agent1 pot_5) (= ?r handtowelholder_5) (checked handtowelholder_5)) (hold_4)) (increase (total-cost) 1)))
 ...
 (:action openobject
  ...
  :effect (and (opened ?r) (checked ?r) (when (or (holds agent1 pot_5) (= ?r handtowelholder_5) (checked handtowelholder_5)) (hold_4)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (checked location4) (and (= ?a agent1) (= ?o pot_5)) (holds agent1 pot_5)) (hold_0)) (when (or (and (= ?a agent1) (= ?o plate_1)) (holds agent1 plate_1)) (hold_1)) (when (or (and (= ?a agent1) (= ?o alarmclock_4)) (holds agent1 alarmclock_4) (and (= ?a agent1) (= ?o butterknife_2)) (holds agent1 butterknife_2)) (hold_2)) (when (or (and (= ?a agent1) (= ?o pot_5)) (holds agent1 pot_5) (checked handtowelholder_5)) (hold_4)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (checked location4) (and (holds agent1 pot_5) (not (and (= ?a agent1) (= ?o pot_5))))) (hold_0)) (when (and (holds agent1 plate_1) (not (and (= ?a agent1) (= ?o plate_1)))) (hold_1)) (when (or (and (holds agent1 alarmclock_4) (not (and (= ?a agent1) (= ?o alarmclock_4)))) (and (holds agent1 butterknife_2) (not (and (= ?a agent1) (= ?o butterknife_2))))) (hold_2)) (when (or (and (holds agent1 pot_5) (not (and (= ?a agent1) (= ?o pot_5)))) (checked handtowelholder_5)) (hold_4)) (increase (total-cost) 1)))
 (:action cleanobject
