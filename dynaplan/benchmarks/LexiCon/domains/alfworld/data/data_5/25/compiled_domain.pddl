(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (atlocation agent1 location4) (= ?o cup_5) (checked cup_5)) (hold_2)) (when (or (= ?o apple_1) (checked apple_1) (objectatlocation cup_5 location5)) (hold_5)) (when (or (= ?o pan_3) (checked pan_3) (= ?o watch_4) (checked watch_4)) (hold_6)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart) (or (not (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2)))))) (seen_psi_1)))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_0)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (holds agent1 watch_4)) (seen_psi_1)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4)))) (checked cup_5)) (hold_2)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :precondition (and (pickupable ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (inreceptacle ?o ?r) (not (holdsany ?a)) (or (not (openable ?r)) (opened ?r)) (or (not (or (and (= ?a agent1) (= ?o apple_1)) (holds agent1 apple_1))) (seen_psi_4)))
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (atlocation agent1 location4) (and (= ?a agent1) (= ?o watch_4)) (holds agent1 watch_4)) (seen_psi_1)) (when (or (and (= ?a agent1) (= ?o apple_1)) (holds agent1 apple_1)) (hold_3)) (when (or (and (objectatlocation apple_1 location5) (not (and (= ?o apple_1) (= ?l location5)))) (and (= ?a agent1) (= ?o ladle_2)) (holds agent1 ladle_2)) (seen_psi_4)) (when (or (checked apple_1) (and (objectatlocation cup_5 location5) (not (and (= ?o cup_5) (= ?l location5))))) (hold_5)) (increase (total-cost) 1)))
 (:action putobject
  :parameters ( ?a - agent ?l - location ?o - obj ?r - receptacle ?ot - objecttype ?rt - receptacletype)
  :precondition (and (holds ?a ?o) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (or (not (openable ?r)) (opened ?r)) (objecttype_0 ?o ?ot) (receptacletype_0 ?r ?rt) (cancontain ?rt ?ot) (or (not (and (holds agent1 apple_1) (not (and (= ?a agent1) (= ?o apple_1))))) (seen_psi_4)))
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (or (atlocation agent1 location4) (and (holds agent1 watch_4) (not (and (= ?a agent1) (= ?o watch_4))))) (seen_psi_1)) (when (and (holds agent1 apple_1) (not (and (= ?a agent1) (= ?o apple_1)))) (hold_3)) (when (or (and (= ?o apple_1) (= ?l location5)) (objectatlocation apple_1 location5) (and (holds agent1 ladle_2) (not (and (= ?a agent1) (= ?o ladle_2))))) (seen_psi_4)) (when (or (checked apple_1) (and (= ?o cup_5) (= ?l location5)) (objectatlocation cup_5 location5)) (hold_5)) (increase (total-cost) 1)))
 (:action cleanobject
