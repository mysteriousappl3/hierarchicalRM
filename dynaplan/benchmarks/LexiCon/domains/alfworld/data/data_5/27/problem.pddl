(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (coolable ?o_0) (objecttype_0 ?o_0 pottype) (receptacletype_0 ?r_0 fridgetype) (iscool ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (holds agent1 pan_4)) (sometime (holds agent1 pot_3)) (sometime-after (holds agent1 pot_3) (or (objectatlocation pot_5 location4) (holds agent1 pot_5))) (sometime (or (atlocation agent1 location2) (objectatlocation pan_4 location2))) (sometime (or (objectatlocation pot_5 location5) (checked toilet_4))) (sometime (or (checked toaster_3) (holds agent1 pot_5))))
