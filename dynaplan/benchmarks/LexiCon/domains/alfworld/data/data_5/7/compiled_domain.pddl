(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (and (holds agent1 mug_5) (not (or (= ?r towelholder_1) (checked towelholder_1)))) (not (hold_1))) (when (or (= ?r towelholder_1) (checked towelholder_1)) (hold_1)) (when (and (atlocation agent1 location5) (not (or (holds agent1 lettuce_3) (= ?r cart_2) (checked cart_2)))) (not (hold_3))) (when (or (holds agent1 lettuce_3) (= ?r cart_2) (checked cart_2)) (hold_3)) (increase (total-cost) 1)))
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5)) (hold_0)) (when (and (or (and (= ?a agent1) (= ?o mug_5)) (holds agent1 mug_5)) (not (checked towelholder_1))) (not (hold_1))) (when (and (atlocation agent1 location5) (not (or (and (= ?a agent1) (= ?o lettuce_3)) (holds agent1 lettuce_3) (checked cart_2)))) (not (hold_3))) (when (or (and (= ?a agent1) (= ?o lettuce_3)) (holds agent1 lettuce_3) (checked cart_2)) (hold_3)) (when (and (objectatlocation mug_5 location5) (not (and (= ?o mug_5) (= ?l location5)))) (hold_4)) (when (and (objectatlocation mug_5 location5) (not (and (= ?o mug_5) (= ?l location5))) (not (or (and (= ?a agent1) (= ?o candle_1)) (holds agent1 candle_1) (checked location1)))) (not (hold_5))) (when (or (and (= ?a agent1) (= ?o candle_1)) (holds agent1 candle_1) (checked location1)) (hold_5)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5)))) (hold_0)) (when (and (holds agent1 mug_5) (not (and (= ?a agent1) (= ?o mug_5))) (not (checked towelholder_1))) (not (hold_1))) (when (and (atlocation agent1 location5) (not (or (and (holds agent1 lettuce_3) (not (and (= ?a agent1) (= ?o lettuce_3)))) (checked cart_2)))) (not (hold_3))) (when (or (and (holds agent1 lettuce_3) (not (and (= ?a agent1) (= ?o lettuce_3)))) (checked cart_2)) (hold_3)) (when (or (and (= ?o mug_5) (= ?l location5)) (objectatlocation mug_5 location5)) (hold_4)) (when (and (or (and (= ?o mug_5) (= ?l location5)) (objectatlocation mug_5 location5)) (not (or (and (holds agent1 candle_1) (not (and (= ?a agent1) (= ?o candle_1)))) (checked location1)))) (not (hold_5))) (when (or (and (holds agent1 candle_1) (not (and (= ?a agent1) (= ?o candle_1)))) (checked location1)) (hold_5)) (increase (total-cost) 1)))
 (:action cleanobject
