(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (heatable ?o_0) (objecttype_0 ?o_0 mugtype) (receptacletype_0 ?r_0 fridgetype) (ishot ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (holds agent1 mug_5)) (sometime-after (holds agent1 mug_5) (checked towelholder_1)) (sometime (atlocation agent1 location5)) (sometime-after (atlocation agent1 location5) (or (holds agent1 lettuce_3) (checked cart_2))) (sometime (objectatlocation mug_5 location5)) (sometime-after (objectatlocation mug_5 location5) (or (holds agent1 candle_1) (checked location1))) (sometime (checked mug_5)) (sometime (or (checked lettuce_3) (checked location5))))
