(define (problem alfred-problem)
 ...
 (:objects
   ...
   fork_1 ladle_2 fork_3 tennisracket_4 pan_5 - obj
 )
 ...
 (and (not (= ?o1 ?o2)) (objecttype_0 ?o2 pantype) (receptacletype_0 ?r_0 sinkbasintype) (inreceptacle ?o2 ?r_0))))))))
 (:constraints (sometime (or (atlocation agent1 location4) (checked microwave_6))) (sometime (or (checked location2) (objectatlocation fork_1 location5))) (sometime (or (holds agent1 tennisracket_4) (atlocation agent1 location4))) (sometime (holds agent1 pan_5)) (sometime-after (holds agent1 pan_5) (objectatlocation fork_1 location3)) (sometime (or (checked pan_5) (objectatlocation ladle_2 location4))))
