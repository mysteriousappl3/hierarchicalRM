(define (problem alfred-problem)
 ...
 (:objects
   ...
   bread_1 handtowel_2 baseballbat_3 bowl_4 box_5 - obj
 )
 ...
 (exists (?o_0 - obj)
 (and (inreceptacle ?o_0 ?r_0) (objecttype_0 ?o_0 boxtype) (receptacletype_0 ?r_0 desktype))))))
 (:constraints (sometime (holds agent1 baseballbat_3)) (sometime (or (atlocation agent1 location3) (checked location1))) (sometime (checked bowl_4)) (sometime (or (atlocation agent1 location5) (holds agent1 bowl_4))) (sometime (atlocation agent1 location5)))
