(define (domain liftedtcore_alfred-domain)
 ...
 (:constants
   agent1 - agent
   location1 location5 location3 - location
   bowl_4 baseballbat_3 - obj
 ...
 (:action look
  ...
  :effect (and (checked ?l) (when (or (atlocation agent1 location3) (= ?l location1) (checked location1)) (hold_1)) (increase (total-cost) 1)))
 (:action inventory
  :parameters ( ?a - agent)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (or (= ?o bowl_4) (checked bowl_4)) (hold_2)) (increase (total-cost) 1)))
 (:action gotolocation
  :parameters ( ?a - agent ?lstart - location ?lend - location)
  :precondition (and (atlocation ?a ?lstart))
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3)))) (checked location1)) (hold_1)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5)))) (holds agent1 bowl_4)) (hold_3)) (when (or (and (= ?a agent1) (= ?lend location5)) (and (atlocation agent1 location5) (not (and (= ?a agent1) (= ?lstart location5))))) (hold_4)) (increase (total-cost) 1)))
 (:action openobject
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o baseballbat_3)) (holds agent1 baseballbat_3)) (hold_0)) (when (or (atlocation agent1 location5) (and (= ?a agent1) (= ?o bowl_4)) (holds agent1 bowl_4)) (hold_3)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 baseballbat_3) (not (and (= ?a agent1) (= ?o baseballbat_3)))) (hold_0)) (when (or (atlocation agent1 location5) (and (holds agent1 bowl_4) (not (and (= ?a agent1) (= ?o bowl_4))))) (hold_3)) (increase (total-cost) 1)))
 (:action cleanobject
