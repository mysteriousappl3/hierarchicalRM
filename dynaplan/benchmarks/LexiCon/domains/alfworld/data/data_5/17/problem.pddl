(define (problem alfred-problem)
 ...
 (exists (?o_0 - obj)
 (and (coolable ?o_0) (objecttype_0 ?o_0 bowltype) (receptacletype_0 ?r_0 coffeetabletype) (iscool ?o_0) (inreceptacle ?o_0 ?r_0))))))
 (:constraints (sometime (holds agent1 cloth_4)) (sometime (atlocation agent1 location2)) (sometime-after (atlocation agent1 location2) (or (objectatlocation cloth_4 location5) (checked sinkbasin_1))) (sometime (holds agent1 bowl_5)) (sometime-after (holds agent1 bowl_5) (or (checked location1) (checked pan_2))) (sometime (or (holds agent1 cloth_4) (holds agent1 pan_2))) (sometime (atlocation agent1 location3)) (sometime-before (atlocation agent1 location3) (atlocation agent1 location4)))
