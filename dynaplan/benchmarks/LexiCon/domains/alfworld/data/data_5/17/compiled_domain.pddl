(define (domain liftedtcore_alfred-domain)
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r ?l_0))))
  :effect (and (checked ?r) (when (and (atlocation agent1 location2) (not (or (objectatlocation cloth_4 location5) (= ?r sinkbasin_1) (checked sinkbasin_1)))) (not (hold_2))) (when (or (objectatlocation cloth_4 location5) (= ?r sinkbasin_1) (checked sinkbasin_1)) (hold_2)) (increase (total-cost) 1)))
 ...
 (and (atlocation ?a ?l_0) (receptacleatlocation ?r_0 ?l_0) (inreceptacle ?o ?r_0) (or (not (openable ?r_0)) (opened ?r_0))))) (holds ?a ?o)))
  :effect (and (checked ?o) (when (and (holds agent1 bowl_5) (not (or (checked location1) (= ?o pan_2) (checked pan_2)))) (not (hold_4))) (when (or (checked location1) (= ?o pan_2) (checked pan_2)) (hold_4)) (increase (total-cost) 1)))
 (:action gotolocation
  ...
  :effect (and (not (atlocation ?a ?lstart)) (atlocation ?a ?lend) (when (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (hold_1)) (when (and (or (and (= ?a agent1) (= ?lend location2)) (and (atlocation agent1 location2) (not (and (= ?a agent1) (= ?lstart location2))))) (not (or (objectatlocation cloth_4 location5) (checked sinkbasin_1)))) (not (hold_2))) (when (or (and (= ?a agent1) (= ?lend location3)) (and (atlocation agent1 location3) (not (and (= ?a agent1) (= ?lstart location3))))) (hold_6)) (when (or (and (= ?a agent1) (= ?lend location4)) (and (atlocation agent1 location4) (not (and (= ?a agent1) (= ?lstart location4))))) (seen_psi_7)) (increase (total-cost) 1)))
 (:action openobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
  :precondition (and (openable ?r) (atlocation ?a ?l) (receptacleatlocation ?r ?l) (not (opened ?r)))
  :effect (and (opened ?r) (checked ?r) (when (and (atlocation agent1 location2) (not (or (objectatlocation cloth_4 location5) (= ?r sinkbasin_1) (checked sinkbasin_1)))) (not (hold_2))) (when (or (objectatlocation cloth_4 location5) (= ?r sinkbasin_1) (checked sinkbasin_1)) (hold_2)) (increase (total-cost) 1)))
 (:action closeobject
  :parameters ( ?a - agent ?l - location ?r - receptacle)
 ...
 (:action pickupobject
  ...
  :effect (and (not (inreceptacle ?o ?r)) (holds ?a ?o) (holdsany ?a) (not (objectatlocation ?o ?l)) (when (or (and (= ?a agent1) (= ?o cloth_4)) (holds agent1 cloth_4)) (hold_0)) (when (and (atlocation agent1 location2) (not (or (and (objectatlocation cloth_4 location5) (not (and (= ?o cloth_4) (= ?l location5)))) (checked sinkbasin_1)))) (not (hold_2))) (when (or (and (objectatlocation cloth_4 location5) (not (and (= ?o cloth_4) (= ?l location5)))) (checked sinkbasin_1)) (hold_2)) (when (or (and (= ?a agent1) (= ?o bowl_5)) (holds agent1 bowl_5)) (hold_3)) (when (and (or (and (= ?a agent1) (= ?o bowl_5)) (holds agent1 bowl_5)) (not (or (checked location1) (checked pan_2)))) (not (hold_4))) (when (or (and (= ?a agent1) (= ?o cloth_4)) (holds agent1 cloth_4) (and (= ?a agent1) (= ?o pan_2)) (holds agent1 pan_2)) (hold_5)) (increase (total-cost) 1)))
 (:action putobject
  ...
  :effect (and (inreceptacle ?o ?r) (objectatlocation ?o ?l) (not (holds ?a ?o)) (not (holdsany ?a)) (when (and (holds agent1 cloth_4) (not (and (= ?a agent1) (= ?o cloth_4)))) (hold_0)) (when (and (atlocation agent1 location2) (not (or (and (= ?o cloth_4) (= ?l location5)) (objectatlocation cloth_4 location5) (checked sinkbasin_1)))) (not (hold_2))) (when (or (and (= ?o cloth_4) (= ?l location5)) (objectatlocation cloth_4 location5) (checked sinkbasin_1)) (hold_2)) (when (and (holds agent1 bowl_5) (not (and (= ?a agent1) (= ?o bowl_5)))) (hold_3)) (when (and (holds agent1 bowl_5) (not (and (= ?a agent1) (= ?o bowl_5))) (not (or (checked location1) (checked pan_2)))) (not (hold_4))) (when (or (and (holds agent1 cloth_4) (not (and (= ?a agent1) (= ?o cloth_4)))) (and (holds agent1 pan_2) (not (and (= ?a agent1) (= ?o pan_2))))) (hold_5)) (increase (total-cost) 1)))
 (:action cleanobject
