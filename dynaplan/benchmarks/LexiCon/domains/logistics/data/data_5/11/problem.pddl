(define (problem logistics-problem)
 ...
 (:constraints (sometime (or (in p2 a1) (at_ p2 l2_5))) (sometime (or (in p1 t2) (at_ p2 l2_3))) (sometime (or (at_ p2 l2_4) (in p2 a2))) (sometime (or (in p1 a1) (at_ p1 l2_5))) (sometime (or (at_ p2 l2_2) (in p2 a2))))
