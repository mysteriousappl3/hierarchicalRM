(define (domain logistics-domain)
 ...
 (:predicates (at_ ?obj - obj ?loc - location) (in ?obj1 - obj ?obj2 - obj) (incity ?obj_0 - location ?city - city))
 ...
 (:action loadairplane
  ...
  :effect (and (not (at_ ?obj_1 ?loc)) (in ?obj_1 ?airplane) (increase (total-cost) 1)))
 (:action unloadtruck
 ...
 (:action unloadairplane
  ...
  :effect (and (not (in ?obj ?airplane)) (at_ ?obj ?loc) (increase (total-cost) 1)))
 (:action drivetruck
