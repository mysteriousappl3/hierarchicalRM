(define (domain liftedtcore_logistics-domain)
 ...
 (:action loadairplane
  ...
  :effect (and (not (at_ ?obj_1 ?loc)) (in ?obj_1 ?airplane) (when (or (and (= ?obj_1 p1) (= ?airplane a2)) (in p1 a2) (in p1 t1)) (seen_psi_1)) (when (and (at_ p1 l1_8) (not (and (= ?obj_1 p1) (= ?loc l1_8)))) (hold_2)) (increase (total-cost) 1)))
 (:action unloadtruck
 ...
 (:action unloadairplane
  ...
  :effect (and (not (in ?obj ?airplane)) (at_ ?obj ?loc) (when (or (and (in p1 a2) (not (and (= ?obj p1) (= ?airplane a2)))) (in p1 t1)) (seen_psi_1)) (when (or (and (= ?obj p1) (= ?loc l1_8)) (at_ p1 l1_8)) (hold_2)) (increase (total-cost) 1)))
 (:action drivetruck
