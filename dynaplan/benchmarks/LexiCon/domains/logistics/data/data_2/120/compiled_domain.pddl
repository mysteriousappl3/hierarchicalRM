(define (domain liftedtcore_logistics-domain)
 ...
 (:action loadairplane
  ...
  :effect (and (not (at_ ?obj_1 ?loc)) (in ?obj_1 ?airplane) (when (or (and (= ?obj_1 p1) (= ?airplane a1)) (in p1 a1)) (hold_0)) (when (and (or (and (= ?obj_1 p1) (= ?airplane a1)) (in p1 a1)) (not (or (and (= ?obj_1 p1) (= ?airplane a2)) (in p1 a2)))) (not (hold_1))) (when (or (and (= ?obj_1 p1) (= ?airplane a2)) (in p1 a2)) (hold_1)) (when (or (and (= ?obj_1 p1) (= ?airplane a2)) (in p1 a2)) (hold_2)) (increase (total-cost) 1)))
 (:action unloadtruck
 ...
 (:action unloadairplane
  ...
  :effect (and (not (in ?obj ?airplane)) (at_ ?obj ?loc) (when (and (in p1 a1) (not (and (= ?obj p1) (= ?airplane a1)))) (hold_0)) (when (and (in p1 a1) (not (and (= ?obj p1) (= ?airplane a1))) (not (and (in p1 a2) (not (and (= ?obj p1) (= ?airplane a2)))))) (not (hold_1))) (when (and (in p1 a2) (not (and (= ?obj p1) (= ?airplane a2)))) (hold_1)) (when (and (in p1 a2) (not (and (= ?obj p1) (= ?airplane a2)))) (hold_2)) (increase (total-cost) 1)))
 (:action drivetruck
