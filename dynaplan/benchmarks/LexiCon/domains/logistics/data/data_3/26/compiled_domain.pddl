(define (domain liftedtcore_logistics-domain)
 ...
 (:constants
   p2 p1 - package
   l2_1 l1_1 - airport
   l2_3 l2_2 l1_5 l1_4 l1_3 - location
 )
 ...
 (:action unloadtruck
  ...
  :effect (and (not (in ?obj ?truck)) (at_ ?obj ?loc) (when (or (and (= ?obj p2) (= ?loc l1_4)) (at_ p2 l1_4) (and (= ?obj p1) (= ?loc l2_1)) (at_ p1 l2_1)) (hold_0)) (when (or (and (= ?obj p2) (= ?loc l1_1)) (at_ p2 l1_1)) (hold_1)) (when (and (or (and (= ?obj p2) (= ?loc l1_1)) (at_ p2 l1_1)) (not (or (and (= ?obj p1) (= ?loc l1_5)) (at_ p1 l1_5) (and (= ?obj p2) (= ?loc l2_3)) (at_ p2 l2_3)))) (not (hold_2))) (when (or (and (= ?obj p1) (= ?loc l1_5)) (at_ p1 l1_5) (and (= ?obj p2) (= ?loc l2_3)) (at_ p2 l2_3)) (hold_2)) (when (or (and (= ?obj p2) (= ?loc l2_1)) (at_ p2 l2_1)) (hold_3)) (when (or (and (= ?obj p2) (= ?loc l1_3)) (at_ p2 l1_3) (and (= ?obj p2) (= ?loc l2_2)) (at_ p2 l2_2)) (seen_psi_4)) (increase (total-cost) 1)))
