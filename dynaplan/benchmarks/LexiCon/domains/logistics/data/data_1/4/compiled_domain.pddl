(define (domain liftedtcore_logistics-domain)
 ...
 (:action loadtruck
  ...
  :effect (and (not (at_ ?obj_1 ?loc)) (in ?obj_1 ?truck) (when (and (at_ p1 l2_1) (not (and (= ?obj_1 p1) (= ?loc l2_1)))) (hold_0)) (when (and (at_ p2 l2_3) (not (and (= ?obj_1 p2) (= ?loc l2_3)))) (seen_psi_1)) (increase (total-cost) 1)))
 (:action loadairplane
  ...
  :effect (and (not (at_ ?obj_1 ?loc)) (in ?obj_1 ?airplane) (when (and (at_ p1 l2_1) (not (and (= ?obj_1 p1) (= ?loc l2_1)))) (hold_0)) (when (and (at_ p2 l2_3) (not (and (= ?obj_1 p2) (= ?loc l2_3)))) (seen_psi_1)) (increase (total-cost) 1)))
 (:action unloadtruck
  :parameters ( ?obj - obj ?truck - truck ?loc - location)
  :precondition (and (at_ ?truck ?loc) (in ?obj ?truck) (or (not (or (and (= ?obj p1) (= ?loc l2_1)) (at_ p1 l2_1))) (seen_psi_1)))
  :effect (and (not (in ?obj ?truck)) (at_ ?obj ?loc) (when (or (and (= ?obj p1) (= ?loc l2_1)) (at_ p1 l2_1)) (hold_0)) (when (or (and (= ?obj p2) (= ?loc l2_3)) (at_ p2 l2_3)) (seen_psi_1)) (increase (total-cost) 1)))
 (:action unloadairplane
  ...
  :effect (and (not (in ?obj ?airplane)) (at_ ?obj ?loc) (when (or (and (= ?obj p1) (= ?loc l2_1)) (at_ p1 l2_1)) (hold_0)) (when (or (and (= ?obj p2) (= ?loc l2_3)) (at_ p2 l2_3)) (seen_psi_1)) (increase (total-cost) 1)))
 (:action drivetruck
