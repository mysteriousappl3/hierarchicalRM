(define (domain blocksworld-domain)
 ...
 (:action pickup-double
  ...
  :effect (and (holding ?obj) (not (ontable ?obj)) (not (handempty)) (and (forall (?topobj - block) (when (on ?topobj ?obj) (not(clear ?topobj))))) ))
 (:action putdown
  :parameters ( ?obj - block)
  :precondition (and (holding ?obj))
  :effect (and (handempty) (ontable ?obj) (not (holding ?obj)) (and (forall (?topobj - block) (when (on ?topobj ?obj) (clear ?topobj)))) ))
 (:action stack
  :parameters ( ?obj - block ?underobj - block)
  :precondition (and (clear ?underobj) (holding ?obj))
  :effect (and (handempty) (on ?obj ?underobj) (not (clear ?underobj)) (not (holding ?obj)) (and (forall (?topobj - block) (when (on ?topobj ?obj) (clear ?topobj)))) ))
 (:action unstack
  :parameters ( ?obj - block ?underobj - block)
 ...
 (:action unstack-double
  ...
  :effect (and (holding ?obj) (clear ?underobj) (not (on ?obj ?underobj)) (not (handempty)) (and (forall (?topobj - block) (when (on ?topobj ?obj) (not(clear ?topobj))))) ))
)
